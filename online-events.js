(() => {
  const ONLINE_VERSION = "2026-08-10-v383-firestore-throttle";
  ...
  const CLOUD_SAVE_MIN_INTERVAL_MS = 120000;
  const PLAYER_SYNC_MIN_INTERVAL_MS = 120000;
  const RESOURCE_EXHAUSTED_BACKOFF_MS = 600000;
