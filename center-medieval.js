...
const WORLD_DAY_TIME_HOURS_PER_MINUTE = 0.864; // V292: 06:00-18:00 dauert rund 5 reale Minuten länger.
...
const DEFAULT_KEYBINDS = Object.freeze({ overview:'KeyM', inventory:'KeyI', crafting:'KeyC', building:'KeyB', marker:'KeyP', perspective:'KeyV', interact:'KeyE', jump:'Space', staffMenu:'Period', vanish:'KeyG', god:'KeyH', fly:'KeyF', transform:'KeyT', greatSword:'KeyO', speedUp:'KeyU', speedDown:'KeyJ' });
...
const STAFF_THEME_CONFIG = Object.freeze({
  // V280: Owner klar lila/violett, Supporter klar blau. Alle Staff-Themes teilen
  // schwarze Galaxy-Tiefen, Sternfelder und Nebelstrukturen, unterscheiden sich aber
  // bewusst in ihrer Farbwelt.
  owner:Object.freeze({label:'Owner Galaxy',primary:0xd45bff,secondary:0x8425ff,accent:0xffa4ff,dark:0x05010a,emissive:0x7a21ec,css:'owner'}),
  admin:Object.freeze({label:'Admin Red Galaxy',primary:0xff2c52,secondary:0xb21231,accent:0xffadb8,dark:0x080103,emissive:0x9b1635,css:'admin'}),
  moderator:Object.freeze({label:'Moderator Grün',primary:0x29e978,secondary:0x0d944b,accent:0xb3ffd3,dark:0x010b06,emissive:0x0c8042,css:'moderator'}),
  supporter:Object.freeze({label:'Supporter Blau',primary:0x1690ff,secondary:0x0b49e6,accent:0x8ee2ff,dark:0x010713,emissive:0x0e5dd8,css:'supporter'}),
...
const STAFF_CAPABILITY_MATRIX = Object.freeze({
  ...
  owner: Object.freeze({ menu:true, vanish:true, god:true, heal:true, online:true, teleport:true, fly:true, noclip:true, speed:true, freezeTime:true, size:true, forms:Object.freeze(['normal','ball','crystal','bush','tree','rock','grass',...ANIMAL_FORM_IDS]), items:Object.freeze(['none','shovel','pickaxe','hoe','axe','hammer','sword','greatSword','staff','eternalFlame']), vehicles:Object.freeze(['none','scooter','plane']), world:true, resources:true, ownerCosmetics:true })
});
...
const MODEL_PATHS = Object.freeze({
  ...
  maskedOwner: `./owner-masked-v294.glb?v=20260809-v330-wizard-v1`
});
const RUN_MODEL_PATHS = Object.freeze({
  male: `./man-run.glb?v=20260808-v269`,
  female: `./woman-run.glb?v=20260808-v269`
});
const IDLE_MODEL_PATHS = Object.freeze({
  male: `./man-idle-v325.glb?v=20260809-v325`,
  female: `./woman-idle-v325.glb?v=20260809-v325`
});
const CENTER_ASSET_PATHS = Object.freeze({
  ...
  villageHousePack: `./village-house-pack-v310.glb?v=20260809-v310`,
  ownerGreatSword: `./owner-great-sword-v314.glb?v=20260809-v314`,
  swordKit: `./sword-kit-v314.glb?v=20260809-v314`,
  ...
  playerHouseLevel4: `./player-house-level4-v293.glb?v=20260809-v293`,
  playerHouseLevel5: `./player-house-level5-v293.glb?v=20260809-v293`,
  chestSmall: `./chest-small-v293.glb?v=20260809-v293`,
  chestMedium: `./chest-medium-v293.glb?v=20260809-v293`
});
...
const BUILDINGS = Object.freeze({
  ...
  house: { name: 'Wohnhaus', icon: '⌂', wood: 8, logs: 20, stone: 12, size: 7.4, category: 'Wohnen', note: 'Dein begehbares Haus · 5 Ausbaustufen' },
  ...
  smallChest: { name: 'Kleine Truhe', icon: '▤', wood: 0, logs: 0, stone: 0, size: 1.25, category: 'Lager', craftedItem: 'smallChest', note: 'Nach dem Herstellen frei platzierbar' },
...
const PLAYER_SWORD_KIT_NODES = Object.freeze([
  'polySurface332_weaponMap_MAT_0','polySurface335_weaponMap_MAT_0','polySurface333_weaponMap_MAT_0',
  'polySurface347_weaponMap_MAT_0','polySurface339_weaponMap_MAT_0','polySurface328_weaponMap_MAT_0',
  'polySurface330_weaponMap_MAT_0','polySurface334_weaponMap_MAT_0','polySurface348_weaponMap_MAT_0'
]);
const PLAYER_SWORD_TIERS = Object.freeze([
  Object.freeze({tier:1,name:'Schwert 1',requiredLevel:1,maxStage:10,baseDamage:20,maxDamage:45,cost:{wood:2,iron:1}}),
  Object.freeze({tier:2,name:'Schwert 2',requiredLevel:10,maxStage:10,baseDamage:60,maxDamage:110,cost:{wood:3,iron:4,leather:1}}),
  Object.freeze({tier:3,name:'Schwert 3',requiredLevel:20,maxStage:10,baseDamage:135,maxDamage:220,cost:{wood:4,iron:7,leather:2}}),
  Object.freeze({tier:4,name:'Schwert 4',requiredLevel:40,maxStage:10,baseDamage:260,maxDamage:390,cost:{wood:5,iron:12,leather:3}}),
  Object.freeze({tier:5,name:'Schwert 5',requiredLevel:50,maxStage:10,baseDamage:470,maxDamage:650,cost:{wood:5,iron:18,leather:4}}),
  Object.freeze({tier:6,name:'Schwert 6',requiredLevel:60,maxStage:10,baseDamage:780,maxDamage:970,cost:{wood:6,iron:25,leather:5}}),
  Object.freeze({tier:7,name:'Schwert 7',requiredLevel:70,maxStage:10,baseDamage:1180,maxDamage:1400,cost:{wood:7,iron:34,leather:7}}),
  Object.freeze({tier:8,name:'Schwert 8',requiredLevel:80,maxStage:10,baseDamage:1700,maxDamage:2200,cost:{wood:8,iron:45,leather:9}}),
  Object.freeze({tier:9,name:'Schwert 9',requiredLevel:90,maxStage:50,baseDamage:2486,maxDamage:4000,cost:{wood:10,iron:65,leather:12}})
]);
const ANIMAL_COMBAT_FACTORS = Object.freeze({fox:.72,cow:1.35,horse:1.5,owl:.55,wolf1:1.05,wolf2:1.12,spider:1.65,clownfish:.32,bird:.42,shark:2.0,orca:2.55});
...
const CHEST_DEFS = Object.freeze({
  ...
  mediumChest:Object.freeze({name:'Mittlere Truhe',asset:'chestMedium',capacity:100,targetSize:1.75,cost:{wood:12,logs:5,iron:2}})
});
const RECIPES = Object.freeze({
  ...
  smallChest: { name: 'Kleine Truhe', icon: '▤', cost: CHEST_DEFS.smallChest.cost, kind: 'placeable', skill: 'crafting' },
  mediumChest: { name: 'Mittlere Truhe', icon: '▣', cost: CHEST_DEFS.mediumChest.cost, kind: 'placeable', skill: 'crafting' }
});
...
function defaultSaveState() {
  return {
    ...
    placeables: { smallChest: 0, mediumChest: 0 },
    equippedTool: '',
    ownerAppearance: { skin: 'normal', ownerBaseModel: 'default', staffSkinTheme: 'none', aura: false, auraTheme: 'owner', size: 1, heldItem: 'none', heldItemTheme: 'owner', cape: false, capeTheme: 'owner', cloak: false, cloakTheme: 'owner', hat: false, hatTheme: 'owner', vehicle: 'none', scooterTuning: 0, quickForm: 'fox', treeVariant: 0, publicMode: 'staff', publicGender: 'male', publicAlias: 'Center Spieler', staffMaxHealth: 500, staffDamage: 180, ownerGreatSwordDamage: 5000, ownerGreatSwordCarried: false, ownerGreatSwordCarryPosition: 'back', ownerGreatSwordActive: false, ownerGreatSwordSpecials: { lightning: false, teleport: false, throw: true } },
    keybinds: { ...DEFAULT_KEYBINDS },
    staffSettings: { speedControlMode: 'wheel', speedMultiplier: 1 },
    swordSystem: { owned: {}, stages: {}, equippedTier: 0, lastKnownMainLevel: 0, healthScaleVersion: 0 },
    markers: [],
    deathLoot: null,
...
function normalizeSaveState(raw) {
  ...
  state.ownerAppearance.ownerBaseModel = ['default','masked'].includes(String(raw.ownerAppearance?.ownerBaseModel||state.ownerAppearance.ownerBaseModel||'default')) ? String(raw.ownerAppearance?.ownerBaseModel||state.ownerAppearance.ownerBaseModel||'default') : 'default';
  ...
  state.ownerAppearance.cloakTheme = normalizeStaffTheme(raw.ownerAppearance?.cloakTheme ?? legacyVisualTheme);
  ...
  state.ownerAppearance.heldItem = ['none','sword','greatSword','shovel','pickaxe','hoe','axe','staff','torch','hammer','eternalFlame'].includes(state.ownerAppearance.heldItem) ? state.ownerAppearance.heldItem : 'none';
  state.ownerAppearance.cloak = !!state.ownerAppearance.cloak;
  ...
  for(const key of ['lightning','teleport','throw'])state.ownerAppearance.ownerGreatSwordSpecials[key]=!!state.ownerAppearance.ownerGreatSwordSpecials[key];
  ...
  state.swordSystem = { ...base.swordSystem, ...(raw.swordSystem || {}) };
  const cleanOwned={},cleanStages={};
  for(const def of PLAYER_SWORD_TIERS){const tier=def.tier,owned=!!state.swordSystem.owned?.[tier];if(owned){cleanOwned[tier]=true;cleanStages[tier]=Math.floor(clamp(Number(state.swordSystem.stages?.[tier])||1,1,def.maxStage));}}
  state.swordSystem.owned=cleanOwned;state.swordSystem.stages=cleanStages;state.swordSystem.equippedTier=cleanOwned[Math.floor(Number(state.swordSystem.equippedTier)||0)]?Math.floor(Number(state.swordSystem.equippedTier)||0):0;state.swordSystem.lastKnownMainLevel=Math.floor(clamp(Number(state.swordSystem.lastKnownMainLevel)||0,0,10000));state.swordSystem.healthScaleVersion=Math.max(0,Math.floor(Number(state.swordSystem.healthScaleVersion)||0));
  ...
  for(const key of Object.keys(base.placeables))state.placeables[key]=Math.max(0,Math.floor(Number(state.placeables[key])||0));
  ...
  state.buildings = Array.isArray(raw.buildings) ? raw.buildings.slice(0, 140).filter((entry) => entry && BUILDINGS[entry.type]).map((entry)=>{const next={...entry};if(next.type==='house')next.houseLevel=Math.floor(clamp(Number(next.houseLevel)||1,1,HOUSE_UPGRADE_LEVELS.length));if(CHEST_DEFS[next.type]){const clean={};for(const id of Object.keys(RESOURCE_LABELS)){const amount=Math.max(0,Math.floor(Number(next.storage?.[id])||0));if(amount>0)clean[id]=amount;}next.storage=clean;}return next;}) : [];
...
function villageWaterFeaturesForChunk(cx,cz){
  ...
  const make=(id,along,side,rx,rz,angleOffset=0,label='Dorfteich')=>{
    ...
    // V310: Bergseite zusätzlich bestimmen. Dort wird später ein natürlicher Felsrand gesetzt,
    // während die talwärts liegende Seite mit Erde geschlossen wird.
    let highAngle=0,lowAngle=Math.PI,ringHigh=-Infinity,ringLow=Infinity;
    for(let ri=0;ri<20;ri+=1){
      const a=ri/20*Math.PI*2,lx=Math.cos(a)*rx,lz=Math.sin(a)*rz,wx=p.x+lx*c-lz*s,wz=p.z+lx*s+lz*c,rh=rawTerrainHeightAt(wx,wz);
      if(rh>ringHigh){ringHigh=rh;highAngle=a;}if(rh<ringLow){ringLow=rh;lowAngle=a;}
    }
    const mountain=slope>3.0;
    const level=clamp(mountain?Math.max(low+.72,Math.min(center-.38,low+Math.min(2.25,slope*.40))):center-.48,-4.4,48);
    // Tiefer als V309: genug Platz zum echten Tauchen.
    const depth=mountain?clamp(5.2+slope*.30,5.4,8.2):clamp(4.25+Math.max(rx,rz)*.075,4.5,6.8);
    return {id:`village-water-${cx}-${cz}-${id}`,x:p.x,z:p.z,rx,rz,yaw:fyaw,level,depth,label,mountain,slope,highAngle,lowAngle};
  };
  let features=[];
...
function terrainHeightAt(x, z) {
  ...
  // V310: echtes tiefes Wasserbecken. Der Boden läuft von der Uferkante mehrere Meter nach
  // unten. Außerhalb der Wasserlinie wird Erde hochgezogen, damit man niemals unter den Rand
  // bzw. unter die normale Weltplatte hindurchsehen kann.
  const vcx=worldToChunk(x),vcz=worldToChunk(z);
  for(const villageWater of villageWaterFeaturesForChunk(vcx,vcz)){
    const d=ellipseDistance(x,z,villageWater);if(d>=1.30)continue;
    if(d<1){
      const bowl=Math.pow(1-clamp(d,0,1),.48),target=villageWater.level-(.78+villageWater.depth*(.38+.62*bowl)),weight=1-smoothRange(.82,1,d);
      h=h*(1-weight)+target*weight;
    }else{
      const rim=1-smoothRange(1,1.28,d),rimTarget=villageWater.level-.10;
      h=Math.max(h,h*(1-rim)+rimTarget*rim);
    }
  }
...
class CenterDynastyGame {
  constructor() {
    ...
    this.playerWalkMixer = null;
    this.playerRunMixer = null;
    this.playerDualLocomotion = false;
    this.playerWalkVisual = null;
    this.playerRunVisual = null;
    this.playerAction = null;
    this.playerWalkAction = null;
    this.playerRunAction = null;
    this.playerJogAction = null;
    this.playerIdleAction = null;
    this.playerWeaponIdleAction = null;
    ...
    this.wizardIdentityLabel = null;
    this.playerUsesNativeIdle = false;
    ...
    this.ownerCloakObject = null;
    this.ownerCapeObject = null;
    this.ownerGreatSwordCarryObject = null;
    ...
    this.greatSwordAimActive = false;
    ...
    this.villageHouseFootprintCache = new Map();
  ...
  effectiveStaffSkinTheme(){
    ...
    if(this.isOwnerActive&&this.state.ownerAppearance?.ownerBaseModel==='masked')return 'none';
  ...
  mainAccountLevel(){return Math.max(1,Math.floor(Number(bridgeSnapshot()?.level)||1));}
  playerLevelMaxHealth(level=this.mainAccountLevel()){level=Math.floor(clamp(Number(level)||1,1,100));return Math.round(100+(level-1)*(4900/99));}
  isOwnerWizardActive(){return !!(this.isOwnerActive&&!this.isPublicPlayerMode()&&this.state.ownerAppearance?.ownerBaseModel==='masked');}
  effectiveMaxHealth(){if(this.isOwnerWizardActive())return 10000;const levelMax=this.playerLevelMaxHealth();if(this.isStaffActive&&['owner','admin'].includes(this.activeStaffRole))return Math.max(levelMax,Math.floor(clamp(Number(this.state.ownerAppearance?.staffMaxHealth)||500,100,10000)));return levelMax;}
  incomingCombatDamage(amount){const raw=Math.max(0,Number(amount)||0);return this.isOwnerWizardActive()?raw*.5:raw;}
  applyIncomingCombatDamage(amount,{minimum=0}={}){if(this.isStaffActive&&this.ownerFlags.god)return 0;const damage=Math.max(minimum,Math.round(this.incomingCombatDamage(amount)));this.state.needs.health=Math.max(0,Number(this.state.needs.health||0)-damage);return damage;}
  swordTierDefinition(tier=1){tier=Math.floor(clamp(Number(tier)||1,1,PLAYER_SWORD_TIERS.length));return PLAYER_SWORD_TIERS[tier-1];}
  swordStage(tier){const def=this.swordTierDefinition(tier);return Math.floor(clamp(Number(this.state.swordSystem?.stages?.[def.tier])||1,1,def.maxStage));}
  swordDamage(tier=this.state.swordSystem?.equippedTier||0){tier=Math.floor(Number(tier)||0);if(!tier)return 0;const def=this.swordTierDefinition(tier),stage=this.swordStage(tier),t=def.maxStage<=1?0:(stage-1)/(def.maxStage-1);return Math.round(def.baseDamage+(def.maxDamage-def.baseDamage)*t);}
  swordUpgradeCost(tier,stage=this.swordStage(tier)){const def=this.swordTierDefinition(tier),next=Math.min(def.maxStage,stage+1);return {iron:Math.max(1,Math.ceil(def.tier*1.4+next*.62)),leather:Math.max(0,Math.floor((def.tier+next)/5)),wood:Math.max(0,Math.floor(def.tier/3))};}
  syncCombatProgression(){const level=this.mainAccountLevel(),previous=Math.max(0,Math.floor(Number(this.state.swordSystem?.lastKnownMainLevel)||0)),newMax=this.effectiveMaxHealth();
    if(Number(this.state.swordSystem?.healthScaleVersion||0)<315){this.state.needs.health=newMax;this.state.swordSystem.healthScaleVersion=315;this.state.swordSystem.lastKnownMainLevel=level;this.saveState(true);this.renderHud(true);return;}
    if(previous===level){if(Number(this.state.needs.health)>newMax)this.state.needs.health=newMax;return;}
    const oldLevelMax=previous>0?this.playerLevelMaxHealth(previous):100,oldMax=this.isStaffActive&&['owner','admin'].includes(this.activeStaffRole)?Math.max(oldLevelMax,Math.floor(clamp(Number(this.state.ownerAppearance?.staffMaxHealth)||500,100,10000))):oldLevelMax;
    if(level>previous)this.state.needs.health=Math.min(newMax,(Number(this.state.needs.health)||0)+Math.max(0,newMax-oldMax));else this.state.needs.health=Math.min(newMax,Number(this.state.needs.health)||newMax);
    this.state.swordSystem.lastKnownMainLevel=level;this.saveState(true);}
  animalScaledMaxHp(type,level=this.mainAccountLevel()){const factor=ANIMAL_COMBAT_FACTORS[type]??1,base=92+(Math.max(1,level)-1)*64;return Math.max(20,Math.round(base*factor));}
  syncAnimalCombatLevel(animal){if(!animal)return;const level=this.mainAccountLevel();if(animal.level===level&&Number(animal.maxHp)>0)return;const oldMax=Math.max(1,Number(animal.maxHp)||1),ratio=clamp((Number(animal.hp)||oldMax)/oldMax,0,1),next=this.animalScaledMaxHp(animal.type,level);animal.level=level;animal.maxHp=next;animal.hp=Math.max(1,Math.round(next*ratio));}
  ...
  attackAnimalCombat(animal){
    ...
    if(!(this.isStaffActive&&this.ownerFlags.god)){
      if(animal.type==='wolf1'||animal.type==='wolf2'){
        ...
        counter=this.applyIncomingCombatDamage(Math.max(3,Math.round(this.effectiveMaxHealth()*pct)),{minimum:1});
      }else if(['spider','shark','orca'].includes(animal.type)){
        counter=this.applyIncomingCombatDamage(Math.max(2,Math.round(4+animal.level*.34*(ANIMAL_COMBAT_FACTORS[animal.type]||1))),{minimum:1});
      }
    }
  ...
  buildOverlay() {
    ...
    this.underwaterOverlay = overlay.querySelector('[data-mdc-underwater]');
  ...
  bindGlobalEvents() {
    ...
    document.addEventListener('keydown', (event) => {
      ...
      if (!event.repeat && this.isOwnerActive && event.code===binds.greatSword) { this.toggleOwnerGreatSwordActive(); return; }
  ...
  bindLookControls() {
    const start = (event) => {
      ...
      if (this.isMobile) {
        ...
        if(document.pointerLockElement===this.canvas)this.beginGreatSwordAim();
    ...
    const end = (event) => {
      ...
      if(event.button===2)this.endGreatSwordAim();
      if(this.staffBeamActive&&(this.staffBeamPointerId==null||event.pointerId===this.staffBeamPointerId))this.endStaffBeam();
    };
    this.canvas.addEventListener('contextmenu',(event)=>{if(this.ownerGreatSwordEquipped()){event.preventDefault();this.beginGreatSwordAim();}});
  ...
  close() {
    if (!this.opened) return;
    if(this.inHouseInterior)this.exitPlayerHouse(true);
    this.saveState(true);
  ...
  villageHouseFootprint(variant=0){
    variant=Math.floor(clamp(Number(variant)||0,0,4));if(this.villageHouseFootprintCache.has(variant))return {...this.villageHouseFootprintCache.get(variant)};
    const visual=this.createVillageHouseVariant(variant,5.7);if(!visual)return null;
    visual.updateMatrixWorld(true);const box=new THREE.Box3().setFromObject(visual);if(box.isEmpty())return null;
    const size=box.getSize(new THREE.Vector3()),footprint={variant,width:Math.max(3.2,size.x),depth:Math.max(3.2,size.z),height:Math.max(3.8,size.y)};
    this.villageHouseFootprintCache.set(variant,footprint);return {...footprint};
  }

  playerHousePlotFootprint(){
    const visual=this.createPlayerHouseAsset(1,false);if(visual){visual.updateMatrixWorld(true);const box=new THREE.Box3().setFromObject(visual);if(!box.isEmpty()){const size=box.getSize(new THREE.Vector3());visual.removeFromParent?.();return {width:Math.max(6,size.x),depth:Math.max(7.8,size.z),height:size.y};}}
    const p=this.houseCollisionProfile(1);return {width:p.halfW*2,depth:p.halfD*2,height:this.houseLevelDefinition(1).height};
  }

  villagePlotContains(plot,x,z,padding=0){
    if(!plot)return false;const yaw=Number(plot.yaw)||0,c=Math.cos(yaw),s=Math.sin(yaw),dx=x-plot.x,dz=z-plot.z,lx=dx*c-dz*s,lz=dx*s+dz*c;
    return Math.abs(lx)<=plot.halfW+padding&&Math.abs(lz)<=plot.halfD+padding;
  }

  pointNearVillageStep4Reservation(chunk,x,z,padding=0){
    const plan=chunk?.villageStep4Plan;if(!plan)return false;
    if(Math.hypot(x-plan.well.x,z-plan.well.z)<plan.well.radius+padding)return true;
    return (plan.plots||[]).some((plot)=>this.villagePlotContains(plot,x,z,padding));
  }

  addVillageStep4Foundation(chunk,plot){
    // V329: Jede Grundstücksplatte ist sichtbar über dem höchsten Terrainpunkt. Dadurch
    // kann kein späteres Haus optisch "ohne Beton" bzw. schwebend im Gelände erscheinen.
    const samples=this.sampleVillageFootprint(plot.x,plot.z,plot.halfW,plot.halfD,plot.yaw),topY=samples.max+.24,bottomY=samples.min-.30,slabThickness=.36,bodyDepth=Math.max(.62,topY-slabThickness-bottomY);
    ...
    const slab=new THREE.Mesh(new THREE.BoxGeometry(plot.halfW*2+.08,slabThickness,plot.halfD*2+.08),topMat);slab.position.set(plot.x-chunk.originX,topY-slabThickness*.5,plot.z-chunk.originZ);slab.rotation.y=plot.yaw;slab.name=plot.free?'v310-free-plot-slab':'v310-house-reserved-slab';slab.userData.villagePlotId=plot.id;slab.castShadow=!!this.state.world?.shadows;slab.receiveShadow=true;chunk.group.add(slab);
    plot.topY=topY;plot.bottomY=bottomY;plot.slope=samples.slope;plot.foundationBody=body;plot.foundationSlab=slab;plot.foundationSlabThickness=slabThickness;
    return plot;
  }

  createVillageStep4Plan(chunk){
    const roadPlan=chunk.villageRoadPlan;if(!roadPlan)return null;
    const rnd=seededRandom((Math.imul(chunk.cx+6103,1103515245)^Math.imul(chunk.cz+9109,12345)^(WORLD_SEED+31004))>>>0),center=roadPlan.center;
    const freeCount=1+Math.floor(rnd()*3),occupied=[],plots=[];
    const playerFoot=this.playerHousePlotFootprint();
    const desired=[
      ...Array.from({length:5},(_,i)=>({free:false,variant:i,foot:this.villageHouseFootprint(i)})),
      ...Array.from({length:freeCount},()=>({free:true,variant:null,foot:playerFoot}))
    ].filter((entry)=>entry.foot);

    const candidatePoints=[...(roadPlan.futurePlots||[])];
    // Genügend Reservepositionen, falls Wasser oder ein Weg eine geplante Fläche blockiert.
    for(let ring=0;ring<3;ring+=1)for(let i=0;i<18;i+=1){
      const a=roadPlan.yaw+i/18*Math.PI*2+(ring%2)*.09,r=27+ring*7+(i%3)*1.4;
      candidatePoints.push({x:center.x+Math.cos(a)*r,z:center.z+Math.sin(a)*r});
    }

    for(let slot=0;slot<desired.length;slot+=1){
      const spec=desired[slot],width=spec.foot.width+.62,depth=spec.foot.depth+.62,halfW=width*.5,halfD=depth*.5;
      let selected=null;
      for(let ci=0;ci<candidatePoints.length;ci+=1){
        const p=candidatePoints[(ci+slot*3)%candidatePoints.length],yaw=Math.atan2(center.x-p.x,center.z-p.z),diag=Math.hypot(halfW,halfD);
        const candidate={id:`v310-plot-${chunk.key}-${slot}`,x:p.x,z:p.z,yaw,halfW,halfD,free:spec.free,variant:spec.variant,houseWidth:spec.foot.width,houseDepth:spec.foot.depth};
        if(Math.hypot(p.x-center.x,p.z-center.z)<12+diag)continue;
        if(pointInsideWaterFeature(p.x,p.z,diag+1.2))continue;
        if(this.pointNearChunkRoad(chunk,p.x,p.z,Math.min(halfW,halfD)*.70))continue;
        if(occupied.some((other)=>this.villageHouseFootprintsOverlap(candidate,other,1.15)))continue;
        const probe=this.sampleVillageFootprint(p.x,p.z,halfW,halfD,yaw);if(probe.slope>7.5)continue;
        selected=candidate;break;
      }
      if(selected){occupied.push(selected);plots.push(selected);}
    }

    return {center,well:{x:roadPlan.well.x,z:roadPlan.well.z,radius:5.2},plots,freeCount:plots.filter((p)=>p.free).length};
  }

  buildVillageStep4Well(chunk,plan){
    const x=plan.well.x,z=plan.well.z,sample=this.sampleVillageFootprint(x,z,3.2,3.2,0),baseY=sample.max+.06,group=new THREE.Group();group.position.set(x-chunk.originX,baseY,z-chunk.originZ);group.name='v310-village-center-well';
    const stone=new THREE.MeshStandardMaterial({color:0x747572,roughness:1,flatShading:true}),wood=new THREE.MeshStandardMaterial({color:0x5c3c27,roughness:1});
    const plaza=new THREE.Mesh(new THREE.CylinderGeometry(4.1,4.2,.18,28),new THREE.MeshStandardMaterial({color:0x777167,roughness:1}));plaza.position.y=-.09;plaza.receiveShadow=true;group.add(plaza);
    const outer=new THREE.Mesh(new THREE.CylinderGeometry(2.05,2.20,1.15,16,1,true),stone);outer.position.y=.58;outer.castShadow=true;outer.receiveShadow=true;group.add(outer);
    const lip=new THREE.Mesh(new THREE.TorusGeometry(2.12,.18,8,24),stone);lip.rotation.x=Math.PI/2;lip.position.y=1.13;group.add(lip);
    const dark=new THREE.Mesh(new THREE.CircleGeometry(1.82,24),new THREE.MeshStandardMaterial({color:0x15333b,roughness:.3,metalness:0}));dark.rotation.x=-Math.PI/2;dark.position.y=.94;group.add(dark);
    for(const sx of [-1,1]){const post=new THREE.Mesh(new THREE.BoxGeometry(.25,3.35,.25),wood);post.position.set(sx*1.62,2.16,0);post.castShadow=true;group.add(post);}
    const beam=new THREE.Mesh(new THREE.BoxGeometry(3.65,.26,.28),wood);beam.position.y=3.72;beam.castShadow=true;group.add(beam);
    const roof=new THREE.Mesh(new THREE.ConeGeometry(2.7,1.15,4),new THREE.MeshStandardMaterial({color:0x5f3127,roughness:1}));roof.rotation.y=Math.PI/4;roof.position.y=4.25;roof.scale.z=.72;group.add(roof);
    chunk.group.add(group);
    const hotspot={id:`v310-well-${chunk.key}`,type:'well',x,z,radius:4.4,label:'Am Dorfbrunnen Wasser holen',chunkKey:chunk.key};chunk.hotspots.push(hotspot);this.hotspots.push(hotspot);
    plan.well.topY=baseY;plan.well.object=group;
  }

  buildChunkVillageStep4(chunk){
    // SCHRITT 4: Noch KEINE Dorfhäuser. Erst Zentrum/Brunnen und exakt aus den echten
    // Hausmodellen berechnete Betonfundamente. 1–3 davon bleiben absichtlich frei.
  ...
  ensureVillageStep5Foundation(chunk,plot,footprint){
    // V329 HARD LOCK: Das sichtbare Haus und sein Betonfundament werden unmittelbar
    // vor dem Spawn noch einmal aus DEMSELBEN Mittelpunkt, Winkel und Hausmaß aufgebaut.
    // Damit können Haus und Betonplatte technisch nicht mehr auseinanderlaufen.
    if(!chunk||!plot||!footprint)return null;
    const margin=.42,halfW=Math.max(1.7,(Number(footprint.width)||3.2)*.5+margin),halfD=Math.max(1.7,(Number(footprint.depth)||3.2)*.5+margin);
    plot.halfW=halfW;plot.halfD=halfD;plot.houseWidth=Number(footprint.width)||halfW*2;plot.houseDepth=Number(footprint.depth)||halfD*2;
    const samples=this.sampleVillageFootprint(plot.x,plot.z,halfW,halfD,plot.yaw),topY=samples.max+.24,bottomY=samples.min-.30,slabThickness=.36,bodyDepth=Math.max(.62,topY-slabThickness-bottomY);
    // Die in Schritt 4 erzeugten belegten Fundamente werden exakt auf das tatsächlich
    // gemessene Hausmaß korrigiert. Freie Spieler-Grundstücke bleiben unangetastet.
    for(const old of [plot.foundationBody,plot.foundationSlab]){
      if(!old)continue;old.removeFromParent?.();old.geometry?.dispose?.();const mats=Array.isArray(old.material)?old.material:[old.material];for(const mat of mats)mat?.dispose?.();
    }
    const bodyMat=new THREE.MeshStandardMaterial({color:0x666b6d,roughness:.98,metalness:0,flatShading:true}),topMat=new THREE.MeshStandardMaterial({color:0x7c8284,roughness:.94,metalness:0,flatShading:true});
    const body=new THREE.Mesh(new THREE.BoxGeometry(halfW*2,bodyDepth,halfD*2,2,1,2),bodyMat);body.position.set(plot.x-chunk.originX,bottomY+bodyDepth*.5,plot.z-chunk.originZ);body.rotation.y=plot.yaw;body.name='v329-house-locked-foundation';body.userData.villagePlotId=plot.id;body.castShadow=!!this.state.world?.shadows;body.receiveShadow=true;chunk.group.add(body);
    const slab=new THREE.Mesh(new THREE.BoxGeometry(halfW*2+.10,slabThickness,halfD*2+.10),topMat);slab.position.set(plot.x-chunk.originX,topY-slabThickness*.5,plot.z-chunk.originZ);slab.rotation.y=plot.yaw;slab.name='v329-house-locked-slab';slab.userData.villagePlotId=plot.id;slab.castShadow=!!this.state.world?.shadows;slab.receiveShadow=true;chunk.group.add(slab);
    plot.topY=topY;plot.bottomY=bottomY;plot.slope=samples.slope;plot.foundationBody=body;plot.foundationSlab=slab;plot.foundationSlabThickness=slabThickness;
    return {topY,bottomY,halfW,halfD,body,slab};
  }
  ...
  validateVillageStep5Plot(chunk,plot,spawned){
    ...
    const slab=plot.foundationSlab||chunk.group.children.find((object)=>object?.userData?.villagePlotId===plot.id&&(object.name==='v310-house-reserved-slab'||object.name==='v329-house-locked-slab'));
  ...
  buildChunkVillageStep5(chunk){
    ...
    for(const plot of plan.plots||[]){
      ...
      const foundation=this.ensureVillageStep5Foundation(chunk,plot,check.footprint);if(!foundation){plot.step5Skipped=true;plot.step5Reason='Betonfundament konnte nicht erzeugt werden';continue;}
      ...
      // Haus und Beton teilen exakt X/Z/Yaw. Anschließend wird die tatsächlich sichtbare
      // Unterkante des GLB noch einmal auf die Oberkante der Betonplatte geschnappt.
      house.position.set(plot.x-chunk.originX,foundation.topY,plot.z-chunk.originZ);house.rotation.y=plot.yaw;house.name=`v329-village-house-${plot.variant+1}-${plot.id}`;chunk.group.add(house);house.updateMatrixWorld(true);
      const houseBox=new THREE.Box3().setFromObject(house);if(!houseBox.isEmpty()){const delta=foundation.topY-houseBox.min.y;house.position.y+=delta;house.updateMatrixWorld(true);}
      house.userData.villagePlotId=plot.id;house.userData.houseNumber=plot.variant+1;house.userData.foundationTopY=foundation.topY;house.userData.foundationLocked=true;
      this.registerVillageStep5HouseColliders(chunk,plot,check.footprint,house);
  ...
  groundPathMaterial(kind='gravel'){
    return new THREE.MeshStandardMaterial({map:this.groundPathTexture(kind),color:0xffffff,roughness:1,metalness:0,polygonOffset:true,polygonOffsetFactor:kind==='gravel'?-8:kind==='sand'?-6:-5,polygonOffsetUnits:-4});
  }
  ...
  createChestAsset(type,ghost=false){
    const def=CHEST_DEFS[type];if(!def)return null;const root=this.cloneCenterAsset(def.asset,{targetSize:def.targetSize,bottomAlign:true,center:true});if(!root)return null;root.name=ghost?`center-${type}-ghost`:`center-${type}`;
    if(ghost){const tint=new THREE.Color(0x69c981);root.traverse((object)=>{if(!object.isMesh)return;const mats=Array.isArray(object.material)?object.material:[object.material];for(const mat of mats){if(!mat)continue;mat.transparent=true;mat.opacity=.52;mat.color?.lerp?.(tint,.62);mat.depthWrite=false;}});}
    return root;
  }

  ensureHouseInterior(level=1){
    level=Math.floor(clamp(Number(level)||1,1,HOUSE_UPGRADE_LEVELS.length));if(this.houseInteriorScene&&this.houseInteriorLevel===level)return this.houseInteriorScene;
    this.houseInteriorScene=null;this.houseInteriorRoot=null;this.houseInteriorLevel=level;
    const scene=new THREE.Scene();scene.background=new THREE.Color(0x17110c);scene.fog=new THREE.Fog(0x17110c,14+level*2,28+level*4);
    scene.add(new THREE.HemisphereLight(0xffe4bd,0x2a2018,1.8));const lamp=new THREE.PointLight(0xffb76b,3.2,20+level*2,2);lamp.position.set(0,2.8,-1.2);scene.add(lamp);
    const root=new THREE.Group(),wood=new THREE.MeshStandardMaterial({color:0x6b452a,roughness:.94}),plaster=new THREE.MeshStandardMaterial({color:0xb69d76,roughness:1}),floorMat=new THREE.MeshStandardMaterial({color:0x493322,roughness:1});
    const width=7.2+(level-1)*1.15,depth=8.8+(level-1)*1.25,wallH=3.35+(level-1)*.16;const floor=new THREE.Mesh(new THREE.BoxGeometry(width,.18,depth),floorMat);floor.position.y=-.09;root.add(floor);
    for(const [x,z,w,d] of [[0,-depth/2,width,.24],[-width/2,0,.24,depth],[width/2,0,.24,depth],[0,depth/2,width,.24]]){const wall=new THREE.Mesh(new THREE.BoxGeometry(w,wallH,d),plaster);wall.position.set(x,wallH/2,z);root.add(wall);}
    for(const x of [-width*.42,0,width*.42]){const beam=new THREE.Mesh(new THREE.BoxGeometry(.22,wallH+.05,.22),wood);beam.position.set(x,(wallH+.05)/2,-depth/2+.14);root.add(beam);}
    const bed=new THREE.Mesh(new THREE.BoxGeometry(2.5,.55,1.45),wood);bed.position.set(-width*.28,.3,-depth*.28);root.add(bed);const blanket=new THREE.Mesh(new THREE.BoxGeometry(2.32,.18,1.28),new THREE.MeshStandardMaterial({color:0x6d3040,roughness:.9}));blanket.position.set(-width*.28,.66,-depth*.28);root.add(blanket);
    const table=new THREE.Mesh(new THREE.BoxGeometry(2.2,.18,1.2),wood);table.position.set(width*.25,1.05,-depth*.10);root.add(table);for(const sx of [-1,1])for(const sz of [-1,1]){const leg=new THREE.Mesh(new THREE.BoxGeometry(.16,1,.16),wood);leg.position.set(width*.25+sx*.85,.5,-depth*.10+sz*.38);root.add(leg);}
    const hearth=new THREE.Mesh(new THREE.BoxGeometry(1.7,1.35,.75),new THREE.MeshStandardMaterial({color:0x625b53,roughness:1}));hearth.position.set(width*.30,.67,depth*.38);root.add(hearth);const glow=new THREE.PointLight(0xff6f2f,2.5,8,2);glow.position.set(width*.30,1.15,depth*.31);root.add(glow);
    if(level>=3){const divider=new THREE.Mesh(new THREE.BoxGeometry(.18,wallH*.82,depth*.44),wood);divider.position.set(-width*.05,wallH*.41,depth*.18);root.add(divider);}
    if(level>=5){const secondTable=new THREE.Mesh(new THREE.BoxGeometry(2.6,.18,1.35),wood);secondTable.position.set(-width*.20,1.05,depth*.26);root.add(secondTable);}
    root.traverse((o)=>{if(o.isMesh){o.castShadow=!!this.state.world?.shadows;o.receiveShadow=true;}});scene.add(root);this.houseInteriorScene=scene;this.houseInteriorRoot=root;return scene;
  }

  enterPlayerHouse(saved){
    if(this.inHouseInterior||!this.player)return;const houseLevel=Math.floor(clamp(Number(saved?.houseLevel)||1,1,HOUSE_UPGRADE_LEVELS.length));this.ensureHouseInterior(houseLevel);this.houseExteriorReturn={x:this.player.position.x,y:this.player.position.y,z:this.player.position.z,yaw:this.yaw,building:saved||null};this.player.removeFromParent();this.houseInteriorScene.add(this.player);this.player.position.set(0,0,2.4);this.velocityY=0;this.onGround=true;this.yaw=Math.PI;this.modelPivot.rotation.y=Math.PI;this.inHouseInterior=true;this.currentRegion='Eigenes Wohnhaus';this.closePanel();this.snapCamera();this.toast(`Du hast dein Wohnhaus Stufe ${houseLevel} betreten. Mit E verlässt du es wieder.`);
  }
  ...
  createAnimalVisual(type){
    ...
    if(type==='cow'){
      ...
      root.userData.proceduralLegs=names.map((name)=>raw.getObjectByName(name)).filter(Boolean);root.userData.proceduralLegBases=new Map(root.userData.proceduralLegs.map((bone)=>[bone,bone.quaternion.clone()]));
    }
    if(type==='horse'){
  ...
  applyProceduralAnimalWalk(visual,moving=true,delta=.016){
    ...
    if(legs.length){
      for(let i=0;i<legs.length;i+=1){
        ...
        const direction=(i===0||i===3)?1:-1,base=visual.userData.proceduralLegBases?.get?.(bone);
        if(base){bone.quaternion.copy(base);bone.quaternion.multiply(new THREE.Quaternion().setFromEuler(new THREE.Euler(Math.sin(phase+i*.35)*.34*strength*direction,0,0)));}
        else bone.rotateX(Math.sin(phase+i*.35)*.34*strength*direction);
      }
    }
...
decorateChunkWithAssetTrees(chunk){
    ...
    for(let i=0;i<count;i+=1){
      ...
      if(Math.abs(x-riverCenter(z))<27||this.pointNearChunkRoad(chunk,x,z,4)||this.pointNearVillageStep4Reservation(chunk,x,z,2.4)||chunk.villages.some((v)=>Math.hypot(x-v.x,z-v.z)<48))continue;
...
applyGraphicsQuality() {
  ...
  applyShadowSettings() {
    ...
    if(this.ownerHeldObject)this.ownerHeldObject.traverse((object)=>{if(object.isMesh){object.castShadow=enabled;object.receiveShadow=worldShadows;}});if(this.ownerGreatSwordCarryObject)this.ownerGreatSwordCarryObject.traverse((object)=>{if(object.isMesh){object.castShadow=enabled;object.receiveShadow=false;}});
...
async updateChunkStreaming(force = false) {
  ...
  createTerrainCircle(chunk,worldX,worldZ,radius,material,segments=32,yOffset=.05) {
    const lift=Math.max(.012,Number(yOffset)||.05),vertices=[worldX-chunk.originX,terrainHeightAt(worldX,worldZ)+lift,worldZ-chunk.originZ],uvs=[.5,.5],indices=[];
    for(let i=0;i<=segments;i+=1){const a=i/segments*Math.PI*2,x=worldX+Math.cos(a)*radius,z=worldZ+Math.sin(a)*radius;vertices.push(x-chunk.originX,terrainHeightAt(x,z)+lift,z-chunk.originZ);uvs.push(.5+Math.cos(a)*radius/3,.5+Math.sin(a)*radius/3);if(i<segments)indices.push(0,i+1,i+2);}
  ...
  createContinuousVillageRibbon(chunk,curve,width,material,name='v308-ground-path',yOffset=.055){
    const length=Math.max(1,curve.getLength()),samples=Math.max(18,Math.ceil(length/1.05)),vertices=[],uvs=[],indices=[],points=[],lift=Math.max(.014,Number(yOffset)||.055);
    ...
    for(let i=0;i<=samples;i+=1){
      ...
      vertices.push(
        lx-chunk.originX,terrainHeightAt(lx,lz)+lift,lz-chunk.originZ,
        rx-chunk.originX,terrainHeightAt(rx,rz)+lift,rz-chunk.originZ
      );
  ...
  buildCurvedVillagePath(chunk,points,width,kind='gravel',shoulderKind=null){
    ...
    const mainMaterial=this.groundPathMaterial(kind);

    // V329: Kein zweites andersfarbiges Rand-Mesh mehr unter demselben Weg. Genau diese
    // Überlagerung konnte je nach Entfernung/Blickwinkel wie ein hell-/dunkelbrauner LOD-Wechsel
    // wirken. Jeder Weg ist jetzt eine einzige durchgehende Oberfläche mit einem Material.
    const main=this.createContinuousVillageRibbon(chunk,curve,width,mainMaterial,'v329-village-road-main',.066);
    this.createTerrainCircle(chunk,points[0].x,points[0].z,width*.5,mainMaterial,28,.067);
    this.createTerrainCircle(chunk,points[points.length-1].x,points[points.length-1].z,width*.5,mainMaterial,28,.067);
  ...
  worldHorizontalPathZ(worldX,rowIndex){
    const center=chunkOrigin(rowIndex)+CHUNK_SIZE*.5;
    return center+Math.sin(worldX/310+rowIndex*.83)*18+Math.sin(worldX/118+rowIndex*1.71)*5.5;
  }

  worldVerticalPathX(worldZ,columnIndex){
    const center=chunkOrigin(columnIndex)+CHUNK_SIZE*.5;
    return center+Math.sin(worldZ/335+columnIndex*.91)*16+Math.sin(worldZ/126+columnIndex*1.37)*5;
  }

  buildWorldwidePathRibbon(chunk,points,width,kind,shoulderKind=null,name='world-path'){
    if(!points?.length||points.length<2)return null;
    const curve=new THREE.CatmullRomCurve3(points.map((p)=>new THREE.Vector3(p.x,0,p.z)),false,'centripetal',.24);
    // V329: Weltwege ebenfalls nur noch mit EINER sichtbaren Materialschicht. Kein
    // andersfarbiger Unterrand, der aus der Distanz plötzlich hervortritt.
    const main=this.createContinuousVillageRibbon(chunk,curve,width,this.groundPathMaterial(kind),`${name}-main`,.064);
    for(let i=1;i<main.points.length;i+=1){
      const a=main.points[i-1],b=main.points[i];
      chunk.roadSegments.push({ax:a.x,az:a.z,bx:b.x,bz:b.z,width,kind,worldRoad:true});
    }
    return main;
  }

  buildChunkWorldwidePaths(chunk){
    // V308: Landschaftswege existieren nicht mehr nur in Dorf-Chunks.
    // Jede Weltzeile besitzt einen durchgehenden Landweg; jede dritte Weltspalte
    // bekommt zusätzlich eine stärkere Nord/Süd-Verbindung. Die Formeln benutzen
    // Weltkoordinaten, deshalb passen die Enden über Chunk-Grenzen exakt zusammen.
    const x0=chunk.originX-4,x1=chunk.originX+CHUNK_SIZE+4,z0=chunk.originZ-4,z1=chunk.originZ+CHUNK_SIZE+4,row=chunk.cz,col=chunk.cx;
    const horizontalKind=row%3===0?'gravel':row%2===0?'dirt':'sod';
    const horizontalShoulder=horizontalKind==='gravel'?'dirt':horizontalKind==='dirt'?'sod':'dirt';
    const horizontalWidth=row%3===0?4.55:3.05;
    const horizontal=[];
    for(let i=0;i<=8;i+=1){const x=x0+(x1-x0)*i/8;horizontal.push({x,z:this.worldHorizontalPathZ(x,row)});}
    this.buildWorldwidePathRibbon(chunk,horizontal,horizontalWidth,horizontalKind,horizontalShoulder,`v308-world-east-west-${row}`);

    let vertical=null;
    if(col%3===0){
      const verticalKind=col%2===0?'gravel':'dirt',verticalShoulder=verticalKind==='gravel'?'sod':'gravel',points=[];
      for(let i=0;i<=8;i+=1){const z=z0+(z1-z0)*i/8;points.push({x:this.worldVerticalPathX(z,col),z});}
      vertical=this.buildWorldwidePathRibbon(chunk,points,4.35,verticalKind,verticalShoulder,`v308-world-north-south-${col}`);

      // Abdeckung der Kreuzung: eine etwas höher liegende, runde Deckfläche verhindert
      // Flimmern, wenn sich zwei Weg-Meshes schneiden.
      let ix=this.worldVerticalPathX(chunk.originZ+CHUNK_SIZE*.5,col),iz=this.worldHorizontalPathZ(ix,row);
      for(let n=0;n<4;n+=1){ix=this.worldVerticalPathX(iz,col);iz=this.worldHorizontalPathZ(ix,row);}
      if(ix>=chunk.originX-5&&ix<=chunk.originX+CHUNK_SIZE+5&&iz>=chunk.originZ-5&&iz<=chunk.originZ+CHUNK_SIZE+5){
        this.createTerrainCircle(chunk,ix,iz,3.35,this.groundPathMaterial(horizontalKind==='sod'?'dirt':horizontalKind),36,.078);
      }
    }
    chunk.worldPathPlan={row,col,horizontalKind,horizontalWidth,hasVertical:!!vertical};
  }

  connectVillageToWorldwidePath(chunk,plan){
    if(!plan?.main?.length)return;
    const candidates=[plan.main[0],plan.main[plan.main.length-1]].map((p)=>{
      const target={x:p.x,z:this.worldHorizontalPathZ(p.x,chunk.cz)};
      return {p,target,d:Math.hypot(target.x-p.x,target.z-p.z)};
    }).sort((a,b)=>a.d-b.d);
    const best=candidates[0];if(!best||best.d<4.2)return;
    const mid={x:(best.p.x+best.target.x)*.5,z:(best.p.z+best.target.z)*.5};
    const tangentX=best.target.x-best.p.x,tangentZ=best.target.z-best.p.z,len=Math.max(.001,Math.hypot(tangentX,tangentZ));
    mid.x+=-tangentZ/len*2.2;mid.z+=tangentX/len*2.2;
    this.buildCurvedVillagePath(chunk,[best.p,mid,best.target],3.05,plan.secondaryKind,plan.shoulderKind);
    this.createTerrainCircle(chunk,best.target.x,best.target.z,2.7,this.groundPathMaterial(plan.mainKind),32,.079);
  }
  ...
  buildChunkPaths(chunk) {
    // V308: zuerst das weltweite Wegenetz, danach – falls vorhanden – das Dorfnetz.
    // Dorfwege werden gezielt mit dem globalen Landweg verbunden.
    chunk.roadSegments=[];
    this.buildChunkWorldwidePaths(chunk);
    ...
    const junctionMat=this.groundPathMaterial(plan.mainKind);
    const junctions=[
    ...
    for(const {p,r} of junctions)this.createTerrainCircle(chunk,p.x,p.z,r,junctionMat,32,.076);
    this.connectVillageToWorldwidePath(chunk,plan);
  }

  buildChunkVillageWater(chunk){
    // V310 — Schritt 3 abgeschlossen: Wasser besitzt jetzt nicht nur eine Oberfläche,
    // sondern einen sichtbaren Unterwasserraum mit Boden und Innenwänden.
    ...
    for(let index=0;index<features.length;index+=1){
      ...
      const basinWall=new THREE.Mesh(new THREE.CylinderGeometry(.72,1,feature.depth,72,3,true),earthMaterial());
      basinWall.scale.set(feature.rx,1,feature.rz);basinWall.position.y=-feature.depth*.50;basinWall.name=`v310-underwater-earth-wall-${index}`;basinWall.receiveShadow=true;holder.add(basinWall);
      const bed=new THREE.Mesh(new THREE.CircleGeometry(1,72),earthMaterial());bed.rotation.x=-Math.PI/2;bed.scale.set(feature.rx*.72,feature.rz*.72,1);bed.position.y=-feature.depth+.025;bed.name=`v310-underwater-earth-bed-${index}`;bed.receiveShadow=true;holder.add(bed);

      // Bergteich: die hohe Bergseite bekommt sichtbare Felsen statt eines künstlichen
      // schwarzen Rings. Die Felsen werden nur auf dem Hangbogen verteilt.
      if(feature.mountain){
        const rndRock=seededRandom((WORLD_SEED+31041+chunk.cx*131+chunk.cz*257+index*53)>>>0),rockCount=14;
        for(let r=0;r<rockCount;r+=1){
          const localAngle=feature.highAngle+(rndRock()-.5)*1.45,rr=1.00+rndRock()*.16,lx=Math.cos(localAngle)*feature.rx*rr,lz=Math.sin(localAngle)*feature.rz*rr;
          const rock=new THREE.Mesh(new THREE.DodecahedronGeometry(.72+rndRock()*.58,0),stoneMaterial());
          rock.position.set(lx,.18+rndRock()*.62,lz);rock.scale.set(.9+rndRock()*.75,.7+rndRock()*.7,.9+rndRock()*.7);rock.rotation.set(rndRock()*1.2,rndRock()*Math.PI*2,rndRock()*.8);rock.castShadow=!!this.state.world?.shadows;rock.receiveShadow=true;rock.name=`v310-mountain-water-rock-${index}-${r}`;holder.add(rock);
        }
      }

      const reedCount=22,reeds=new THREE.InstancedMesh(reedGeo,reedMat.clone(),reedCount),matrix=new THREE.Matrix4(),q=new THREE.Quaternion(),rnd=seededRandom((WORLD_SEED+31011+chunk.cx*97+chunk.cz*193+index*37)>>>0);
      for(let r=0;r<reedCount;r++){const a=(r/reedCount)*Math.PI*2+(rnd()-.5)*.18,rr=.97+rnd()*.095,lx=Math.cos(a)*feature.rx*rr,lz=Math.sin(a)*feature.rz*rr,sc=.65+rnd()*.85;matrix.compose(new THREE.Vector3(lx,.34*sc,lz),q,new THREE.Vector3(sc,sc,sc));reeds.setMatrixAt(r,matrix);}
      reeds.instanceMatrix.needsUpdate=true;reeds.name=`v310-village-water-reeds-${index}`;holder.add(reeds);chunk.group.add(holder);
      ...
      // Nemo bleibt ausschließlich innerhalb der Ellipse und mindestens 60 cm unter Wasser.
      const fishCount=Math.max(feature.rx,feature.rz)>18?4:2;
      for(let f=0;f<fishCount;f+=1){
        const visual=this.createAnimalVisual('clownfish');if(!visual)continue;
        const group=new THREE.Group();group.add(visual);chunk.group.add(group);
        const fish={group,visual,type:'clownfish',feature,angle:(f/fishCount)*Math.PI*2,phase:f*1.47,speed:.20+f*.023,radiusFactor:.28+f*.075,chunk};
        chunk.villageFish.push(fish);this.villageFish.push(fish);
      }
    }
  }
  ...
  buildChunkForest(chunk) {
    ...
    for (let i = 0; i < count; i += 1) {
      ...
      if (y > 62 || pointInsideWaterFeature(x,z,7) || this.pointNearChunkRoad(chunk, x, z, 2.8) || this.pointNearVillageStep4Reservation(chunk,x,z,3.2) || chunk.villages.some((v)=>Math.hypot(x-v.x,z-v.z)<50)) continue;
  ...
  buildChunkRocksAndBushes(chunk) {
    ...
    const create = (type, count) => {
      ...
      for(let i=0;i<count;i+=1){
        ...
        if(y>72||pointInsideWaterFeature(x,z,type==='bush'?3:5)||this.pointNearChunkRoad(chunk,x,z,type==='bush'?1.1:2.1)||this.pointNearVillageStep4Reservation(chunk,x,z,type==='bush'?1.5:2.6)||chunk.villages.some((v)=>Math.hypot(x-v.x,z-v.z)<42))continue;
...
buildChunkGrass(chunk) {
  ...
  buildChunkPlantsAndFlowers(chunk){
    ...
    for(let tries=0;tries<flowerCount*6&&used<flowerCount;tries+=1){const lx=3+random()*(CHUNK_SIZE-6),lz=3+random()*(CHUNK_SIZE-6),x=chunk.originX+lx,z=chunk.originZ+lz,y=terrainHeightAt(x,z);if(y>58||pointInsideWaterFeature(x,z,4)||this.pointNearChunkRoad(chunk,x,z,.75)||this.pointNearVillageStep4Reservation(chunk,x,z,1.1))continue;const vd=chunk.villages.length?Math.min(...chunk.villages.map((v)=>Math.hypot(x-v.x,z-v.z))):999;if(vd<13)continue;const sc=.72+random()*.8;q.setFromAxisAngle(new THREE.Vector3(0,1,0),random()*Math.PI*2);scale.set(sc,sc,sc);matrix.compose(new THREE.Vector3(lx,y+.16*sc,lz),q,scale);stemMesh.setMatrixAt(used,matrix);const colorIndex=Math.floor(random()*blooms.length),bi=counts[colorIndex]++;matrix.compose(new THREE.Vector3(lx,y+.34*sc,lz),q,new THREE.Vector3(sc,sc,sc));blooms[colorIndex].setMatrixAt(bi,matrix);used++;}
  ...
  buildChunkLandmarks(chunk) {
    ...
    if(y<-2||Math.abs(x-riverCenter(z))<24||this.pointNearVillageStep4Reservation(chunk,x,z,12)||chunk.villages.some(v=>Math.hypot(x-v.x,z-v.z)<55))return;
    const roll=random();
  ...
  updateAmbientCreatures(delta,now=performance.now()){
    ...
    for(const fish of this.villageFish||[]){const feature=fish.feature,chunk=fish.chunk;if(!feature||!chunk?.group?.parent)continue;fish.angle+=delta*fish.speed;const a=fish.angle+fish.phase,rf=Math.min(.58,fish.radiusFactor),lx=Math.cos(a)*feature.rx*rf,lz=Math.sin(a)*feature.rz*rf,c=Math.cos(feature.yaw||0),s=Math.sin(feature.yaw||0),bx=feature.x+lx*c-lz*s,bz=feature.z+lx*s+lz*c,bottom=terrainHeightAt(bx,bz),targetY=feature.level-Math.min(feature.depth*.55,1.35+rf*2.4)+Math.sin(now*.0018+fish.phase)*.16,by=Math.max(bottom+.42,Math.min(feature.level-.62,targetY));fish.group.position.set(bx-chunk.originX,by,bz-chunk.originZ);fish.group.rotation.y=-(a+(feature.yaw||0))+Math.PI/2;fish.group.visible=ellipseDistance(bx,bz,feature)<.72;this.setAnimalAnimation(fish.visual,true,delta);}
  }
  ...
  createAnimal(type,x,z,index,y=null) {
    ...
    const combatLevel=this.mainAccountLevel(),maxHp=this.animalScaledMaxHp(type,combatLevel);return {id:`animal-${type}-${index}`,type,profile,group,visual,mixer:visual?.userData?.mixer||null,idleAction:visual?.userData?.idleAction||null,moveAction:visual?.userData?.moveAction||null,x,z,y:baseY,targetX:x,targetZ:z,targetY:baseY,speed:profile.speed,nextTurn:0,active:true,respawnAt:0,level:combatLevel,maxHp,hp:maxHp,predatorTarget:null,attackCooldown:0,tamed:type==='horse'&&!!this.state.horseTamed};
  }
  ...
  spawnSavedBuilding(saved) {
    const object=this.createBuildObject(saved.type,Number(saved.x),Number(saved.z),Number(saved.rotation)||0,true,false,saved);
    object.userData.buildId=saved.id;
    this.ownBuildingObjects.set(saved.id,object);
    this.addBuildingHotspots(saved);
  }

  createBuildObject(type,x,z,rotation=0,owned=true,ghost=false,savedData=null) {
    const group=new THREE.Group();
    ...
    if(type==='campfire') {
      ...
      const houseAsset=this.createPlayerHouseAsset(savedData?.houseLevel||1,ghost);if(houseAsset)group.add(houseAsset);else{const base=new THREE.Mesh(new THREE.BoxGeometry(7.2,4.3,5.7),stone);base.position.y=2.15;group.add(base);const roof=new THREE.Mesh(new THREE.ConeGeometry(5.3,3.2,4),roofMat);roof.position.y=5.7;roof.rotation.y=Math.PI/4;roof.scale.z=.8;group.add(roof);}
    } else if(CHEST_DEFS[type]) {
      const chest=this.createChestAsset(type,ghost);if(chest)group.add(chest);else{const fallback=new THREE.Mesh(new THREE.BoxGeometry(type==='mediumChest'?1.55:1.15,.82,type==='mediumChest'?.9:.72),wood);fallback.position.y=.41;group.add(fallback);}
    } else {
    ...
    const explicitBaseY=Number(savedData?.baseY),spawnY=Number.isFinite(explicitBaseY)?explicitBaseY:terrainHeightAt(x,z);group.position.set(x,spawnY,z); group.rotation.y=rotation; group.userData={type,owned,ghost}; this.scene.add(group);
  ...
  // V274: Die Mann-/Frau-Rigs stammen direkt aus Ego-Shooter.KL. Dort werden
  // globale Export-Root-Tracks entfernt und Walk/Run als eigene, native Rigs
  // abgespielt. Genau dieses bewährte Verhalten wird im Center übernommen.
  sanitizeEgoLocomotionClip(clip){
    if(!clip?.clone)return null;const cloned=clip.clone();
    cloned.tracks=(cloned.tracks||[]).filter((track)=>{const name=String(track?.name||'');return !/(^|[./])(bip_01|bip Footsteps|RootNode|rig_CharRoot|_rootJoint)\.(position|quaternion|rotation|scale)$/i.test(name);});
    cloned.resetDuration?.();return this.makeInPlaceLocomotionClip(cloned);
  }

  normalizeEgoCenterVisual(scene,targetHeight=1.76){
    const wrapper=new THREE.Group();wrapper.userData.centerEgoLocomotionVisual=true;wrapper.add(scene);scene.position.set(0,0,0);scene.rotation.set(0,0,0);scene.scale.set(1,1,1);wrapper.updateMatrixWorld(true);
    const bones=[];scene.traverse((object)=>{if(object?.isBone||/^bip /i.test(String(object?.name||'')))bones.push(object);});
    const head=bones.find((object)=>/^bip Head_/i.test(object.name||''))||bones.find((object)=>/Head/i.test(object.name||'')),feet=bones.filter((object)=>/^bip [LR] Foot_/i.test(object.name||'')),pelvis=bones.find((object)=>/^bip Pelvis_/i.test(object.name||''));
    const wp=new THREE.Vector3(),headPos=new THREE.Vector3(),pelvisPos=new THREE.Vector3();if(head)head.getWorldPosition(headPos);if(pelvis)pelvis.getWorldPosition(pelvisPos);let floorY=Infinity;for(const foot of feet){foot.getWorldPosition(wp);floorY=Math.min(floorY,wp.y);}if(!Number.isFinite(floorY))floorY=0;
    const skeletonHeight=head?Math.max(.75,headPos.y-floorY+.20):targetHeight,scale=clamp(targetHeight/skeletonHeight,.72,1.45);wrapper.scale.setScalar(scale);wrapper.position.set(-(pelvis?pelvisPos.x*scale:0),-floorY*scale,-(pelvis?pelvisPos.z*scale:0));wrapper.rotation.y=CHARACTER_MODEL_YAW;
    wrapper.traverse((object)=>{if(!object.isMesh)return;object.castShadow=!!this.state.world?.shadows;object.receiveShadow=!!this.state.world?.shadows;const mats=Array.isArray(object.material)?object.material:[object.material];for(const material of mats){if(material?.map)material.map.colorSpace=THREE.SRGBColorSpace;if(material){material.envMapIntensity=.25;this.cacheOriginalMaterial(material);}}});wrapper.updateMatrixWorld(true);return wrapper;
  }
  ...
  switchPlayerLocomotion(action){
    ...
    const previous=this.playerActiveAction,standTransition=action===this.playerIdleAction||previous===this.playerIdleAction,blend=standTransition?.30:.14;
    if(previous&&previous!==action){previous.fadeOut?.(blend);previous.enabled=true;previous.paused=false;}
    action.enabled=true;action.paused=false;action.reset?.();action.fadeIn?.(blend);action.play?.();this.playerActiveAction=action;
  }

  hasWeaponForStandPose(){
    const appearance=this.state.ownerAppearance||{},staffHeld=this.isStaffActive&&!this.isPublicPlayerMode()?String(appearance.heldItem||'none'):'none';
    return !!(this.ownerGreatSwordEquipped?.()||Math.floor(Number(this.state.swordSystem?.equippedTier)||0)>0||String(this.state.equippedTool||'')||staffHeld!=='none');
  }

  applyNativeStandWeaponHands(delta=.016){
    if(!this.playerUsesNativeIdle||!this.hasWeaponForStandPose())return;
    const alpha=1-Math.exp(-Math.max(.001,delta)*12.5),apply=(bone)=>{
      if(!bone)return;const q=bone.userData.__centerIdleQuaternion||bone.userData.__centerBindQuaternion;if(q)bone.quaternion.slerp(q,alpha);
    };
    apply(this.playerBones.shoulderRight);apply(this.playerBones.shoulderLeft);
    apply(this.playerBones.upperRight);apply(this.playerBones.upperLeft);
  ...
  cachePlayerBones(root) {
    ...
    this.playerBones={
      ...
      chest:find(/(?:^chest|spine_?2|upperchest|(?:^|[_ .-])chest$)/i),
      hips:find(/(?:^hip|hips|pelvis|bip Pelvis|mixamorig:Hips)/i),
      neck:find(/(?:^neck|neck_|(?:^|[_ .-])neck$)/i),
      head:find(/(?:^head|head_|(?:^|[_ .-])head$)/i),
  ...
  applyIdlePose(delta=.016,instant=false) {
    if(!this.playerModel||this.playerUsesNativeIdle)return;
  ...
  resetLocomotionToIdle(instant=false) {
    for(const action of [this.playerWalkAction,this.playerRunAction,this.playerAction])if(action){action.paused=true;action.enabled=true;action.setEffectiveWeight?.(1);}
    if(this.playerMixer)this.playerMixer.timeScale=1;if(this.playerWalkMixer)this.playerWalkMixer.timeScale=1;if(this.playerRunMixer)this.playerRunMixer.timeScale=1;
    if(this.playerDualLocomotion){if(this.playerWalkVisual)this.playerWalkVisual.visible=true;if(this.playerRunVisual)this.playerRunVisual.visible=false;}
    this.playerActiveAction=null;this.playerActionWasMoving=false;
    this.idleStartedAt=performance.now();this.idleBlend=instant?1:0;
    if(this.playerUsesNativeIdle&&this.playerIdleAction&&this.playerMixer){this.playerIdleAction.enabled=true;this.playerIdleAction.paused=false;this.playerIdleAction.reset?.();this.playerIdleAction.setEffectiveWeight?.(1);this.playerIdleAction.play?.();this.playerActiveAction=this.playerIdleAction;this.playerMixer.update(0);return;}
  ...
  updatePlayerAnimation(delta,moving,sprint) {
    ...
    if(this.isOwnerWizardActive()&&this.playerMixer&&(this.playerWalkAction||this.playerIdleAction)){
      const nowAnim=performance.now();if(this.wizardNativeAction&&nowAnim<this.wizardNativeActionUntil){this.wizardNativeAction.paused=false;this.playerMixer.timeScale=1;this.playerMixer.update(delta);this.playerActionWasMoving=humanMoving;this.idleBlend=humanMoving?0:1;}else{if(this.wizardNativeAction){this.wizardNativeAction.fadeOut?.(.08);this.wizardNativeAction.paused=true;this.wizardNativeAction=null;this.wizardNativeActionUntil=0;}let desired=null;if(humanMoving){const speedMultiplier=clamp(Number(this.ownerFlags.speedMultiplier)||1,1,OWNER_MAX_SPEED_MULTIPLIER);desired=speedMultiplier>1.001&&this.playerRunAction?this.playerRunAction:(sprint&&this.playerJogAction?this.playerJogAction:(this.playerWalkAction||this.playerAction));}else desired=this.hasWeaponForStandPose()&&this.playerWeaponIdleAction?this.playerWeaponIdleAction:this.playerIdleAction;if(desired){this.switchPlayerLocomotion(desired);const size=clamp(Number(appearance.size)||1,.45,2.5);this.playerMixer.timeScale=(desired===this.playerRunAction?1.08:desired===this.playerJogAction?1.04:1)/Math.sqrt(size);this.playerMixer.update(delta);}this.playerActionWasMoving=humanMoving;this.idleBlend=humanMoving?0:1;}
    }else if(this.playerDualLocomotion&&(this.playerWalkMixer||this.playerRunMixer)){
      const running=!!(humanMoving&&sprint&&this.playerRunAction);if(this.playerWalkVisual)this.playerWalkVisual.visible=!running;if(this.playerRunVisual)this.playerRunVisual.visible=running;
      if(humanMoving){const size=this.isStaffActive&&this.staffCapabilities?.size?clamp(Number(appearance.size)||1,.45,2.5):1;if(running){if(this.playerWalkAction)this.playerWalkAction.paused=true;if(this.playerRunAction){this.playerRunAction.enabled=true;this.playerRunAction.paused=false;this.playerRunAction.setEffectiveWeight?.(1);this.playerRunMixer.timeScale=1.05/Math.sqrt(size);this.playerRunMixer.update(delta);}}else{if(this.playerRunAction)this.playerRunAction.paused=true;if(this.playerWalkAction){this.playerWalkAction.enabled=true;this.playerWalkAction.paused=false;this.playerWalkAction.setEffectiveWeight?.(1);this.playerWalkMixer.timeScale=1.02/Math.sqrt(size);this.playerWalkMixer.update(delta);}}this.playerActionWasMoving=true;this.idleBlend=0;}
      else{if(this.playerWalkAction)this.playerWalkAction.paused=true;if(this.playerRunAction)this.playerRunAction.paused=true;this.playerActionWasMoving=false;this.playerActiveAction=null;if(!flying&&!scooter&&!plane&&!mounted)this.applyIdlePose(delta,false);}
    }else if(this.playerMixer&&(this.playerWalkAction||this.playerRunAction||this.playerAction||this.playerIdleAction)){
      if(humanMoving){const desired=sprint&&this.playerRunAction?this.playerRunAction:(this.playerWalkAction||this.playerAction);this.switchPlayerLocomotion(desired);const size=this.isStaffActive&&this.staffCapabilities?.size?clamp(Number(appearance.size)||1,.45,2.5):1;this.playerMixer.timeScale=((desired===this.playerRunAction)?1.08:(sprint&&!this.playerRunAction?1.32:1.02))/Math.sqrt(size);this.playerMixer.update(delta);this.playerActionWasMoving=true;this.idleBlend=0;}
      else if(this.playerUsesNativeIdle&&this.playerIdleAction&&!flying&&!scooter&&!plane&&!mounted){this.switchPlayerLocomotion(this.playerIdleAction);this.playerMixer.timeScale=1;this.playerMixer.update(delta);this.applyNativeStandWeaponHands(delta);this.playerActionWasMoving=false;this.idleBlend=1;}
      else{if(this.playerActionWasMoving||this.playerActiveAction){for(const action of [this.playerWalkAction,this.playerRunAction,this.playerAction,this.playerIdleAction])if(action){action.fadeOut?.(.10);action.paused=true;}this.playerActionWasMoving=false;this.playerActiveAction=null;this.idleStartedAt=performance.now();this.idleBlend=0;}if(!this.playerUsesNativeIdle&&!flying&&!scooter&&!plane&&!mounted)this.applyIdlePose(delta,false);}
  ...
  ensureFlightEffects() {
    // V330: Feuer-/Raketenstrahlen unter den Füßen vollständig entfernt.
    if(this.flightEffects){for(const node of [this.flightEffects.left,this.flightEffects.right,this.flightEffects.root])if(node){try{this.disposeGeneratedVisual(node);}catch{node.removeFromParent?.();}}this.flightEffects=null;}
  }

  updateFlightEffects(){this.ensureFlightEffects();}

  playWizardNativeAction(kind='weapon-attack'){
    if(!this.isOwnerWizardActive()||!this.playerMixer)return false;let action=null;
    if(kind==='great-sword-draw-back')action=this.playerWizardDrawAction;
    else if(kind==='great-sword-slash-down')action=this.playerWizardAttackRightAction;
    else if(kind==='great-sword-slash-up')action=this.playerWizardAttackLeftAction;
    else if(kind==='weapon-attack'||kind==='attack')action=(this.wizardAttackSide++%2===0?this.playerWizardAttackRightAction:this.playerWizardAttackLeftAction);
    if(!action)return false;if(this.wizardNativeAction&&this.wizardNativeAction!==action)this.wizardNativeAction.fadeOut?.(.07);action.enabled=true;action.paused=false;action.clampWhenFinished=false;action.setLoop?.(THREE.LoopOnce,1);action.reset?.();action.fadeIn?.(.07);action.play?.();this.wizardNativeAction=action;const duration=Math.max(.30,Number(action.getClip?.()?.duration)||.55);this.wizardNativeActionUntil=performance.now()+duration*1000;this.playerActiveAction=action;this.actionAnimation=null;return true;
  }

  triggerActionAnimation(kind='chop',duration=560) {
    if(this.playWizardNativeAction(kind))return;
  ...
  applyActionAnimation(now=performance.now()) {
    ...
    if(action.kind==='jump'){
    ...
    }else if(action.kind==='great-sword-draw-back'||action.kind==='great-sword-sheath-back'){
      const phase=swing;
      ...
      // V327: Die Schlagpose wird NACH Walk/Run auf den Oberkörper gelegt. Dadurch laufen
      // Lauf- und Sprintanimation an den Beinen normal weiter, während Arm/Brust schlagen.
      // Zwei diagonale Great-Sword-Schläge wechseln sich bei jedem Klick ab.
      const smooth=(x)=>{x=clamp(x,0,1);return x*x*(3-2*x);},locomotionBoost=this.walking?(this.sprinting?1.12:1.06):1;
      let startW=0,endW=0;
      ...
      if(rightUpper){rightUpper.rotateX(mix(startPose.ux,endPose.ux)*locomotionBoost);rightUpper.rotateY(mix(startPose.uy,endPose.uy)*locomotionBoost);rightUpper.rotateZ(mix(startPose.uz,endPose.uz)*locomotionBoost);}
      if(rightLower){rightLower.rotateX(mix(startPose.lx,endPose.lx)*locomotionBoost);rightLower.rotateY(mix(-.10,.20)*locomotionBoost);}
      if(chest){chest.rotateY(mix(startPose.cy,endPose.cy)*locomotionBoost);chest.rotateX(-.05*(startW+endW)*locomotionBoost);}
  ...
  createGalaxyTexture(width=128,height=256,theme='owner') {
    ...
    // V280: sichtbare Galaxie statt Vollflächen-Farbe: viel schwarzer Weltraum,
    // kräftige Nebelarme, dunkle Staubbahnen, heller Kern und echte Sternfelder.
    ctx.fillStyle='#010103';ctx.fillRect(0,0,width,height);
    const bg=ctx.createLinearGradient(0,0,width,height);bg.addColorStop(0,rgb(dark,.98));bg.addColorStop(.30,'rgba(0,0,0,.98)');bg.addColorStop(.60,rgb(dark.clone().lerp(primary,.12),.98));bg.addColorStop(1,'rgba(0,0,0,1)');ctx.fillStyle=bg;ctx.fillRect(0,0,width,height);
    const nebula=(x,y,r,c1,c2,a)=>{const g=ctx.createRadialGradient(width*x,height*y,0,width*x,height*y,Math.max(width,height)*r);g.addColorStop(0,rgb(white,a*.50));g.addColorStop(.08,rgb(accent,a*.82));g.addColorStop(.25,rgb(c1,a));g.addColorStop(.50,rgb(c2,a*.58));g.addColorStop(.78,rgb(c1,a*.16));g.addColorStop(1,'rgba(0,0,0,0)');ctx.fillStyle=g;ctx.fillRect(0,0,width,height);};
    nebula(.22,.23,.45,primary,secondary,.78);nebula(.74,.57,.50,secondary,primary,.72);nebula(.38,.88,.34,accent,primary,.52);
    // Spiral-Arme / Gaswolken
    ctx.save();ctx.globalCompositeOperation='screen';ctx.lineCap='round';
    for(let i=0;i<5;i++){ctx.beginPath();const c=i%3===0?accent:i%3===1?primary:secondary;ctx.strokeStyle=rgb(c,.16-i*.014);ctx.lineWidth=Math.max(2,width*(.075-i*.009));ctx.moveTo(-width*.22,height*(.12+i*.15));ctx.bezierCurveTo(width*.15,height*(.02+i*.10),width*.61,height*(.78-i*.055),width*1.20,height*(.38+i*.12));ctx.stroke();}
    ctx.restore();
    // Schwarze Staubbahnen schneiden durch die Nebel und geben Tiefe.
    ctx.save();ctx.globalCompositeOperation='multiply';ctx.lineCap='round';for(let i=0;i<4;i++){ctx.beginPath();ctx.strokeStyle=`rgba(0,0,0,${.42-i*.055})`;ctx.lineWidth=Math.max(5,width*(.095-i*.012));ctx.moveTo(-width*.08,height*(.20+i*.18));ctx.bezierCurveTo(width*.30,height*(.03+i*.14),width*.60,height*(.70-i*.04),width*1.10,height*(.50+i*.11));ctx.stroke();}ctx.restore();
    // Galaxiekern
    const core=ctx.createRadialGradient(width*.52,height*.48,0,width*.52,height*.48,Math.max(width,height)*.16);core.addColorStop(0,'rgba(255,255,255,.82)');core.addColorStop(.10,rgb(accent,.72));core.addColorStop(.30,rgb(primary,.36));core.addColorStop(.68,rgb(secondary,.10));core.addColorStop(1,'rgba(0,0,0,0)');ctx.fillStyle=core;ctx.fillRect(0,0,width,height);
    // Sternenfeld – fester Seed, damit jedes Teil desselben Ranges zusammenpasst.
    const rnd=seededRandom(2800909),count=Math.max(190,Math.min(520,Math.round(width*height/115)));ctx.save();ctx.globalCompositeOperation='screen';
    for(let i=0;i<count;i++){const x=rnd()*width,y=rnd()*height,b=rnd(),r=b>.982?1.6+rnd()*2.4:b>.88?.65+rnd()*.95:.20+rnd()*.48;const c=b>.80?white:(b>.52?accent:(rnd()>.55?primary:secondary));ctx.beginPath();ctx.fillStyle=rgb(c,.50+b*.48);ctx.arc(x,y,r,0,Math.PI*2);ctx.fill();if(b>.985){ctx.strokeStyle=rgb(accent,.58);ctx.lineWidth=.6;ctx.beginPath();ctx.moveTo(x-r*4,y);ctx.lineTo(x+r*4,y);ctx.moveTo(x,y-r*4);ctx.lineTo(x,y+r*4);ctx.stroke();}}
    for(let i=0;i<160;i++){ctx.fillStyle=rgb(rnd()>.5?primary:accent,.10+rnd()*.20);ctx.fillRect(rnd()*width,rnd()*height,.45,.45);}ctx.restore();
    const texture=new THREE.CanvasTexture(canvas);texture.colorSpace=THREE.SRGBColorSpace;texture.wrapS=texture.wrapT=THREE.RepeatWrapping;texture.repeat.set(1,1.55);texture.userData.__centerRuntimeGalaxyTexture=true;texture.userData.__centerStaffTheme=theme;texture.userData.__centerGalaxyPattern='v280-deep-space';texture.needsUpdate=true;return texture;
  }
...
updateOwnerAura(delta=.016,now=performance.now()) {
  ...
  createPlayerSwordVisual(tier=1){const def=this.swordTierDefinition(tier),nodeName=PLAYER_SWORD_KIT_NODES[def.tier-1],asset=this.cloneCenterAsset('swordKit',{nodeName,targetSize:1.48,bottomAlign:false,center:true});if(!asset)return null;asset.name=`center-player-sword-tier-${def.tier}`;asset.traverse((object)=>{if(object.isMesh){object.castShadow=!!this.state.world?.shadows;object.receiveShadow=false;}});asset.rotation.set(0,Math.PI,.06);return asset;}

  createOwnerGreatSwordVisual({handGrip=false}={}){
    const asset=this.cloneCenterAsset('ownerGreatSword',{targetSize:1.92,bottomAlign:false,center:!handGrip});if(!asset)return null;
    if(handGrip){
  ...
  applyOwnerGreatSwordCarryVisual(){
    ...
    if(this.ownerGreatSwordCarryObject)this.ownerGreatSwordCarryObject.visible=!this.firstPerson&&allowed&&!active&&!this.greatSwordThrowState;
  }

  toggleOwnerGreatSwordActive(force=null){
    if(!this.isOwnerActive)return false;
    const appearance=this.state.ownerAppearance||{};
    ...
    setTimeout(()=>{
      if(token!==this.greatSwordDrawToken||!this.opened)return;
      appearance.ownerGreatSwordActive=next;
      this.applyHeldItemVisual();this.applyOwnerGreatSwordCarryVisual();this.renderHud(true);this.saveState(true);this.publishPresence(true).catch(()=>{});
      if(this.ownerPanel?.classList.contains('is-open'))this.renderOwnerMenu();
      this.toast(next?'Owner Great Sword gezogen.':'Owner Great Sword weggesteckt.');
    },next?220:170);
    return true;
  }
  ...
  createHeldItemMesh(kind='none',theme='owner') {
    ...
    if(kind==='greatSword'){const asset=this.createOwnerGreatSwordVisual({handGrip:true});if(!asset)return null;group.add(asset);group.userData.assetBased=true;/* V327: horizontal aus dem echten Griff heraus; keine zusätzliche Gruppenrotation. */group.rotation.set(0,0,0);}
  ...
  currentFirstPersonArmsIdle(){const kind=this.ownerHeldObject?.userData?.kind||this.firstPersonHeldObject?.userData?.kind||'';return ['sword','greatSword','kitSword','shovel','hoe','axe','hammer','pickaxe','eternalFlame','torch','spear'].includes(kind)?'knife_idle':'guard_idle';}
...
applyStaffVehicle(){
  ...
  applyGalaxyMaterialMode(material,active,texture=null){
    ...
    if(active){
      ...
      if(this.materialSupportsEmissive(material)){
        ...
        material.emissive?.set?.(cfg.emissive);if('emissiveIntensity' in material)material.emissiveIntensity=1.18;
      }else if(material.emissiveMap){material.emissiveMap=null;programChanged=true;}
      material.color?.set?.(0xffffff);if('metalness' in material)material.metalness=.16;if('roughness' in material)material.roughness=.38;
    }else{
  ...
  getStaffSkinTexture(theme='owner'){
    theme=normalizeStaffTheme(theme);let texture=this.staffSkinTextureCache.get(theme);if(texture)return texture;texture=this.createGalaxyTexture(512,1024,theme);texture.repeat.set(.92,1.48);texture.userData.__centerSharedStaffSkinTexture=true;this.staffSkinTextureCache.set(theme,texture);return texture;
  }
...
applyHeldItemVisual() {
    const appearance=this.state.ownerAppearance||{skin:'normal',heldItem:'none'},disguised=this.isPublicPlayerMode(),effectiveSkin=disguised?'normal':appearance.skin,effectiveVehicle=disguised?'none':appearance.vehicle,formAllowsItems=(!this.isStaffActive||['normal','galaxy'].includes(effectiveSkin))&&!['scooter','plane'].includes(effectiveVehicle),greatSwordActive=this.ownerGreatSwordEquipped(),selectedKind=greatSwordActive?'greatSword':this.isStaffActive&&!disguised?appearance.heldItem:'none',allowedItems=this.staffCapabilities?.items||['none'],staffKind=selectedKind==='greatSword'&&this.isOwnerActive?'greatSword':allowedItems.includes(selectedKind)?selectedKind:'none',normalSwordKind=Math.floor(Number(this.state.swordSystem?.equippedTier)||0)>0?'kitSword':'none',toolKind=this.state.equippedTool==='axe'||this.state.equippedTool==='ironAxe'?'axe':this.state.equippedTool==='pickaxe'?'pickaxe':this.state.equippedTool==='hammer'?'hammer':this.state.equippedTool==='torch'?'torch':this.state.equippedTool==='spear'?'spear':this.state.equippedTool==='bow'?'bow':normalSwordKind,kind=formAllowsItems?(staffKind&&staffKind!=='none'?staffKind:toolKind):'none',theme=greatSwordActive?'owner':this.appearanceTheme('heldItem'),currentKind=this.ownerHeldObject?.userData?.kind||'none',currentTheme=this.ownerHeldObject?.userData?.theme||'owner',currentTier=Number(this.ownerHeldObject?.userData?.swordTier)||0,targetTier=kind==='kitSword'?Math.floor(Number(this.state.swordSystem?.equippedTier)||0):0;
    if(kind==='none'){this.disposeHeldVisual(this.ownerHeldObject);this.ownerHeldObject=null;this.ownerHeldAnchor?.removeFromParent?.();this.ownerHeldAnchor=null;this.ownerItemLight=null;this.disposeHeldVisual(this.firstPersonHeldObject);this.firstPersonHeldObject=null;this.applyOwnerGreatSwordCarryVisual();return;}
    if(currentKind===kind&&currentTheme===theme&&currentTier===targetTier&&this.ownerHeldAnchor){if(!this.firstPersonHeldObject||this.firstPersonHeldObject.userData?.kind!==kind||this.firstPersonHeldObject.userData?.theme!==theme)this.createFirstPersonHeldItem(kind);this.syncOwnerHeldAnchorPose();this.updateHeldItemTransform(performance.now(),true);this.applyOwnerGreatSwordCarryVisual();this.applyOwnerVisualState();return;}
    ...
    const mesh=this.createHeldItemMesh(kind,theme);if(!mesh)return;const hand=this.playerBones.handRight;if(hand){const anchor=new THREE.Group();anchor.name='center-held-item-grip';anchor.userData.kind=kind;anchor.userData.theme=theme;if(['sword','greatSword','kitSword','staff','eternalFlame','shovel','pickaxe','hoe','axe','hammer'].includes(kind)){anchor.userData.worldLockedGrip=true;this.modelPivot.add(anchor);}else{hand.add(anchor);const grips={torch:{p:[.012,-.08,.068],r:[Math.PI-.18,.03,-.15]},spear:{p:[.012,-.09,.07],r:[Math.PI-.12,.02,-.1]},bow:{p:[.01,-.07,.065],r:[Math.PI-.2,.02,-.2]}};const tr=grips[kind]||{p:[.012,-.08,.068],r:[Math.PI-.18,.03,-.15]};anchor.position.set(...tr.p);anchor.rotation.set(...tr.r);}anchor.add(mesh);mesh.userData.fixedToHand=true;this.ownerHeldAnchor=anchor;}else this.modelPivot.add(mesh);this.ownerHeldObject=mesh;this.ownerItemLight=mesh.userData.light||null;this.syncOwnerHeldAnchorPose();this.createFirstPersonHeldItem(kind);if(this.firstPerson)this.ensureFirstPersonArms().then(()=>this.playFirstPersonArmsAction(this.currentFirstPersonArmsIdle(),true)).catch(()=>{});this.updateHeldItemTransform(performance.now(),true);this.applyOwnerGreatSwordCarryVisual();this.applyOwnerVisualState();
  }
...
createStaffCloak(theme='owner',compact=false){
    ...
    // V285: etwas groesser als V284, damit der Umhang nicht schon auf Brusthoehe endet.
    const asset=this.cloneCenterAsset('staffCape',{targetHeight:compact?1.30:1.47,bottomAlign:false,center:true});
    // Root = fester Knochen-Anker. visualPivot = NUR Stoffbewegung. Dadurch kann die
    // Flug-/Laufbewegung nicht mehr die Knochenrotation ueberschreiben und der Umhang
    // bleibt in jeder Pose fest am oberen Ruecken/Hals.
    const root=new THREE.Group(),visualPivot=new THREE.Group();root.add(visualPivot);root.userData.visualPivot=visualPivot;
    if(!asset){
      const h=compact?1.25:1.42,wTop=compact?.35:.42,wBottom=compact?.59:.70,z=0;
      ...
      const mesh=new THREE.Mesh(geo,mat);mesh.castShadow=!compact;mesh.receiveShadow=false;visualPivot.add(mesh);root.userData.fallback=true;
    }else{
      asset.updateMatrixWorld(true);const capeBox=new THREE.Box3().setFromObject(asset);
      if(!capeBox.isEmpty()){
        // Oberkante exakt auf den Halsanker legen und seitlich mittig halten.
        const center=capeBox.getCenter(new THREE.Vector3());asset.position.x-=center.x;asset.position.z-=center.z;asset.position.y-=capeBox.max.y;
      }
      visualPivot.add(asset);visualPivot.updateMatrixWorld(true);
      const texture=this.createGalaxyTexture(compact?160:320,compact?320:640,theme);texture.repeat.set(.88,1.34);
      visualPivot.traverse((object)=>{if(!object.isMesh&&!object.isSkinnedMesh)return;const galaxyMat=new THREE.MeshStandardMaterial({map:texture,emissiveMap:texture,color:0xffffff,emissive:cfg.emissive,emissiveIntensity:compact?.52:.82,metalness:.04,roughness:.48,side:THREE.DoubleSide,transparent:false});object.material=galaxyMat;object.castShadow=!compact;object.receiveShadow=false;});
    }
    ...
    // Die leichte Grundneigung sitzt nur auf dem Stoff-Pivot, niemals auf dem Anker.
    visualPivot.rotation.set(.035,0,0);root.userData.baseRotationX=.035;return root;
  }
...
applyOwnerWearables(){
    const appearance=this.state.ownerAppearance||{},cloakTheme=this.appearanceTheme('cloak'),capeTheme=this.appearanceTheme('cape'),hatTheme=this.appearanceTheme('hat'),allowed=!!(this.isStaffActive&&this.staffCapabilities?.ownerCosmetics&&!this.isPublicPlayerMode()&&['normal','galaxy'].includes(appearance.skin||'normal')),wantCloak=allowed&&!!appearance.cloak,wantCape=allowed&&!!appearance.cape,wantHat=allowed&&!!appearance.hat;
    if(this.ownerCloakObject&&this.ownerCloakObject.userData?.theme!==cloakTheme){this.disposeGeneratedVisual(this.ownerCloakObject);this.ownerCloakObject=null;}if(this.ownerCapeObject&&this.ownerCapeObject.userData?.theme!==capeTheme){this.disposeGeneratedVisual(this.ownerCapeObject);this.ownerCapeObject=null;}if(this.ownerHatObject&&this.ownerHatObject.userData?.theme!==hatTheme){this.disposeGeneratedVisual(this.ownerHatObject);this.ownerHatObject=null;}
    if(!wantCloak&&this.ownerCloakObject){this.disposeGeneratedVisual(this.ownerCloakObject);this.ownerCloakObject=null;}if(!wantCape&&this.ownerCapeObject){this.disposeGeneratedVisual(this.ownerCapeObject);this.ownerCapeObject=null;}if(!wantHat&&this.ownerHatObject){this.disposeGeneratedVisual(this.ownerHatObject);this.ownerHatObject=null;}
    if(wantCloak&&!this.ownerCloakObject){const cloak=this.createStaffCloak(cloakTheme);this.modelPivot.add(cloak);this.ownerCloakObject=cloak;cloak.userData.centerBackAttachment=true;const backBone=this.playerBones?.neck||this.resolveBackAttachmentBone(this.playerModel,this.playerBones)||this.playerBones?.chest||this.playerBones?.spine,backPos=new THREE.Vector3(0,1.62,-.19),backQ=new THREE.Quaternion();if(!this.configureWearableFollower(cloak,this.modelPivot,backBone,backPos,backQ)){cloak.position.copy(backPos);cloak.quaternion.copy(backQ);}this.updateWearableFollower(cloak);}
    if(wantCape&&!this.ownerCapeObject){const cape=this.createGalaxyOwnerCape(capeTheme);this.modelPivot.add(cape);this.ownerCapeObject=cape;cape.userData.centerBackAttachment=true;const backBone=this.resolveBackAttachmentBone(this.playerModel,this.playerBones),backPos=new THREE.Vector3(0,1.46,-.22),backQ=new THREE.Quaternion();if(!this.configureWearableFollower(cape,this.modelPivot,backBone,backPos,backQ)){cape.position.copy(backPos);cape.quaternion.copy(backQ);}}
    ...
    this.applyOwnerGreatSwordCarryVisual();
  }
  ...
  updateOwnerWearables(delta=.016,now=performance.now()){
    const flying=this.isStaffActive&&this.ownerFlags.fly,motion=clamp(this.flightInputMagnitude||0,0,1);
    if(this.ownerCloakObject){
      this.updateWearableFollower(this.ownerCloakObject);const data=this.ownerCloakObject.userData||(this.ownerCloakObject.userData={}),visual=data.visualPivot||this.ownerCloakObject,targetPitch=flying?-.11:(motion>.08?-.035:.015),targetRoll=Math.sin(now*.0013)*(flying?.016:.009)+(motion*.025),alpha=1-Math.exp(-Math.max(.001,Number(delta)||.016)*(flying?3.0:2.4));
      data.pitch=THREE.MathUtils.lerp(Number(data.pitch)||0,targetPitch,alpha);data.roll=THREE.MathUtils.lerp(Number(data.roll)||0,targetRoll,alpha*.7);visual.rotation.x=(Number(data.baseRotationX)||.035)+data.pitch;visual.rotation.z=data.roll;if(this.ownerCloakObject.userData?.glow)this.ownerCloakObject.userData.glow.material.opacity=(this.ownerCloakObject.userData.compact?.11:.16)+Math.sin(now*.0022)*.015;if(this.ownerCloakObject.userData?.light)this.ownerCloakObject.userData.light.intensity=.34+Math.sin(now*.0028)*.05;
    }
    if(this.ownerCapeObject){
      this.updateWearableFollower(this.ownerCapeObject);const left=this.ownerCapeObject.userData?.left?.pivot,right=this.ownerCapeObject.userData?.right?.pivot,vertical=this.flightVerticalVelocity||0,speedBoost=clamp(Number(this.ownerFlags.speedMultiplier)||1,1,5),targetPose=this.wingFlightPose(flying,motion,vertical,now,speedBoost,!!this.sprinting),{sweep,spread}=this.smoothWingFlightPose(this.ownerCapeObject,targetPose,delta);
    ...
    if(this.ownerGreatSwordCarryObject){this.updateWearableFollower(this.ownerGreatSwordCarryObject);this.ownerGreatSwordCarryObject.visible=!this.firstPerson&&this.ownerGreatSwordCarried()&&!this.ownerGreatSwordEquipped()&&!this.greatSwordThrowState;}
  }
...
applyOwnerAppearance() {
    ...
    const wizard=this.isOwnerWizardActive();if(wizard&&!this.wizardIdentityLabel){this.wizardIdentityLabel=this.makeLabel('Wizard of the World','☠ · OWNER WIZARD');this.wizardIdentityLabel.position.set(0,2.48,0);this.modelPivot.add(this.wizardIdentityLabel);}else if(!wizard&&this.wizardIdentityLabel){this.wizardIdentityLabel.removeFromParent?.();this.wizardIdentityLabel.material?.map?.dispose?.();this.wizardIdentityLabel.material?.dispose?.();this.wizardIdentityLabel=null;}if(this.wizardIdentityLabel)this.wizardIdentityLabel.visible=!this.firstPerson;
...
applyOwnerVisualState() {
    ...
    // V281: Vanish ist fuer den eigenen Client ein "Ghost Preview". Der Spieler bleibt
    // fuer sich selbst leicht durchsichtig sichtbar, waehrend die Online-Presence weiterhin
    // vanished=true sendet und nicht berechtigte Fremd-Clients die Figur komplett ausblenden.
    const ghostOpacity=.22;
    this.playerModel.traverse((object)=>{if(!object.isMesh)return;const materials=Array.isArray(object.material)?object.material:[object.material];for(const material of materials){if(!material)continue;this.cacheOriginalMaterial(material);const original=material.userData.__centerOriginalMaterial;const opacity=vanished?ghostOpacity:(original.opacity??1);material.transparent=vanished||!!original.transparent||opacity<1;material.opacity=opacity;material.depthWrite=!vanished&&original.depthWrite!==false;material.needsUpdate=true;}});
    if(this.ownerFormObject)this.ownerFormObject.traverse((object)=>{if(!object.isMesh)return;const mats=Array.isArray(object.material)?object.material:[object.material];for(const mat of mats){if(!mat)continue;if(mat.userData.__formOpacity===undefined)mat.userData.__formOpacity=mat.opacity??1;mat.transparent=vanished||mat.transparent;mat.opacity=vanished?ghostOpacity:mat.userData.__formOpacity;mat.depthWrite=!vanished;mat.needsUpdate=true;}});
    if(this.ownerAura)this.ownerAura.visible=cosmeticAllowed&&!!appearance.aura&&!vanished&&!this.firstPerson;
    const applyItem=(root)=>root?.traverse?.((object)=>{if(object.isLight){if(object.userData.__centerBaseIntensity===undefined)object.userData.__centerBaseIntensity=object.intensity;object.intensity=vanished?object.userData.__centerBaseIntensity*.14:object.userData.__centerBaseIntensity;return;}if(!object.isMesh&&!object.isLine&&!object.isLineSegments&&!object.isPoints)return;const mats=Array.isArray(object.material)?object.material:[object.material];for(const material of mats){if(!material)continue;this.cacheOriginalMaterial(material);const original=material.userData.__centerOriginalMaterial;const baseOpacity=original.opacity??1;material.transparent=vanished||!!original.transparent||baseOpacity<1;material.opacity=vanished?Math.min(ghostOpacity,Math.max(.10,baseOpacity*ghostOpacity)):baseOpacity;material.depthWrite=!vanished&&original.depthWrite!==false;material.needsUpdate=true;}});
    applyItem(this.ownerHeldObject);applyItem(this.firstPersonHeldObject);applyItem(this.ownerCapeObject);applyItem(this.ownerCloakObject);applyItem(this.ownerHatObject);applyItem(this.ownerGreatSwordCarryObject);applyItem(this.ownerScooterObject);applyItem(this.ownerPlaneObject);
    // Eigene Ausruestung bleibt im Vanish lokal sichtbar und wird nur transparent.
    if(this.ownerHeldAnchor)this.ownerHeldAnchor.visible=!this.firstPerson;if(this.firstPersonHeldObject)this.firstPersonHeldObject.visible=this.firstPerson;if(this.ownerCapeObject)this.ownerCapeObject.visible=!this.firstPerson&&cosmeticAllowed&&!!appearance.cape&&vehicle!=='plane';if(this.ownerCloakObject)this.ownerCloakObject.visible=!this.firstPerson&&cosmeticAllowed&&!!appearance.cloak&&vehicle!=='plane';if(this.ownerHatObject)this.ownerHatObject.visible=!this.firstPerson&&cosmeticAllowed&&!!appearance.hat&&vehicle!=='plane';if(this.ownerGreatSwordCarryObject)this.ownerGreatSwordCarryObject.visible=!this.firstPerson&&this.ownerGreatSwordCarried()&&!this.ownerGreatSwordEquipped()&&!this.greatSwordThrowState&&vehicle!=='plane';if(this.ownerScooterObject)this.ownerScooterObject.visible=!this.firstPerson&&this.isStaffActive&&vehicle==='scooter';if(this.ownerPlaneObject)this.ownerPlaneObject.visible=!this.firstPerson&&this.isStaffActive&&vehicle==='plane';if(this.playerModel&&vehicle==='plane')this.playerModel.visible=false;
  }

async ensureCorrectPlayerModel() {
    const player=bridgeSnapshot(),staffWhite=this.isStaffActive&&!this.isPublicPlayerMode(),ownerSpecial=!!(this.isOwnerActive&&!this.isPublicPlayerMode()&&this.state.ownerAppearance?.ownerBaseModel==='masked'),skin=ownerSpecial?'maskedOwner':staffWhite?'owner':this.isPublicPlayerMode()?this.state.ownerAppearance.publicGender:player.gender;
    ...
    try{
      if((skin==='male'||skin==='female')&&RUN_MODEL_PATHS[skin]&&IDLE_MODEL_PATHS[skin]){
        const [walkGltf,runGltf,idleGltf]=await Promise.all([
          this.gltfLoader.loadAsync(MODEL_PATHS[skin]),
          this.gltfLoader.loadAsync(RUN_MODEL_PATHS[skin]),
          this.gltfLoader.loadAsync(IDLE_MODEL_PATHS[skin])
        ]);if(token!==this.playerModelInstallToken)return;
        const root=this.normalizeEgoCenterVisual(walkGltf.scene,1.76);
        this.playerModel=root;this.playerWalkVisual=root;this.playerRunVisual=null;this.playerDualLocomotion=false;installPivot.add(root);this.cachePlayerBones(root);
        const walkSource=(walkGltf.animations||[])[0]||this.selectLocomotionClip(walkGltf.animations||[]),
          runSource=(runGltf.animations||[])[0]||this.selectLocomotionClip(runGltf.animations||[]),
          idleSource=(idleGltf.animations||[])[0]||null,
          walkClip=this.sanitizeEgoLocomotionClip(walkSource),
          runClip=this.retargetLocomotionClip(this.sanitizeEgoLocomotionClip(runSource),root,'run'),
          idleClip=this.retargetLocomotionClip(this.sanitizeEgoLocomotionClip(idleSource),root,'stand');
        this.playerMixer=new THREE.AnimationMixer(root);this.playerWalkMixer=this.playerMixer;this.playerRunMixer=this.playerMixer;this.playerUsesNativeIdle=!!idleClip;
        if(idleClip){idleClip.name=skin==='female'?'Stand Female':'Stand Male';this.playerIdleAction=this.playerMixer.clipAction(idleClip);this.playerIdleAction.play();this.playerIdleAction.paused=false;this.playerActiveAction=this.playerIdleAction;}
        if(walkClip){walkClip.name=skin==='female'?'Walk Female':'Walk Male';this.playerWalkAction=this.playerMixer.clipAction(walkClip);this.playerWalkAction.play();this.playerWalkAction.paused=true;this.playerAction=this.playerWalkAction;}
        if(runClip){runClip.name=skin==='female'?'Run Female':'Run Male';this.playerRunAction=this.playerMixer.clipAction(runClip);this.playerRunAction.play();this.playerRunAction.paused=true;}
        this.resetLocomotionToIdle(true);
      }else{
...
applyPerspectiveVisibility(){this.overlay.classList.toggle('is-first-person',this.firstPerson);this.overlay.classList.toggle('is-third-person',!this.firstPerson);const disguised=this.isPublicPlayerMode(),appearance=this.state.ownerAppearance||{},skin=disguised?'normal':appearance.skin||'normal',vehicle=disguised?'none':appearance.vehicle||'none',cosmeticAllowed=this.isStaffActive&&this.staffCapabilities?.ownerCosmetics&&!disguised;if(this.playerModel)this.playerModel.visible=!this.firstPerson&&['normal','galaxy'].includes(skin)&&vehicle!=='plane';if(this.ownerFormObject)this.ownerFormObject.visible=!this.firstPerson&&!disguised;if(this.ownerHeldAnchor)this.ownerHeldAnchor.visible=!this.firstPerson;if(this.firstPersonHeldObject)this.firstPersonHeldObject.visible=this.firstPerson;if(this.ownerCapeObject)this.ownerCapeObject.visible=!this.firstPerson&&cosmeticAllowed&&!!appearance.cape&&vehicle!=='plane';if(this.ownerCloakObject)this.ownerCloakObject.visible=!this.firstPerson&&cosmeticAllowed&&!!appearance.cloak&&vehicle!=='plane';if(this.ownerHatObject)this.ownerHatObject.visible=!this.firstPerson&&cosmeticAllowed&&!!appearance.hat&&vehicle!=='plane';if(this.ownerGreatSwordCarryObject)this.ownerGreatSwordCarryObject.visible=!this.firstPerson&&this.ownerGreatSwordCarried()&&!this.ownerGreatSwordEquipped()&&!this.greatSwordThrowState&&vehicle!=='plane';if(this.ownerScooterObject)this.ownerScooterObject.visible=!this.firstPerson&&this.isStaffActive&&vehicle==='scooter';if(this.ownerPlaneObject)this.ownerPlaneObject.visible=!this.firstPerson&&this.isStaffActive&&vehicle==='plane';if(this.firstPersonArmsObject)this.firstPersonArmsObject.visible=this.firstPerson&&['normal','galaxy'].includes(skin)&&!['scooter','plane'].includes(vehicle);if(this.firstPerson&&vehicle!=='plane')this.ensureFirstPersonArms().catch(()=>{});this.applyOwnerAppearance();}
  ...
  supportHeightAt(x,z,currentY=this.player?.position.y||0) {
    ...
    const plotChunk=this.chunks?.get?.(chunkKey(worldToChunk(x),worldToChunk(z)));
    for(const plot of plotChunk?.villagePlots||[])if(this.villagePlotContains(plot,x,z,-.08)&&currentY>=plot.topY-1.2&&currentY<=plot.topY+1.8)support=Math.max(support,plot.topY);
  ...
  updateCamera(delta,snap=false) {
    if(this.inHouseInterior){const size=this.isStaffActive&&this.staffCapabilities?.size?clamp(Number(this.state.ownerAppearance?.size)||1,.45,2.5):1,head=this.tmpVector.set(this.player.position.x,this.player.position.y+1.65*size,this.player.position.z);if(this.firstPerson){this.camera.position.copy(head);this.camera.rotation.set(this.pitch,this.yaw,0);return;}const distance=4.1,height=1.65,cp=Math.cos(this.pitch),sp=Math.sin(this.pitch),sy=Math.sin(this.yaw),cy=Math.cos(this.yaw),target=this.tmpVector2.set(head.x+sy*cp*distance,head.y+height+sp*distance,head.z+cy*cp*distance);target.x=clamp(target.x,-3.7,3.7);target.z=clamp(target.z,-4.55,4.55);target.y=clamp(target.y,.7,3.15);this.camera.position.lerp(target,snap?1:1-Math.exp(-delta*10));this.camera.lookAt(head.x,head.y+.12,head.z);return;}
  ...
  updateWorldTime(delta) {
    const daylightClock=this.state.time>=6&&this.state.time<18;const speed=this.isStaffActive&&this.ownerFlags.freezeTime?0:(daylightClock?WORLD_DAY_TIME_HOURS_PER_MINUTE:WORLD_TIME_HOURS_PER_MINUTE);
  ...
  updateNeeds(delta) {
    ...
    if(this.isOwnerWizardActive()){this.state.needs.hunger=100;this.state.needs.thirst=100;this.state.needs.stamina=100;this.state.needs.warmth=100;this.state.needs.health=clamp(Number(this.state.needs.health)||0,0,10000);this.updateSurvivalWarnings();if(this.state.needs.health<=0&&!this.deathScreenOpen)this.respawnAfterCollapse();return;}
  ...
  updateAnimals(delta,now) {
    ...
    for(const animal of this.animals){
      this.syncAnimalCombatLevel(animal);
      if(!animal.active){if(animal.respawnAt&&Date.now()>animal.respawnAt){animal.active=true;animal.group.visible=true;animal.hp=animal.maxHp||100;animal.predatorTarget=null;if(animal.type==='spider'){animal.x=animal.homeX;animal.z=animal.homeZ;animal.y=terrainHeightAt(animal.x,animal.z);animal.targetX=animal.homeX;animal.targetZ=animal.homeZ;}else this.relocateAnimal(animal,100,300);animal.renderTargetX=animal.x;animal.renderTargetY=animal.y;animal.renderTargetZ=animal.z;}else continue;}
      if(this.mountedHorse===animal){animal.x=this.player.position.x;animal.z=this.player.position.z;animal.y=terrainHeightAt(animal.x,animal.z);animal.renderTargetX=animal.x;animal.renderTargetY=animal.y;animal.renderTargetZ=animal.z;animal.renderRotationY=this.modelPivot.rotation.y;animal.renderMoving=!!this.walking;continue;}
      ...
      if(animal.type==='spider'&&animal.aggressive&&!playerVanished){const homeDistance=Math.hypot(px-animal.homeX,pz-animal.homeZ);if(playerDistance<15&&homeDistance<animal.roamRadius+18){animal.targetX=px;animal.targetZ=pz;if(playerDistance<2.05&&now>(animal.attackCooldown||0)){animal.attackCooldown=now+1250;if(!(this.isStaffActive&&this.ownerFlags.god)){const hit=this.applyIncomingCombatDamage(6+Math.floor(Math.random()*7),{minimum:1});this.toast(`🕷 Zauberspinne hat dich getroffen · -${hit} Leben.`);}}}else if(homeDistance>animal.roamRadius+18){const a=Math.atan2(animal.homeX-animal.x,animal.homeZ-animal.z);animal.targetX=animal.homeX+Math.sin(a)*3;animal.targetZ=animal.homeZ+Math.cos(a)*3;}}
      ...
      if(profile.zone==='water')animal.y+=dy*Math.min(1,delta*2.8);else if(profile.zone==='air')animal.y+=dy*Math.min(1,delta*1.9);else animal.y=terrainHeightAt(animal.x,animal.z);
      // V287: Die KI darf weiterhin in einem sparsameren Takt rechnen. Die sichtbare
      // Position/Rotation wird aber in smoothDynamicActors in jedem Renderframe geglättet.
      animal.renderTargetX=animal.x;animal.renderTargetY=animal.y;animal.renderTargetZ=animal.z;animal.renderRotationY=Math.atan2(dx,dz);animal.renderMoving=d>2||!!animal.predatorTarget;
      animal.renderZone=profile.zone;
    }
  }
  ...
  updateNpcs(delta,now) {
    for(const npc of this.npcs){
      ...
      // V287: Nur das logische Ziel wird hier aktualisiert. Die sichtbare Figur bewegt
      // sich pro Renderframe weich zu diesem Ziel, statt alle 100-300 ms zu springen.
      npc.renderTargetX=npc.x-ox;npc.renderTargetY=terrainHeightAt(npc.x,npc.z);npc.renderTargetZ=npc.z-oz;npc.renderRotationY=Math.atan2(dx,dz);npc.renderWalk=Math.min(1,d/2);
      const hotspot=this.hotspots.find((h)=>h.id===npc.id);if(hotspot){hotspot.x=npc.x;hotspot.z=npc.z;}
    }
  }

  smoothDynamicActors(delta=.016,now=performance.now()){
    const actorAlpha=1-Math.exp(-Math.max(.001,delta)*18),rotAlpha=1-Math.exp(-Math.max(.001,delta)*14);
    const smoothAngle=(current,target)=>current+Math.atan2(Math.sin(target-current),Math.cos(target-current))*rotAlpha;
    for(const animal of this.animals){
      if(!animal?.active||!animal.group?.parent)continue;
      if(this.mountedHorse===animal){animal.group.position.set(this.player.position.x,terrainHeightAt(this.player.position.x,this.player.position.z),this.player.position.z);animal.group.rotation.y=this.modelPivot.rotation.y;this.setAnimalAnimation(animal,!!this.walking,delta);continue;}
      if(Number.isFinite(animal.renderTargetX)){
        animal.group.position.x=THREE.MathUtils.lerp(animal.group.position.x,animal.renderTargetX,actorAlpha);
        animal.group.position.y=THREE.MathUtils.lerp(animal.group.position.y,animal.renderTargetY,actorAlpha);
        animal.group.position.z=THREE.MathUtils.lerp(animal.group.position.z,animal.renderTargetZ,actorAlpha);
      }
      if(Number.isFinite(animal.renderRotationY))animal.group.rotation.y=smoothAngle(animal.group.rotation.y,animal.renderRotationY);
      if(animal.renderZone==='water')animal.group.rotation.z=Math.sin(now*.0016+animal.x*.01)*.035;else if(animal.renderZone==='air')animal.group.rotation.z=Math.sin(now*.002+animal.z*.01)*.08;
      this.setAnimalAnimation(animal,!!animal.renderMoving,delta);
    }
    for(const npc of this.npcs){
      if(!npc?.group?.parent)continue;
      if(Number.isFinite(npc.renderTargetX)){
        npc.group.position.x=THREE.MathUtils.lerp(npc.group.position.x,npc.renderTargetX,actorAlpha);
        npc.group.position.y=THREE.MathUtils.lerp(npc.group.position.y,npc.renderTargetY,actorAlpha);
        npc.group.position.z=THREE.MathUtils.lerp(npc.group.position.z,npc.renderTargetZ,actorAlpha);
      }
      if(Number.isFinite(npc.renderRotationY))npc.group.rotation.y=smoothAngle(npc.group.rotation.y,npc.renderRotationY);
      const walk=Number(npc.renderWalk)||0,phase=now*.006+(npc.name?.length||0),limbs=npc.group.userData.npcLimbs;
  ...
  updateHotspots() {
    ...
    if(groundGap<1.65)for(const animal of this.animals){if(!animal.active)continue;const d=Math.hypot(px-animal.x,pz-animal.z);if(d<5.5&&d<best){best=d;const label=animal.type==='horse'?(this.state.horseTamed?'Reitpferd besteigen':'Reitpferd zähmen'):`${animal.profile?.label||animal.type} · Lv ${animal.level||this.mainAccountLevel()} · ${Math.ceil(animal.hp||0)}/${animal.maxHp||0} HP`;nearest={id:animal.id,type:'animal',x:animal.x,z:animal.z,label,data:animal};}}
  ...
  activateNearestHotspot() {
    ...
    switch(hotspot.type){
      ...
      case 'sleep':return this.sleepUntilMorning();
      case 'own-house':return this.enterPlayerHouse(hotspot.data);
      case 'house-exit':return this.exitPlayerHouse();
      case 'own-smallChest':case 'own-mediumChest':return this.openChestStorage(hotspot.data);
  ...
  ownerGreatSwordEquipped(){
    return !!(this.isOwnerActive&&!this.isPublicPlayerMode()&&this.state.ownerAppearance?.ownerGreatSwordCarried&&this.state.ownerAppearance?.ownerGreatSwordActive);
  }

  ownerGreatSwordCarried(){
    return !!(this.isOwnerActive&&!this.isPublicPlayerMode()&&this.state.ownerAppearance?.ownerGreatSwordCarried);
  }

  ownerGreatSwordDamage(){
    return Math.floor(clamp(Number(this.state.ownerAppearance?.ownerGreatSwordDamage)||5000,1,100000));
  }

  ownerGreatSwordSpecialEnabled(key){
    return !!this.state.ownerAppearance?.ownerGreatSwordSpecials?.[key];
  }

  greatSwordTarget(maxDistance=70){
    const target=this.staffLightningTarget(maxDistance);
    let bestDistance=target.hit?target.origin.distanceTo(target.end):maxDistance;
    let colliderHit=null,colliderEnd=null;
    for(let t=1.2;t<=bestDistance;t+=.65){
      const p=target.origin.clone().addScaledVector(target.direction,t);
      for(const collider of this.nearbyColliders(p.x,p.z)){
        if(collider?.active===false||collider?.node?.active===false)continue;
        const radius=Math.max(.3,Number(collider.radius)||.5),ground=terrainHeightAt(collider.x,collider.z),height=Math.max(1,Number(collider.height)||3);
        if(this.colliderDistance(collider,p.x,p.z)<=radius&&p.y>=ground-.4&&p.y<=ground+height+.8){
          bestDistance=t;colliderHit={type:'collider',data:collider};colliderEnd=p.clone();break;
        }
      }
      if(colliderHit)break;
    }
    if(colliderHit){target.hit=colliderHit;target.end.copy(colliderEnd);}
    return target;
  }

  applyGreatSwordTargetDamage(target,damage=this.ownerGreatSwordDamage()){
    if(target?.hit?.type==='animal'){const animal=target.hit.data;this.syncAnimalCombatLevel(animal);animal.hp=Math.max(0,Number(animal.hp??animal.maxHp)-damage);animal.hitFlashUntil=performance.now()+220;if(animal.hp<=0)this.defeatAnimalCombat(animal,'Owner Great Sword');return true;}
    if(target?.hit?.type==='npc'){const npc=target.hit.data;npc.staffEventHealth=Math.max(0,Number(npc.staffEventHealth??100)-damage);npc.hitFlashUntil=performance.now()+220;return true;}
    return false;
  }

  castOwnerGreatSwordLightning(target,damage=this.ownerGreatSwordDamage()){
    if(!target?.end)return;
    const end=target.end.clone();
    for(let i=0;i<7;i+=1){
      const a=i/7*Math.PI*2,r=1.4+(i%3)*.55,start=end.clone().add(new THREE.Vector3(Math.cos(a)*r,3.4+(i%2)*1.3,Math.sin(a)*r));
      const finish=end.clone().add(new THREE.Vector3(Math.cos(a)*r*.32,.08,Math.sin(a)*r*.32));
      this.spawnStaffLightning(start,finish,'owner');
    }
    const splash=Math.max(1,Math.round(damage*.38)),radius=6.5;
    for(const animal of this.animals||[]){if(!animal?.active||!animal.group?.visible)continue;animal.group.getWorldPosition(this.tmpVector);if(this.tmpVector.distanceTo(end)>radius)continue;this.syncAnimalCombatLevel(animal);animal.hp=Math.max(0,Number(animal.hp??animal.maxHp)-splash);animal.hitFlashUntil=performance.now()+230;if(animal.hp<=0)this.defeatAnimalCombat(animal,'Great-Sword-Blitzschlag');}
    for(const npc of this.npcs||[]){if(!npc?.group?.visible)continue;npc.group.getWorldPosition(this.tmpVector);if(this.tmpVector.distanceTo(end)>radius)continue;npc.staffEventHealth=Math.max(0,Number(npc.staffEventHealth??100)-splash);npc.hitFlashUntil=performance.now()+230;}
  }

  beginGreatSwordAim(){
    if(!this.ownerGreatSwordEquipped()||!this.ownerGreatSwordSpecialEnabled('throw')||this.greatSwordThrowState)return false;
    this.greatSwordAimActive=true;
    if(performance.now()-Number(this.greatSwordAimToastAt||0)>1800){this.greatSwordAimToastAt=performance.now();this.toast('Owner Great Sword: Zielmodus · Linksklick zum Werfen.');}
    return true;
  }

  endGreatSwordAim(){this.greatSwordAimActive=false;}

  throwOwnerGreatSword(){
    if(!this.ownerGreatSwordEquipped()||!this.ownerGreatSwordSpecialEnabled('throw')||this.greatSwordThrowState)return false;
    const target=this.greatSwordTarget(82),visual=this.createOwnerGreatSwordVisual();if(!visual)return false;
    const start=new THREE.Vector3();
    if(this.ownerHeldObject?.getWorldPosition)this.ownerHeldObject.getWorldPosition(start);else{this.camera.getWorldPosition(start);start.addScaledVector(target.direction,.55);}
    const end=target.end.clone(),direction=end.clone().sub(start).normalize(),q=new THREE.Quaternion().setFromUnitVectors(new THREE.Vector3(0,1,0),direction);
    visual.position.copy(start);visual.quaternion.copy(q);visual.name='owner-great-sword-thrown-v315';this.scene.add(visual);
    if(this.ownerHeldObject)this.ownerHeldObject.visible=false;if(this.firstPersonHeldObject)this.firstPersonHeldObject.visible=false;
    this.greatSwordThrowState={visual,start:start.clone(),end:end.clone(),target,startedAt:performance.now(),phase:'out',hitApplied:false,baseQuaternion:q.clone()};
    this.greatSwordAimActive=false;this.triggerActionAnimation('weapon-attack',420);return true;
  }

  updateOwnerGreatSwordThrow(now=performance.now()){
    const state=this.greatSwordThrowState;if(!state)return;
    if(!this.ownerGreatSwordEquipped()){this.disposeGeneratedVisual(state.visual);this.greatSwordThrowState=null;this.greatSwordAimActive=false;return;}
    if(state.phase==='out'){
      const t=clamp((now-state.startedAt)/360,0,1),ease=1-Math.pow(1-t,3);state.visual.position.copy(state.start).lerp(state.end,ease);state.visual.quaternion.copy(state.baseQuaternion);state.visual.rotateY(t*Math.PI*5);
      if(t>=1){state.phase='stuck';state.stuckAt=now;if(!state.hitApplied){state.hitApplied=true;const damage=this.ownerGreatSwordDamage();this.applyGreatSwordTargetDamage(state.target,damage);if(this.ownerGreatSwordSpecialEnabled('lightning'))this.castOwnerGreatSwordLightning(state.target,damage);if(this.ownerGreatSwordSpecialEnabled('teleport'))this.teleportOwner(state.end.x-state.target.direction.x*1.15,state.end.z-state.target.direction.z*1.15,null,'Great-Sword-Ziel');}}
      return;
    }
    if(state.phase==='stuck'){if(now-state.stuckAt<1650)return;state.phase='return';state.returnAt=now;state.returnStart=state.visual.position.clone();return;}
    if(state.phase==='return'){
      const hand=new THREE.Vector3();if(this.ownerHeldObject?.parent?.getWorldPosition)this.ownerHeldObject.parent.getWorldPosition(hand);else{hand.copy(this.player.position);hand.y+=1.3;}
      const t=clamp((now-state.returnAt)/520,0,1),ease=t*t*(3-2*t);state.visual.position.copy(state.returnStart).lerp(hand,ease);state.visual.rotateY(.34);
      if(t>=1){this.disposeGeneratedVisual(state.visual);this.greatSwordThrowState=null;if(this.ownerHeldObject)this.ownerHeldObject.visible=true;if(this.firstPersonHeldObject)this.firstPersonHeldObject.visible=true;this.toast('Owner Great Sword ist zurückgekehrt.');}
    }
  }
  ...
  applyStaffLightningDamage(target,damage){
    if(target.hit?.type==='animal'){const animal=target.hit.data;this.syncAnimalCombatLevel(animal);animal.hp=Math.max(0,Number(animal.hp??animal.maxHp)-damage);animal.hitFlashUntil=performance.now()+180;if(animal.hp<=0)this.defeatAnimalCombat(animal,'Stab');}
  ...
  performPrimaryAction() {
    ...
    if(this.performOwnerGreatSwordAttack())return;
    ...
    if(hotspot?.type==='animal'&&hotspot.data?.type!=='horse'){const armed=!!(this.ownerGreatSwordEquipped()||this.state.swordSystem?.equippedTier||this.state.ownerAppearance?.heldItem!=='none'||this.state.equippedTool);this.triggerActionAnimation(armed?'weapon-attack':`punch-${this.nextPunchSide}`,520);this.nextPunchSide=this.nextPunchSide==='right'?'left':'right';this.attackAnimalCombat(hotspot.data);return;}
    if(hotspot?.type==='npc'&&this.isStaffActive&&this.state.ownerAppearance?.heldItem==='sword'){
      const damage=this.currentCombatDamage(),npc=hotspot.data;this.triggerActionAnimation('weapon-attack',520);npc.staffEventHealth=Math.max(0,Number(npc.staffEventHealth??Math.max(3000,this.mainAccountLevel()*80))-damage);npc.hitFlashUntil=performance.now()+200;this.toast(`${staffThemeConfig(this.appearanceTheme('heldItem')).label} Schwert · -${damage} Schaden`);return;
    }
    if(this.ownerGreatSwordEquipped()||this.state.equippedTool||this.state.ownerAppearance?.heldItem!=='none'){this.triggerActionAnimation('weapon-attack',520);return;}
  ...
  huntAnimal(animal) {
    ...
    if(isWolf&&Math.random()>.58+hunting*.06){if(!(this.isStaffActive&&this.ownerFlags.god)){this.applyIncomingCombatDamage(14,{minimum:1});this.state.needs.stamina=Math.max(0,this.state.needs.stamina-12);}this.toast('Der junge Wolf wehrt sich und entkommt.');animal.targetX+=30;animal.targetZ+=18;return;}
  ...
  talkToNpc(npc) {
    ...
    const houseCapacity=this.state.buildings.filter((b)=>b.type==='house').reduce((sum,b)=>sum+this.houseLevelDefinition(b.houseLevel||1).capacity,0);
  ...
  recruitNpc(name) {
    ...
    const capacity=this.state.buildings.filter((b)=>b.type==='house').reduce((sum,b)=>sum+this.houseLevelDefinition(b.houseLevel||1).capacity,0);
  ...
  resolveWorldEncounter(hotspot) {
    ...
    if(danger<.28){const loss=5+Math.floor(Math.random()*10);if(!(this.isStaffActive&&this.ownerFlags.god)){this.applyIncomingCombatDamage(loss,{minimum:1});if(this.state.needs.health<1)this.state.needs.health=1;}this.state.inventory.leather+=1;this.toast(`Ein Wolf überrascht dich: -${loss} Gesundheit · +1 Leder`);}
  ...
  equipTool(id) {
    ...
    this.state.equippedTool=this.state.equippedTool===id?'':id;if(this.state.equippedTool)this.state.swordSystem.equippedTier=0;
  ...
  craft(recipeId) {
    ...
    if(recipe.kind==='placeable'){this.state.placeables[recipeId]=Math.max(0,Math.floor(Number(this.state.placeables[recipeId])||0))+1;}
    else if(recipeId==='cookedMeat')this.state.inventory.cookedMeat+=recipe.amount||1;else if(recipeId==='medicine')this.state.inventory.medicine+=recipe.amount||1;else {this.state.tools[recipeId]=Math.min(recipeId==='ironAxe'?180:120,(this.state.tools[recipeId]||0)+recipe.durability);if(!this.state.equippedTool)this.state.equippedTool=recipeId;this.applyHeldItemVisual();}
    this.state.stats.crafted+=1;if(recipeId==='axe')this.checkTutorialProgress();this.gainXp(8,`Herstellung: ${recipe.name}`);this.toast(`${recipe.name} hergestellt${recipe.kind==='placeable'?' · jetzt im Bauen-Menü platzierbar.':'.'}`);this.saveState(true);this.openManagement('crafting');this.checkQuestProgress();
  }

  chestStorageCapacity(saved){return CHEST_DEFS[saved?.type]?.capacity||40;}
  chestStorageUsed(saved){return Object.values(saved?.storage||{}).reduce((sum,value)=>sum+Math.max(0,Math.floor(Number(value)||0)),0);}
  openChestStorage(saved){
    if(!saved||!CHEST_DEFS[saved.type])return;const def=CHEST_DEFS[saved.type],capacity=this.chestStorageCapacity(saved),used=this.chestStorageUsed(saved);saved.storage=saved.storage&&typeof saved.storage==='object'?saved.storage:{};
    const rows=Object.entries(RESOURCE_LABELS).map(([id,name])=>{const inv=Math.max(0,Math.floor(Number(this.state.inventory[id])||0)),stored=Math.max(0,Math.floor(Number(saved.storage[id])||0));return `<article><span>${this.itemIcon(id)}</span><div><b>${escapeHtml(name)}</b><small>Rucksack ${inv} · Truhe ${stored}</small></div><button data-mdc-action="chest-deposit" data-build-id="${escapeHtml(saved.id)}" data-item="${id}" data-amount="1" ${inv>0&&used<capacity?'':'disabled'}>+1</button><button data-mdc-action="chest-deposit" data-build-id="${escapeHtml(saved.id)}" data-item="${id}" data-amount="10" ${inv>0&&used<capacity?'':'disabled'}>+10</button><button data-mdc-action="chest-withdraw" data-build-id="${escapeHtml(saved.id)}" data-item="${id}" data-amount="1" ${stored>0?'':'disabled'}>−1</button><button data-mdc-action="chest-withdraw" data-build-id="${escapeHtml(saved.id)}" data-item="${id}" data-amount="10" ${stored>0?'':'disabled'}>−10</button></article>`;}).join('');
    this.openPanel('LAGERTRUHE',def.name,`<div class="mdc-village-hero"><strong>${def.name}</strong><span>${used}/${capacity} Gegenstände gelagert</span></div><p class="mdc-note">Mit den Plus-Tasten legst du Rohstoffe hinein, mit Minus holst du sie wieder heraus.</p><div class="mdc-inventory-list">${rows}</div>`);
  }

  moveChestStorage(buildId,item,amount,direction){
    const saved=this.state.buildings.find((b)=>b.id===buildId&&CHEST_DEFS[b.type]);if(!saved||!RESOURCE_LABELS[item])return;saved.storage=saved.storage&&typeof saved.storage==='object'?saved.storage:{};amount=Math.max(1,Math.floor(Number(amount)||1));
    if(direction==='deposit'){const free=Math.max(0,this.chestStorageCapacity(saved)-this.chestStorageUsed(saved)),take=Math.min(amount,free,Math.max(0,Math.floor(Number(this.state.inventory[item])||0)));if(take<=0)return;this.state.inventory[item]-=take;saved.storage[item]=(saved.storage[item]||0)+take;}
    else {const give=Math.min(amount,Math.max(0,Math.floor(Number(saved.storage[item])||0)));if(give<=0)return;saved.storage[item]-=give;if(saved.storage[item]<=0)delete saved.storage[item];this.state.inventory[item]=(this.state.inventory[item]||0)+give;}
    this.saveState(true);this.renderHud(true);this.openChestStorage(saved);
  }

  upgradePlayerHouse(buildId=''){
  ...
  beginBuildMode(type) {
    ...
    const def=BUILDINGS[type];if(def.craftedItem){if((this.state.placeables[def.craftedItem]||0)<=0){this.toast(`${def.name} musst du zuerst im Herstellen-Menü bauen.`);return;}}else{if(type!=='campfire'&&this.state.tools.hammer<=0){this.toast('Du brauchst einen Bauhammer.');return;}const cost=this.buildingCost(def);if(!this.hasCost(cost,true)){this.toast('Nicht genügend Baumaterial.');return;}}
    if(type==='house'&&this.state.buildings.some((b)=>b.type==='house')){this.toast('Du besitzt bereits ein Wohnhaus. Baue es im Bauen-Menü weiter aus.');return;}
  ...
  updateBuildGhost() {
    ...
    const distance=8;let x=this.player.position.x-Math.sin(this.yaw)*distance,z=this.player.position.z-Math.cos(this.yaw)*distance,snappedPlot=null;
    if(this.buildMode==='house'){
      let best=4.8;
      for(const chunk of this.chunks.values())for(const plot of chunk.villagePlots||[]){if(!plot.free)continue;const occupied=this.state.buildings.some((b)=>b.type==='house'&&Math.hypot(b.x-plot.x,b.z-plot.z)<4);if(occupied)continue;const d=Math.hypot(x-plot.x,z-plot.z);if(d<best){best=d;snappedPlot=plot;}}
      if(snappedPlot){x=snappedPlot.x;z=snappedPlot.z;this.buildRotation=snappedPlot.yaw;}
    }
    const y=snappedPlot?snappedPlot.topY+.03:terrainHeightAt(x,z)+.03;this.buildGhost.position.set(x,y,z);this.buildGhost.rotation.y=this.buildRotation;
    const valid=snappedPlot?true:this.canPlaceBuilding(x,z,BUILDINGS[this.buildMode].size);
    this.buildGhost.userData.snappedVillagePlot=snappedPlot?.id||'';this.buildGhost.traverse((object)=>{if(object.isMesh&&object.material?.color)object.material.color.set(valid?0x69c981:0xd65a52);});
  ...
  canPlaceBuilding(x,z,size) {
    ...
    for(const chunk of this.chunks.values())for(const plot of chunk.villagePlots||[]){
      if(!this.villagePlotContains(plot,x,z,Math.max(.4,size*.28)))continue;
      if(!(plot.free&&this.buildMode==='house'))return false;
    }
  ...
  placeBuilding() {
    ...
    const type=this.buildMode,def=BUILDINGS[type],cost=this.buildingCost(def);
    if(def.craftedItem){if((this.state.placeables[def.craftedItem]||0)<=0){this.toast('Das hergestellte Objekt ist nicht mehr verfügbar.');return;}this.state.placeables[def.craftedItem]-=1;}else{if(!this.hasCost(cost,true)){this.toast('Baumaterial reicht nicht mehr.');return;}this.payCost(cost,true);if(type!=='campfire')this.useTool('hammer',5);}
    const id=`b-${Date.now()}-${Math.random().toString(36).slice(2,7)}`,snappedId=String(this.buildGhost.userData.snappedVillagePlot||''),snappedPlot=snappedId?[...this.chunks.values()].flatMap((chunk)=>chunk.villagePlots||[]).find((plot)=>plot.id===snappedId):null;const saved={id,type,x:Number(this.buildGhost.position.x.toFixed(2)),z:Number(this.buildGhost.position.z.toFixed(2)),rotation:Number(this.buildRotation.toFixed(4)),condition:100,createdAt:Date.now(),...(type==='house'?{houseLevel:1}:{}),...(snappedPlot?{villagePlotId:snappedPlot.id,baseY:Number(snappedPlot.topY.toFixed(3))}:{}),...(CHEST_DEFS[type]?{storage:{}}:{})};
  ...
  renderInventoryPanel() {
    ...
    const swords=PLAYER_SWORD_TIERS.filter((def)=>this.state.swordSystem.owned[def.tier]).map((def)=>{const stage=this.swordStage(def.tier),equipped=this.state.swordSystem.equippedTier===def.tier;return `<article class="${equipped?'is-equipped':''}"><span>⚔</span><div><b>${def.name}</b><small>Schwertstufe ${stage}/${def.maxStage} · ${this.swordDamage(def.tier)} Schaden</small></div><strong>Lv ${def.requiredLevel}</strong><button data-mdc-action="sword-equip" data-sword-tier="${def.tier}">${equipped?'Ablegen':'Ausrüsten'}</button></article>`;}).join('');
    const tools=Object.entries(RECIPES).filter(([,r])=>r.kind!=='placeable').filter(([id])=>!['cookedMeat','medicine'].includes(id)).map(([id,r])=>{const amount=Math.round(this.state.tools[id]||0),equipped=this.state.equippedTool===id;return `<article class="${equipped?'is-equipped':''}"><span>${r.icon}</span><div><b>${r.name}</b><small>${equipped?'In der Hand':'Haltbarkeit'}</small></div><strong>${amount}%</strong><button ${amount>0?'':'disabled'} data-mdc-action="equip-tool" data-tool="${id}">${equipped?'Ablegen':'Ausrüsten'}</button></article>`;}).join('');
    return `<h3 class="mdc-section-title">Rohstoffe</h3><div class="mdc-inventory-list">${items}</div><h3 class="mdc-section-title">Schwert-Kit</h3><p class="mdc-note">Die neun Schwerter sind die normalen Charakterwaffen. Das ausgerüstete Schwert erscheint direkt in deiner rechten Hand.</p><div class="mdc-inventory-list">${swords||'<p>Noch kein Schwert hergestellt.</p>'}</div><h3 class="mdc-section-title">Werkzeuge</h3><div class="mdc-inventory-list">${tools}</div>`;
  }

  renderCraftingPanel() {
    const accountLevel=this.mainAccountLevel();
    const swordCards=PLAYER_SWORD_TIERS.map((def)=>{const owned=!!this.state.swordSystem.owned[def.tier],stage=owned?this.swordStage(def.tier):0,unlocked=accountLevel>=def.requiredLevel,previousOk=def.tier===1||!!this.state.swordSystem.owned[def.tier-1];if(!owned)return `<article><span>⚔</span><div><h3>${def.name}</h3><p>${this.costText(def.cost)}</p><small>Hauptlevel ${def.requiredLevel} · Schaden ${def.baseDamage}</small></div><button ${unlocked&&previousOk&&this.hasCost(def.cost)?'':'disabled'} data-mdc-action="sword-craft" data-sword-tier="${def.tier}">${unlocked?(previousOk?'Herstellen':`Erst Schwert ${def.tier-1}`):`Ab Level ${def.requiredLevel}`}</button></article>`;const maxed=stage>=def.maxStage,cost=this.swordUpgradeCost(def.tier,stage);return `<article><span>⚔</span><div><h3>${def.name}</h3><p>${maxed?'Maximal aufgewertet':this.costText(cost)}</p><small>Stufe ${stage}/${def.maxStage} · ${this.swordDamage(def.tier)} Schaden${def.tier===9?' · Maximum 4.000':''}</small></div><button ${!maxed&&this.hasCost(cost)?'':'disabled'} data-mdc-action="sword-upgrade" data-sword-tier="${def.tier}">${maxed?'MAX':`Auf Stufe ${stage+1}`}</button></article>`;}).join('');
    return `<h3 class="mdc-section-title">Schwert-Kit · Hauptlevel ${accountLevel}</h3><p class="mdc-note">Schwert 1–8 haben je 10 Stufen. Schwert 9 hat 50 Stufen und steigt von 2.486 auf 4.000 Schaden.</p><div class="mdc-recipe-grid">${swordCards}</div><h3 class="mdc-section-title">Werkzeuge & Gegenstände</h3><div class="mdc-recipe-grid">${Object.entries(RECIPES).map(([id,r])=>`<article><span>${r.icon}</span><div><h3>${r.name}</h3><p>${this.costText(r.cost)}</p><small>${r.kind==='placeable'?`Bereit zum Platzieren: ${this.state.placeables[id]||0}`:['cookedMeat','medicine'].includes(id)?'Verbrauchsgegenstand':'Haltbarkeit '+Math.round(this.state.tools[id]||0)+'%'}</small></div><button ${this.hasCost(r.cost)?'':'disabled'} data-mdc-action="craft" data-recipe="${id}">Herstellen</button></article>`).join('')}</div>`;
  }

  renderBuildingPanel() {
    const ownHouse=this.state.buildings.find((b)=>b.type==='house'),level=ownHouse?Math.floor(clamp(Number(ownHouse.houseLevel)||1,1,HOUSE_UPGRADE_LEVELS.length)):0,current=level?this.houseLevelDefinition(level):this.houseLevelDefinition(1),next=level<HOUSE_UPGRADE_LEVELS.length?this.houseLevelDefinition(level+1):null;
    const cards=Object.entries(BUILDINGS).map(([id,b])=>{
      if(id==='house'){if(!ownHouse){const cost=this.buildingCost(b);return `<article><span>${b.icon}</span><div><small>Wohnen · Stufe 1/5</small><h3>Wohnhaus · ${current.label}</h3><p>${this.costText(cost,true)}</p></div><button ${this.hasCost(cost,true)?'':'disabled'} data-mdc-action="build" data-building="house">Platzieren</button></article>`;}if(next){return `<article><span>${b.icon}</span><div><small>Wohnen · Stufe ${level}/5</small><h3>${current.label}</h3><p>Nächstes Haus: ${next.label} · ${this.costText(next.upgradeCost,true)}</p></div><button ${this.hasCost(next.upgradeCost,true)&&this.state.tools.hammer>0?'':'disabled'} data-mdc-action="upgrade-house" data-build-id="${escapeHtml(ownHouse.id)}">Auf Stufe ${next.level} upgraden</button></article>`;}return `<article><span>${b.icon}</span><div><small>Wohnen · Stufe 5/5</small><h3>${current.label}</h3><p>Maximale Ausbaustufe erreicht.</p></div><button disabled>Voll ausgebaut</button></article>`;}
  ...
  renderVillagePanel() {
    const s=this.state.settlement,capacity=this.state.buildings.filter((b)=>b.type==='house').reduce((sum,b)=>sum+this.houseLevelDefinition(b.houseLevel||1).capacity,0),jobs=s.jobs||{},assigned=Object.values(jobs).reduce((sum,value)=>sum+Number(value||0),0),free=Math.max(0,s.residents-assigned);
  ...
  handlePanelAction(event) {
    ...
    if(action==='sword-craft')this.craftPlayerSword(Number(button.dataset.swordTier));
    if(action==='sword-upgrade')this.upgradePlayerSword(Number(button.dataset.swordTier));
    if(action==='sword-equip')this.equipPlayerSword(Number(button.dataset.swordTier));
    if(action==='equip-tool')this.equipTool(button.dataset.tool);
    if(action==='build')this.beginBuildMode(button.dataset.building);
    if(action==='upgrade-house')this.upgradePlayerHouse(button.dataset.buildId||'');
    if(action==='chest-deposit')this.moveChestStorage(button.dataset.buildId,button.dataset.item,button.dataset.amount,'deposit');
    if(action==='chest-withdraw')this.moveChestStorage(button.dataset.buildId,button.dataset.item,button.dataset.amount,'withdraw');
  ...
  renderHud(force=false) {
    ...
    const greatSwordHud=this.ownerGreatSwordEquipped()?`<div class="mdc-equipped-tool"><span>🗡</span><b>${this.ownerGreatSwordDamage().toLocaleString('de-DE')} Schaden</b><small>OWNER GREAT SWORD · ${KEYBIND_LABELS[this.state.keybinds?.greatSword]||this.state.keybinds?.greatSword||'O'}</small></div>`:'';
    const staffGalaxySwordHud=this.isStaffActive&&!this.ownerGreatSwordEquipped()&&this.state.ownerAppearance?.heldItem==='sword'?`<div class="mdc-equipped-tool"><span>⚔</span><b>${this.currentCombatDamage().toLocaleString('de-DE')} Schaden</b><small>${staffThemeConfig(this.appearanceTheme('heldItem')).label.toUpperCase()} GALAXY-SCHWERT</small></div>`:'';
    const swordTier=Math.floor(Number(this.state.swordSystem?.equippedTier)||0),swordHud=swordTier?`<div class="mdc-equipped-tool"><span>⚔</span><b>${this.swordDamage(swordTier)} Schaden</b><small>Schwert ${swordTier} · Stufe ${this.swordStage(swordTier)}</small></div>`:'';
    this.hotbarElement.innerHTML=`${staffAttack}${greatSwordHud}${staffGalaxySwordHud}${swordHud}${equipped}<button data-mdc-use="berries"><span>●</span><b>${this.state.inventory.berries}</b><small>Beeren</small></button><button data-mdc-use="mushrooms"><span>🍄</span><b>${this.state.inventory.mushrooms}</b><small>Pilze</small></button><button data-mdc-use="cookedMeat"><span>🍖</span><b>${this.state.inventory.cookedMeat}</b><small>Fleisch</small></button><button data-mdc-use="water"><span>💧</span><b>${this.state.inventory.water}</b><small>Wasser</small></button><div><span>🪵</span><b>${this.state.inventory.logs}</b><small>Stämme</small></div><div><span>◆</span><b>${this.state.inventory.stone}</b><small>Stein</small></div><button data-mdc-use="medicine"><span>✚</span><b>${this.state.inventory.medicine}</b><small>Heilmittel</small></button><div><span>◉</span><b>${this.state.inventory.coins}</b><small>Münzen</small></div>`;
...
presencePayload(online=true, compatibility=this.onlineCompatibilityMode) {
    const player=bridgeSnapshot(),disguised=this.isPublicPlayerMode(),wizard=this.isOwnerWizardActive(),publicAlias=String(this.state.ownerAppearance?.publicAlias||'Center Spieler').trim().slice(0,30)||'Center Spieler',publicGender=this.state.ownerAppearance?.publicGender==='female'?'female':'male',visibleStaffStyle=this.effectivePublicStaffStyle(),visibleStaffRole=this.effectivePublicStaffRole(),staffVisualClaim=!disguised&&visibleStaffStyle!=='player',vanished=!!(this.isStaffActive&&this.ownerFlags.vanish),skinTheme=staffVisualClaim?this.effectiveStaffSkinTheme():'none',outside=this.inHouseInterior?(this.houseExteriorReturn?.building||this.houseExteriorReturn||{}):null,presenceX=outside?Number(outside.x||0):Number(this.player?.position.x||0),presenceZ=outside?Number(outside.z||0):Number(this.player?.position.z||0),presenceY=outside?terrainHeightAt(presenceX,presenceZ):Number(this.player?.position.y||0);
    const base={online:!!online&&!vanished,mapId:ONLINE_MAP_ID,sessionId:this.onlineSessionId,x:Number(presenceX.toFixed(3)),z:Number(presenceZ.toFixed(3)),yaw:Number(this.yaw.toFixed(4)),bodyYaw:Number((this.modelPivot?.rotation.y||0).toFixed(4)),walking:!!this.walking&&!this.inHouseInterior,sprinting:!!this.sprinting&&!this.inHouseInterior,velocityX:this.inHouseInterior?0:Number((this.motionVelocityX||0).toFixed(3)),velocityY:this.inHouseInterior?0:Number((this.motionVelocityY||0).toFixed(3)),velocityZ:this.inHouseInterior?0:Number((this.motionVelocityZ||0).toFixed(3)),view:this.firstPerson?'first':'third',gender:disguised?publicGender:player.gender,firstName:wizard?'Wizard of the World':(disguised?publicAlias:player.firstName.slice(0,30)),lastName:wizard?'':(disguised?'':player.lastName.slice(0,30)),level:player.level,slot:player.slot,ownerClaim:staffVisualClaim,updatedAtMs:Date.now(),leftAtMs:online?0:Date.now(),version:CENTER_VERSION};if(compatibility){const {sprinting,velocityX,velocityY,velocityZ,...legacy}=base;return {cottbus3D:legacy};}
    return {cottbus3D:{...base,mode:'center',y:Number(presenceY.toFixed(3)),staffRole:visibleStaffRole,staffStyle:visibleStaffStyle,staffSkinTheme:skinTheme,vanished,flying:!!(this.isStaffActive&&this.ownerFlags.fly),season:this.state.season,day:this.state.day,appearanceSkin:disguised?'normal':this.isStaffActive?this.state.ownerAppearance.skin:'normal',ownerBaseModel:(!disguised&&visibleStaffStyle==='owner'&&this.isOwnerActive&&this.state.ownerAppearance?.ownerBaseModel==='masked')?'masked':'default',appearanceSize:disguised?1:this.isStaffActive&&this.staffCapabilities?.size?Number(this.state.ownerAppearance.size||1):1,heldItem:disguised?'none':this.isStaffActive?(this.ownerGreatSwordEquipped()?'greatSword':this.state.ownerAppearance.heldItem):'none',vehicle:disguised?'none':this.isStaffActive?this.state.ownerAppearance.vehicle:'none',ownerCape:!!(staffVisualClaim&&this.staffCapabilities?.ownerCosmetics&&this.state.ownerAppearance.cape),ownerCapeTheme:this.appearanceTheme('cape'),staffCloak:!!(staffVisualClaim&&this.staffCapabilities?.ownerCosmetics&&this.state.ownerAppearance.cloak),staffCloakTheme:this.appearanceTheme('cloak'),ownerHat:!!(staffVisualClaim&&this.staffCapabilities?.ownerCosmetics&&this.state.ownerAppearance.hat),ownerHatTheme:this.appearanceTheme('hat'),ownerAura:!!(staffVisualClaim&&this.staffCapabilities?.ownerCosmetics&&this.state.ownerAppearance.aura),ownerAuraTheme:this.appearanceTheme('aura'),heldItemTheme:this.ownerGreatSwordEquipped()?'owner':this.appearanceTheme('heldItem'),staffShotTheme:normalizeStaffTheme(this.staffShotTheme||this.appearanceTheme('heldItem')),staffShotSeq:Math.max(0,Math.floor(Number(this.staffShotSeq)||0)),staffShotAtMs:Math.max(0,Math.floor(Number(this.staffShotAtMs)||0)),staffShotX:Number((this.staffShotEnd?.x||0).toFixed(3)),staffShotY:Number((this.staffShotEnd?.y||0).toFixed(3)),staffShotZ:Number((this.staffShotEnd?.z||0).toFixed(3))}};
  }
...
async connectMultiplayer(prepared=null) {
  ...
  async publishPresence(force=false){
    ...
    const now=Date.now();let payload=this.presencePayload(true),live=payload.cottbus3D;const key=`${Number(live.x||0).toFixed(2)}|${Number(live.y||0).toFixed(2)}|${Number(live.z||0).toFixed(2)}|${Number(live.bodyYaw||0).toFixed(2)}|${!!live.walking}|${!!live.sprinting}|${Number(live.velocityX||0).toFixed(1)}|${Number(live.velocityY||0).toFixed(1)}|${Number(live.velocityZ||0).toFixed(1)}|${!!live.vanished}|${!!live.flying}|${live.staffStyle||'player'}|${live.staffSkinTheme||'none'}|${live.appearanceSkin||'normal'}|${live.ownerBaseModel||'default'}|${live.heldItem||'none'}|${live.heldItemTheme||'owner'}|${live.vehicle||'none'}|${!!live.ownerAura}|${live.ownerAuraTheme||'owner'}|${!!live.ownerCape}|${live.ownerCapeTheme||'owner'}|${!!live.staffCloak}|${live.staffCloakTheme||'owner'}|${!!live.ownerHat}|${live.ownerHatTheme||'owner'}|${Number(live.staffShotSeq||0)}`;
...
async verifiedRemoteSkin(uid,live){
    ...
    const maskedOwner=actualDetail==='owner'&&visibleStyle==='owner'&&String(live.ownerBaseModel||'default')==='masked';
    return {skin:visibleStyle==='player'?gender:(maskedOwner?'maskedOwner':'owner'),role:visibleStyle,actualRole,actualDetailRole:actualDetail};
  }

async upsertRemotePlayer(uid,profile,live){
    let remote=this.remotePlayers.get(uid);const existed=!!remote,previousAppearance=remote?.appearanceSkin||'',wizardIdentity=String(live.ownerBaseModel||'default')==='masked'&&String(live.staffStyle||live.staffRole||'')==='owner',name=wizardIdentity?'Wizard of the World':String(`${live.firstName||''} ${live.lastName||''}`.trim()||profile.displayName||'Spieler').slice(0,44),level=Math.max(0,Math.floor(Number(live.level||0))),labelSub=wizardIdentity?'☠ · OWNER WIZARD':`LEVEL ${level} · ONLINE`;
    if(!remote){const group=new THREE.Group(),pivot=new THREE.Group();group.add(pivot);group.position.set(Number(live.x||0),Number.isFinite(Number(live.y))?Number(live.y):terrainHeightAt(Number(live.x||0),Number(live.z||0)),Number(live.z||0));const label=this.makeLabel(name,labelSub);label.position.y=2.4;group.add(label);this.scene.add(group);remote={uid,group,pivot,label,name,labelSub,skin:'',staffVisualRole:'player',mixer:null,walkMixer:null,runMixer:null,idleAction:null,nativeIdle:false,dualLocomotion:false,walkVisual:null,runVisual:null,cape:null,cloak:null,hat:null,aura:null,formObject:null,vehicleObject:null,heldObject:null,heldAnchor:null,renderedHeldItem:'',renderedAppearanceSkin:'',renderedVehicle:'',lastVisualKey:'',lastFormKey:'',lastCosmeticKey:'',lastHeldKey:'',lastMaterialThemeKey:'',targetX:Number(live.x||0),targetY:Number(live.y||0),targetZ:Number(live.z||0),targetYaw:Number(live.bodyYaw??live.yaw??0),walking:!!live.walking,sprinting:!!live.sprinting,flying:!!live.flying,vanished:!!live.vanished,velocityX:Number(live.velocityX||0),velocityY:Number(live.velocityY||0),velocityZ:Number(live.velocityZ||0),verticalVelocity:Number(live.velocityY||0),lastSnapshotReceivedAt:performance.now(),lastSeenAt:Date.now(),sourceUpdatedAt:Number(live.updatedAtMs||Date.now()),lastShotSeq:0,staffBeamVisual:null,staffBeamUntil:0,staffBeamEnd:new THREE.Vector3(),staffBeamTheme:'owner',modelInstallToken:0,modelInstallPromise:null,pendingSkin:'',missingSince:0};this.remotePlayers.set(uid,remote);}else if(remote.name!==name||remote.labelSub!==labelSub){remote.label?.removeFromParent?.();remote.label?.material?.map?.dispose?.();remote.label?.material?.dispose?.();remote.label=this.makeLabel(name,labelSub);remote.label.position.y=2.4;remote.group.add(remote.label);remote.name=name;remote.labelSub=labelSub;}
    remote.appearanceSkin=['shadow','oaura','galaxy'].includes(String(live.appearanceSkin||''))?'normal':String(live.appearanceSkin||'normal');remote.ownerBaseModel=String(live.ownerBaseModel||'default')==='masked'?'masked':'default';if(existed&&previousAppearance&&previousAppearance!==remote.appearanceSkin)this.spawnTransformationEffectAt(remote.group.position,true);remote.staffSkinTheme=normalizeStaffTheme(live.staffSkinTheme||(String(live.appearanceSkin||'')==='galaxy'?'owner':'none'),true);remote.vehicle=String(live.vehicle||'none');remote.heldItem=String(live.heldItem||'none');remote.appearanceSize=clamp(Number(live.appearanceSize)||1,.45,2.5);remote.ownerAura=!!live.ownerAura;remote.ownerAuraTheme=normalizeStaffTheme(live.ownerAuraTheme||'owner');remote.ownerCape=!!live.ownerCape;remote.ownerCapeTheme=normalizeStaffTheme(live.ownerCapeTheme||'owner');remote.staffCloak=!!live.staffCloak;remote.staffCloakTheme=normalizeStaffTheme(live.staffCloakTheme||'owner');remote.ownerHat=!!live.ownerHat;remote.ownerHatTheme=normalizeStaffTheme(live.ownerHatTheme||'owner');remote.heldItemTheme=normalizeStaffTheme(live.heldItemTheme||'owner');remote.staffShotTheme=normalizeStaffTheme(live.staffShotTheme||'owner');remote.viewerCanSeeVanish=!!live.__viewerCanSeeVanish;
  ...
  collectRemotePoseBones(root){
    const all=[];root?.traverse?.((object)=>{if(object?.isBone){object.userData.__centerRemoteBaseQuaternion=object.quaternion.clone();object.userData.__centerRemoteBasePosition=object.position.clone();all.push(object);}});const find=(pattern)=>all.find((bone)=>pattern.test(bone.name||'')),result={all,
      ...
      chest:find(/(?:^chest|spine_?2|upperchest|(?:^|[_ .-])chest$)/i),neck:find(/(?:^neck|neck_|(?:^|[_ .-])neck$)/i),head:find(/(?:^head|head_|(?:^|[_ .-])head$)/i),handRight:find(/(?:right.*hand|hand.*right|bip R Hand|mixamorig:RightHand|hand_R)/i)
    };
  ...
  async installRemoteModel(remote,skin){
    ...
    const task=(async()=>{let template=null,fallback=null;try{template=await this.remoteTemplate(skin);}catch{fallback=this.makeFallbackCharacter(skin);}if(token!==remote.modelInstallToken||!this.remotePlayers.has(remote.uid))return;
      remote.mixer?.stopAllAction?.();remote.walkMixer?.stopAllAction?.();remote.runMixer?.stopAllAction?.();remote.vehicleObject?.userData?.mixer?.stopAllAction?.();this.disposeGeneratedVisual(remote.cape);this.disposeGeneratedVisual(remote.cloak);this.disposeGeneratedVisual(remote.hat);this.disposeGeneratedVisual(remote.aura);this.disposeGeneratedVisual(remote.formObject);this.disposeGeneratedVisual(remote.vehicleObject);this.disposeGeneratedVisual(remote.heldObject);this.disposeGeneratedVisual(remote.staffBeamVisual);remote.staffBeamVisual=null;remote.heldAnchor?.removeFromParent?.();this.disposeClonedModelMaterials(remote.model);remote.pivot.clear();remote.mixer=null;remote.walkMixer=null;remote.runMixer=null;remote.dualLocomotion=false;remote.walkVisual=null;remote.runVisual=null;remote.action=null;remote.walkAction=null;remote.runAction=null;remote.jogAction=null;remote.idleAction=null;remote.weaponIdleAction=null;remote.nativeIdle=false;remote.activeAction=null;remote.wasWalking=false;remote.model=null;remote.bones=null;remote.aura=null;remote.cape=null;remote.cloak=null;remote.hat=null;remote.formObject=null;remote.vehicleObject=null;remote.heldObject=null;remote.heldAnchor=null;remote.renderedHeldItem='';remote.renderedAppearanceSkin='';remote.renderedVehicle='';remote.lastVisualKey='';remote.lastFormKey='';remote.lastCosmeticKey='';remote.lastHeldKey='';remote.lastMaterialThemeKey='';
      if(template){if(template.normalTriple){const model=cloneSkeleton(template.root);model.traverse((object)=>{if(object.isMesh&&object.material)object.material=Array.isArray(object.material)?object.material.map((m)=>m.clone()):object.material.clone();});remote.model=model;remote.bones=this.collectRemotePoseBones(model);remote.pivot.add(model);
        const walkSource=(template.walkAnimations||[])[0]||null,runSource=(template.runAnimations||[])[0]||null,idleSource=(template.idleAnimations||[])[0]||null,
          walk=this.sanitizeEgoLocomotionClip(walkSource),run=this.retargetLocomotionClip(this.sanitizeEgoLocomotionClip(runSource),model,'run'),idle=this.retargetLocomotionClip(this.sanitizeEgoLocomotionClip(idleSource),model,'stand');
        remote.mixer=new THREE.AnimationMixer(model);remote.walkMixer=remote.mixer;remote.runMixer=remote.mixer;remote.nativeIdle=!!idle;
        if(idle){remote.idleAction=remote.mixer.clipAction(idle);remote.idleAction.play();remote.idleAction.paused=false;remote.activeAction=remote.idleAction;}
        if(walk){remote.walkAction=remote.mixer.clipAction(walk);remote.walkAction.play();remote.walkAction.paused=true;remote.action=remote.walkAction;}
        if(run){remote.runAction=remote.mixer.clipAction(run);remote.runAction.play();remote.runAction.paused=true;}
        remote.mixer.update(0);
      }else if(template.dual){const walkVisual=cloneSkeleton(template.walkRoot),runVisual=cloneSkeleton(template.runRoot),model=new THREE.Group();for(const visual of [walkVisual,runVisual])visual.traverse((object)=>{if(object.isMesh&&object.material)object.material=Array.isArray(object.material)?object.material.map((m)=>m.clone()):object.material.clone();});runVisual.visible=false;model.add(walkVisual,runVisual);remote.model=model;remote.walkVisual=walkVisual;remote.runVisual=runVisual;remote.dualLocomotion=true;remote.bones=this.collectRemotePoseBones(walkVisual);remote.pivot.add(model);const walk=this.sanitizeEgoLocomotionClip((template.walkAnimations||[])[0]||null),run=this.sanitizeEgoLocomotionClip((template.runAnimations||[])[0]||null);if(walk){remote.walkMixer=new THREE.AnimationMixer(walkVisual);remote.mixer=remote.walkMixer;remote.walkAction=remote.walkMixer.clipAction(walk);remote.walkAction.play();remote.walkAction.paused=true;remote.action=remote.walkAction;}if(run){remote.runMixer=new THREE.AnimationMixer(runVisual);remote.runAction=remote.runMixer.clipAction(run);remote.runAction.play();remote.runAction.paused=true;}this.applyRemoteIdlePose(remote,.016,true);}else{const model=cloneSkeleton(template.root);model.traverse((object)=>{if(object.isMesh&&object.material)object.material=Array.isArray(object.material)?object.material.map((m)=>m.clone()):object.material.clone();});remote.model=model;remote.bones=this.collectRemotePoseBones(model);remote.pivot.add(model);if(template.nativeTriple){const animations=template.animations||[],find=(name)=>animations.find((clip)=>String(clip?.name||'')===name)||null,idle=find('Man_Stand')||animations.find((clip)=>/stand|idle/i.test(String(clip?.name||'')))||null,walk=this.makeInPlaceLocomotionClip(find('Man_Walk')||animations.find((clip)=>/walk/i.test(String(clip?.name||'')))||null),jog=this.makeInPlaceLocomotionClip(find('Man_Jog')),run=this.makeInPlaceLocomotionClip(find('Man_Run')||animations.find((clip)=>/run/i.test(String(clip?.name||'')))||null),weaponIdle=find('Weapon_Stand');remote.mixer=new THREE.AnimationMixer(model);remote.nativeIdle=!!idle;const loop=(clip)=>{if(!clip)return null;const a=remote.mixer.clipAction(clip);a.play();a.paused=true;return a;};if(idle){remote.idleAction=loop(idle);remote.idleAction.paused=false;remote.activeAction=remote.idleAction;}remote.walkAction=loop(walk);remote.action=remote.walkAction;remote.jogAction=loop(jog);remote.runAction=loop(run);remote.weaponIdleAction=loop(weaponIdle);remote.mixer.update(0);}else{const walk=this.selectLocomotionClip(template.animations);if(walk){remote.mixer=new THREE.AnimationMixer(model);remote.walkAction=remote.mixer.clipAction(walk);remote.walkAction.play();remote.walkAction.paused=true;remote.action=remote.walkAction;remote.mixer.update(0);this.applyRemoteIdlePose(remote,.016,true);}}}}else{remote.model=fallback||this.makeFallbackCharacter(skin);remote.pivot.add(remote.model);}remote.skin=skin;this.applyRemoteOwnerAura(remote);
...
applyRemoteOwnerAura(remote) {
    ...
    const visible=isStaffVisual&&!hidden&&!remote.formObject&&remote.vehicle!=='plane';if(remote.cape&&(remote.cape.userData?.theme!==capeTheme||remote.cape.userData?.qualityTier!==tier)){this.disposeGeneratedVisual(remote.cape);remote.cape=null;}if(remote.cloak&&(remote.cloak.userData?.theme!==cloakTheme||remote.cloak.userData?.qualityTier!==tier)){this.disposeGeneratedVisual(remote.cloak);remote.cloak=null;}if(remote.hat&&(remote.hat.userData?.theme!==hatTheme||remote.hat.userData?.qualityTier!==tier)){this.disposeGeneratedVisual(remote.hat);remote.hat=null;}
    ...
    if(visible&&remote.staffCloak&&tier!=='minimal'&&!remote.cloak){remote.cloak=this.createStaffCloak(cloakTheme,tier!=='high');remote.cloak.userData.qualityTier=tier;this.simplifyRemoteVisual(remote.cloak,tier);remote.pivot.add(remote.cloak);const backBone=remote.bones?.neck||this.resolveBackAttachmentBone(remote.model,remote.bones)||remote.bones?.chest||remote.bones?.spine,neckPos=new THREE.Vector3(0,1.62,-.21),q=new THREE.Quaternion();if(!this.configureWearableFollower(remote.cloak,remote.pivot,backBone,neckPos,q)){remote.cloak.position.copy(neckPos);remote.cloak.quaternion.copy(q);}this.updateWearableFollower(remote.cloak);}if(remote.cloak)remote.cloak.visible=visible&&remote.staffCloak&&tier!=='minimal';
...
applyRemoteHeldItem(remote){
  ...
  updateRemotePlayers(delta){
    ...
    for(const [uid,remote] of this.remotePlayers){
      ...
      if(remote.cloak?.visible){this.updateWearableFollower(remote.cloak);const visual=remote.cloak.userData?.visualPivot||remote.cloak,rs=Math.hypot(Number(remote.velocityX)||0,Number(remote.velocityZ)||0),target=(remote.flying?-.10:-.01)-clamp(rs*.006,0,.045),base=Number(remote.cloak.userData?.baseRotationX)||.035;visual.rotation.x+=(base+target-visual.rotation.x)*(1-Math.exp(-delta*4));visual.rotation.z=Math.sin(now*.003+remote.group.position.x)*.010;}
      ...
      if(remote.dualLocomotion&&(remote.walkMixer||remote.runMixer)){const running=!!(humanWalking&&remote.sprinting&&remote.runAction);if(remote.walkVisual)remote.walkVisual.visible=!running;if(remote.runVisual)remote.runVisual.visible=running;if(humanWalking){if(running){if(remote.walkAction)remote.walkAction.paused=true;if(remote.runAction){remote.runAction.enabled=true;remote.runAction.paused=false;remote.runAction.setEffectiveWeight?.(1);remote.runMixer.timeScale=1.05;remote.runMixer.update(delta);}}else{if(remote.runAction)remote.runAction.paused=true;if(remote.walkAction){remote.walkAction.enabled=true;remote.walkAction.paused=false;remote.walkAction.setEffectiveWeight?.(1);remote.walkMixer.timeScale=1;remote.walkMixer.update(delta);}}remote.wasWalking=true;}else{if(remote.walkAction)remote.walkAction.paused=true;if(remote.runAction)remote.runAction.paused=true;remote.wasWalking=false;this.applyRemoteIdlePose(remote,delta,false);}}
      else if(remote.mixer&&(remote.walkAction||remote.runAction||remote.jogAction||remote.action||remote.idleAction||remote.weaponIdleAction)){if(humanWalking){const remoteSpeed=Math.hypot(Number(remote.velocityX)||0,Number(remote.velocityZ)||0),desired=remote.ownerBaseModel==='masked'&&remoteSpeed>9.2&&remote.runAction?remote.runAction:(remote.ownerBaseModel==='masked'&&remote.sprinting&&remote.jogAction?remote.jogAction:(remote.sprinting&&remote.runAction?remote.runAction:(remote.walkAction||remote.action)));if(remote.activeAction!==desired){const blend=(desired===remote.idleAction||remote.activeAction===remote.idleAction)?.28:.14;if(remote.activeAction&&remote.activeAction!==desired){remote.activeAction.fadeOut?.(blend);remote.activeAction.paused=false;}desired.enabled=true;desired.paused=false;desired.reset?.();desired.fadeIn?.(blend);desired.play?.();remote.activeAction=desired;}else desired.paused=false;remote.mixer.timeScale=desired===remote.runAction?1.08:1;remote.mixer.update(delta);remote.wasWalking=true;}else if(remote.nativeIdle&&remote.idleAction&&!remote.flying&&!airborne&&!remote.vehicleObject){const desired=remote.ownerBaseModel==='masked'&&remote.heldItem&&remote.heldItem!=='none'&&remote.weaponIdleAction?remote.weaponIdleAction:remote.idleAction;if(remote.activeAction!==desired){const blend=.28;if(remote.activeAction&&remote.activeAction!==desired){remote.activeAction.fadeOut?.(blend);remote.activeAction.paused=false;}desired.enabled=true;desired.paused=false;desired.reset?.();desired.fadeIn?.(blend);desired.play?.();remote.activeAction=desired;}else desired.paused=false;remote.mixer.timeScale=1;remote.mixer.update(delta);remote.wasWalking=false;}else{if(remote.wasWalking||remote.activeAction){for(const a of [remote.walkAction,remote.jogAction,remote.runAction,remote.action,remote.idleAction,remote.weaponIdleAction])if(a){a.fadeOut?.(.08);a.paused=true;}remote.activeAction=null;remote.wasWalking=false;}if(!remote.nativeIdle)this.applyRemoteIdlePose(remote,delta,false);}}
  ...
  removeRemotePlayer(uid){const remote=this.remotePlayers.get(uid);if(!remote)return;remote.modelInstallToken=(remote.modelInstallToken||0)+1;remote.mixer?.stopAllAction?.();remote.walkMixer?.stopAllAction?.();remote.runMixer?.stopAllAction?.();remote.vehicleObject?.userData?.mixer?.stopAllAction?.();this.disposeGeneratedVisual(remote.cape);this.disposeGeneratedVisual(remote.cloak);this.disposeGeneratedVisual(remote.hat);this.disposeGeneratedVisual(remote.aura);this.disposeGeneratedVisual(remote.formObject);this.disposeGeneratedVisual(remote.vehicleObject);this.disposeGeneratedVisual(remote.heldObject);remote.heldAnchor?.removeFromParent?.();this.disposeClonedModelMaterials(remote.model);remote.group.removeFromParent();remote.label?.material?.map?.dispose?.();remote.label?.material?.dispose?.();this.remotePlayers.delete(uid);}
...
renderOwnerMenu(){
    ...
    if(caps.speed){const speedMode=this.state.staffSettings?.speedControlMode||'wheel';sections.push(`<h3 data-owner-nav="speed">Geschwindigkeit</h3><div class="mdc-owner-character"><label>Tempo <input data-owner-speed type="range" min="1" max="${OWNER_MAX_SPEED_MULTIPLIER}" step="0.25" value="${speedMultiplier}"><b>${speedMultiplier.toFixed(2)}×</b></label><label>Tempo-Steuerung<select data-owner-speed-control><option value="wheel" ${speedMode==='wheel'?'selected':''}>Scrollrad beim Laufen/Fly/Flieger</option><option value="keys" ${speedMode==='keys'?'selected':''}>Eigene Tasten</option><option value="off" ${speedMode==='off'?'selected':''}>Aus</option></select></label>${speedMode==='keys'?`<div class="mdc-keybind-grid"><label>Schneller<select data-keybind-action="speedUp">${this.keybindOptions(this.state.keybinds?.speedUp)}</select></label><label>Langsamer<select data-keybind-action="speedDown">${this.keybindOptions(this.state.keybinds?.speedDown)}</select></label></div>`:''}<p class="mdc-note">Scroll hoch = schneller · Scroll runter = langsamer. Funktioniert nur für Teamrollen mit Tempo-Recht und nur beim Laufen, Fly oder im Sägelflugzeug.</p></div>`);}
    if(caps.size||forms.length>1)sections.push(`<h3 data-owner-nav="character">Charakter</h3><div class="mdc-owner-character">${caps.size?`<label>Größe <input data-owner-size type="range" min="0.45" max="2.5" step="0.05" value="${appearance.size}"><b>${Number(appearance.size).toFixed(2)}×</b></label>`:''}<div class="mdc-owner-actions three">${forms.map(([id,label])=>`<button class="${appearance.skin===id?'active ':''}" data-owner-action="skin-${id}">${label}</button>`).join('')}</div></div>`);
    if(teamToolIds.length>1)sections.push(`<h3 data-owner-nav="tools">Team-Werkzeuge</h3><div class="mdc-owner-actions three">${teamToolIds.map((id)=>`<button class="${appearance.heldItem===id?'active ':''}" data-owner-action="admin-item" data-owner-item="${id}">${itemLabels[id]||id}</button>`).join('')}</div>`);
    const availableThemes=this.allowedCosmeticThemes();if(availableThemes.length){const titles={owner:'Owner Galaxy',admin:'Admin Red Galaxy',moderator:'Moderator Grün',supporter:'Supporter Blau'};for(const theme of availableThemes)sections.push(themeSection(theme,titles[theme]));}else if(this.isStaffActive)sections.push(`<h3 data-owner-nav="gear">Team-Skin</h3><div class="mdc-owner-character"><p class="mdc-note">${detailRole==='testsupporter'?'Testsupporter':'Teammitglied'} nutzt den weißen Team-Skin${detailRole==='testsupporter'?' und darf Fly benutzen':''}.</p></div>`);
    if((caps.vehicles||[]).some((id)=>id==='scooter'||id==='plane'))sections.push(`<h3 data-owner-nav="vehicles">Team-Fahrzeuge</h3><div class="mdc-owner-actions">${(caps.vehicles||[]).includes('scooter')?`<button class="${appearance.vehicle==='scooter'?'active ':''}" data-owner-action="admin-vehicle" data-owner-vehicle="scooter">🛴 Electro Scooter</button>`:''}${(caps.vehicles||[]).includes('plane')?`<button class="${appearance.vehicle==='plane'?'active ':''}" data-owner-action="admin-vehicle" data-owner-vehicle="plane">✈ Sägelflugzeug</button>`:''}${appearance.vehicle!=='none'?'<button data-owner-action="admin-vehicle" data-owner-vehicle="none">Fahrzeug abstellen</button>':''}</div>`);
    if(caps.world)sections.push(`<h3 data-owner-nav="world">Welt und Zeit</h3><div class="mdc-owner-actions three"><button data-owner-action="time-day">☀ Tag</button><button data-owner-action="time-night">☾ Nacht</button><button data-owner-action="weather-clear">Klar</button><button data-owner-action="weather-rain">Regen</button><button data-owner-action="weather-snow">Schnee</button><button data-owner-action="season-next">Jahreszeit +</button></div>`);
    if(caps.resources)sections.push(`<h3 data-owner-nav="resources">Ressourcen und Fortschritt</h3><div class="mdc-owner-grant"><select data-owner-resource>${Object.entries(RESOURCE_LABELS).map(([id,name])=>`<option value="${id}">${escapeHtml(name)}</option>`).join('')}</select><input data-owner-amount type="number" min="1" max="9999" value="100"><button data-owner-action="grant-resource">Hinzufügen</button></div><div class="mdc-owner-actions"><button data-owner-action="grant-all">Alle Ressourcen +100</button><button data-owner-action="grant-tools">Alle Werkzeuge 100 %</button><button data-owner-action="grant-skills">Skills und XP</button><button data-owner-action="respawn-resources">Ressourcen regenerieren</button></div>`);
    const staffBindRows=[['staffMenu','Team-Menü'],this.isOwnerActive&&['greatSword','Owner Great Sword ziehen'],caps.vanish&&['vanish','Vanish'],caps.god&&['god','Unbesiegbar'],caps.fly&&['fly','Fly']].filter(Boolean),quickFormOptions=(caps.forms||[]).filter((id)=>ANIMAL_FORM_IDS.includes(id));if(staffBindRows.length||quickFormOptions.length)sections.push(`<h3 data-owner-nav="keybinds">Keybinds</h3><div class="mdc-keybind-grid">${staffBindRows.map(([id,label])=>`<label>${label}<select data-keybind-action="${id}">${this.keybindOptions(this.state.keybinds?.[id])}</select></label>`).join('')}${quickFormOptions.length?`<label>Tier-Verwandlung<select data-owner-quick-form>${quickFormOptions.map((id)=>`<option value="${id}" ${appearance.quickForm===id?'selected':''}>${escapeHtml(formLabels[id]||ANIMAL_PROFILES[id]?.label||id)}</option>`).join('')}</select></label><label>Tier-Keybind<select data-keybind-action="transform">${this.keybindOptions(this.state.keybinds?.transform)}</select></label>`:''}</div>`);
    if(caps.online)sections.push(`<h3 data-owner-nav="online">Online-Spieler im Center</h3><div class="mdc-owner-actions"><button data-owner-action="refresh-online-players">↻ Aktualisieren</button></div><div class="mdc-owner-player-list">${onlinePlayers.length?onlinePlayers.map((p,i)=>`<article><span>●</span><div><b>${escapeHtml(p.name)}</b><small>${Math.round(Math.hypot(Number(p.x||0)-this.player.position.x,Number(p.z||0)-this.player.position.z))} m entfernt${p.vanished?' · Vanish':''}</small></div>${caps.teleport?`<button data-owner-action="tp-player" data-owner-index="${i}">Teleportieren</button>`:''}</article>`).join(''):'<p>Aktuell ist kein weiterer Spieler im Center verbunden.</p>'}</div>`);
    if(caps.teleport)sections.push(`<h3 data-owner-nav="teleport">Teleportieren</h3><div class="mdc-owner-teleports"><button data-owner-action="tp-spawn">Siedlungs-Spawn</button><button data-owner-action="tp-river">Nächster Fluss</button><button data-owner-action="tp-random">Sicherer Zufallsort</button>${villages.map((v,i)=>`<button data-owner-action="tp-village" data-owner-index="${i}">Dorf: ${escapeHtml(v.name)}</button>`).join('')}${landmarks.map((h,i)=>`<button data-owner-action="tp-landmark" data-owner-index="${i}">${escapeHtml(h.data?.title||h.label||'Weltort')}</button>`).join('')}</div>`);
    const navItems=[
      this.isOwnerActive&&['owner-skin','Owner Spezial-Skin'],
      this.isOwnerActive&&['great-sword','Owner Great Sword'],
      ['combat','Kampf'],
      ['movement','Schutz & Bewegung'],
      caps.speed&&['speed','Geschwindigkeit'],
      (caps.size||forms.length>1)&&['character','Charakter'],
      teamToolIds.length>1&&['tools','Teamwerkzeuge'],
      availableThemes.length&&['gear','Team-Ausrüstung'],
      (caps.vehicles||[]).some((id)=>id==='scooter'||id==='plane')&&['vehicles','Teamfahrzeuge'],
      caps.world&&['world','Welt & Zeit'],
      caps.resources&&['resources','Ressourcen & Fortschritt'],
      (staffBindRows.length||quickFormOptions.length)&&['keybinds','Keybinds'],
...
handleOwnerInput(event){
    ...
    const healthInput=event.target.closest?.('[data-owner-health-max]');if(healthInput&&['owner','admin'].includes(this.activeStaffRole)){const old=this.effectiveMaxHealth(),value=Math.floor(clamp(Number(healthInput.value)||500,100,10000));this.state.ownerAppearance.staffMaxHealth=value;const next=this.effectiveMaxHealth();if(next>old)this.state.needs.health=Math.min(next,this.state.needs.health+(next-old));else this.state.needs.health=Math.min(next,this.state.needs.health);const label=healthInput.parentElement?.querySelector('b');if(label)label.textContent=String(next);this.renderHud(true);this.saveState(true);return;}
    const greatDamageInput=event.target.closest?.('[data-owner-great-sword-damage]');if(greatDamageInput&&this.isOwnerActive){const value=Math.floor(clamp(Number(greatDamageInput.value)||5000,1,100000));this.state.ownerAppearance.ownerGreatSwordDamage=value;const label=greatDamageInput.parentElement?.querySelector('b');if(label)label.textContent=value.toLocaleString('de-DE');this.saveState(true);return;}
  ...
  async handleOwnerAction(event){
    ...
    if(action==='jump-owner-section'){const target=button.dataset.ownerTarget||'',heading=[...this.ownerPanelBody.querySelectorAll('[data-owner-nav]')].find((el)=>el.dataset.ownerNav===target);heading?.scrollIntoView?.({behavior:'smooth',block:'start'});return;}
    ...
    if(action==='toggle-owner-galaxy-skin'||action==='toggle-staff-skin'){
      const theme=requestedTheme||'owner';if(!this.allowedCosmeticThemes().includes(theme))return;const appearance=this.state.ownerAppearance;if(this.isOwnerActive&&appearance.ownerBaseModel==='masked'){this.toast('Der Owner Wizard Character bleibt in seiner Originaloptik. Galaxy-Wings, Umhang, Krone, Aura, Stab und Schwert kannst du weiterhin separat verwenden.');return;}appearance.staffSkinTheme=appearance.staffSkinTheme===theme?'none':theme;this.spawnTransformationEffectAt?.(this.player.position);this.setShadowCharacterMode(appearance.staffSkinTheme!=='none',appearance.staffSkinTheme==='none'?'owner':appearance.staffSkinTheme);this.applyOwnerAppearance();this.saveState(true);this.renderOwnerMenu();this.publishPresence(true).catch(()=>{});return;
    }
    if(action==='owner-base-default'||action==='owner-base-masked'){
      if(!this.ownerOnly())return;const appearance=this.state.ownerAppearance,next=action==='owner-base-masked'?'masked':'default';if(appearance.ownerBaseModel===next)return;appearance.ownerBaseModel=next;appearance.skin='normal';appearance.vehicle='none';if(next==='masked'){appearance.staffSkinTheme='none';this.state.needs.health=10000;this.state.needs.hunger=100;this.state.needs.thirst=100;this.state.needs.stamina=100;this.state.needs.warmth=100;}this.spawnTransformationEffectAt?.(this.player.position);await this.ensureCorrectPlayerModel();this.applyOwnerAppearance();this.saveState(true);this.renderOwnerMenu();this.publishPresence(true).catch(()=>{});this.renderHud(true);this.toast(next==='masked'?'Owner Wizard Character V1 aktiviert · 10.000 Leben · alle Wizard-Animationen geladen.':'Standard Owner-Skin aktiviert.');return;
    }
    ...
    if(action==='admin-item'){const item=button.dataset.ownerItem||'none';if(this.state.ownerAppearance?.ownerGreatSwordActive){this.state.ownerAppearance.ownerGreatSwordActive=false;this.greatSwordDrawToken+=1;this.endGreatSwordAim();}if(item==='greatSword'&&!this.isOwnerActive){this.toast('Das Owner Great Sword ist ausschließlich für den Owner.');return;}if(!caps.items.includes(item)){this.toast('Dieses Item ist ausschließlich für eine höhere Teamrolle.');return;}const appearance=this.state.ownerAppearance,nextTheme=requestedTheme||this.appearanceTheme('heldItem'),same=item!=='none'&&appearance.heldItem===item&&appearance.heldItemTheme===nextTheme;appearance.heldItem=same?'none':item;if(item!=='none')appearance.heldItemTheme=nextTheme;this.applyHeldItemVisual();this.saveState(true);this.renderOwnerMenu();this.publishPresence(true).catch(()=>{});return;}
