...
export function buildToxicKeyboardWorld(api){
  ...
  const win=(stage,reward,y=.8)=>{z-=4.4;addPlatform({x:0,y:y-.16,z,w:9.8,h:.38,d:5.2,color:0x16361d,label:'',kind:'safe-zone',stage:Math.min(10,stage+1)});addPlatform({x:2.55,y:y+.15,z,w:3.4,h:.2,d:2.15,color:0xdfaa2d,label:`WIN +${compactReward(reward)}`,kind:'win-pad',winReward:reward,winStage:stage});addSign(`WIN +${compactReward(reward)} · CASH OUT`,{x:2.55,y:y+2.0,z:z+.1},0xffd35b,.43);};
