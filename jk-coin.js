(() => {
  ...
  const VERSION = "2026-08-22-jkcoin-v523-chamber-kl-v3-armory";
  ...
  const GAME_STORE = [
    ...
    { game:"chamber", id:"chamber-shotgun-inferno", name:"Inferno Reactor Pumpgun", cost:700, text:"Aufwendiges Chamber.KL-V3-Premiumdesign mit eigenem Material- und Glow-Look. Rein kosmetisch.", grant:{kind:"shotgun:inferno",amount:1} },
    { game:"chamber", id:"chamber-shotgun-obsidian", name:"Obsidian Core Pumpgun", cost:850, text:"Aufwendiges Chamber.KL-V3-Premiumdesign mit eigenem Material- und Glow-Look. Rein kosmetisch.", grant:{kind:"shotgun:obsidian",amount:1} },
    { game:"chamber", id:"chamber-shotgun-thunderlord", name:"Thunderlord Pumpgun", cost:1000, text:"Aufwendiges Chamber.KL-V3-Premiumdesign mit eigenem Material- und Glow-Look. Rein kosmetisch.", grant:{kind:"shotgun:thunderlord",amount:1} },
    { game:"chamber", id:"chamber-shotgun-toxicstorm", name:"Toxic Storm Pumpgun", cost:1150, text:"Aufwendiges Chamber.KL-V3-Premiumdesign mit eigenem Material- und Glow-Look. Rein kosmetisch.", grant:{kind:"shotgun:toxicstorm",amount:1} },
    { game:"chamber", id:"chamber-shotgun-bloodmoon", name:"Blood Moon Pumpgun", cost:1300, text:"Aufwendiges Chamber.KL-V3-Premiumdesign mit eigenem Material- und Glow-Look. Rein kosmetisch.", grant:{kind:"shotgun:bloodmoon",amount:1} },
    { game:"chamber", id:"chamber-shotgun-aurora", name:"Aurora Prism Pumpgun", cost:1500, text:"Aufwendiges Chamber.KL-V3-Premiumdesign mit eigenem Material- und Glow-Look. Rein kosmetisch.", grant:{kind:"shotgun:aurora",amount:1} },
    { game:"chamber", id:"chamber-shotgun-voidwalker", name:"Voidwalker Pumpgun", cost:1700, text:"Aufwendiges Chamber.KL-V3-Premiumdesign mit eigenem Material- und Glow-Look. Rein kosmetisch.", grant:{kind:"shotgun:voidwalker",amount:1} },
    { game:"chamber", id:"chamber-shotgun-dragoncore", name:"Dragon Core Pumpgun", cost:1950, text:"Aufwendiges Chamber.KL-V3-Premiumdesign mit eigenem Material- und Glow-Look. Rein kosmetisch.", grant:{kind:"shotgun:dragoncore",amount:1} },
    { game:"chamber", id:"chamber-shotgun-celestial", name:"Celestial Crown Pumpgun", cost:2250, text:"Aufwendiges Chamber.KL-V3-Premiumdesign mit eigenem Material- und Glow-Look. Rein kosmetisch.", grant:{kind:"shotgun:celestial",amount:1} },
    { game:"chamber", id:"chamber-shotgun-singularitygun", name:"Singularity X Pumpgun", cost:2600, text:"Aufwendiges Chamber.KL-V3-Premiumdesign mit eigenem Material- und Glow-Look. Rein kosmetisch.", grant:{kind:"shotgun:singularitygun",amount:1} },
    { game:"chamber", id:"chamber-sawed-inferno", name:"Sawed Inferno", cost:750, text:"Premiumdesign für die sichtbar abgesägte Chamber.KL-Pumpgun nach Einsatz der Handsäge. Rein kosmetisch.", grant:{kind:"sawed:inferno",amount:1} },
    { game:"chamber", id:"chamber-sawed-obsidian", name:"Sawed Obsidian", cost:900, text:"Premiumdesign für die sichtbar abgesägte Chamber.KL-Pumpgun nach Einsatz der Handsäge. Rein kosmetisch.", grant:{kind:"sawed:obsidian",amount:1} },
    { game:"chamber", id:"chamber-sawed-thunderlord", name:"Sawed Thunderlord", cost:1050, text:"Premiumdesign für die sichtbar abgesägte Chamber.KL-Pumpgun nach Einsatz der Handsäge. Rein kosmetisch.", grant:{kind:"sawed:thunderlord",amount:1} },
    { game:"chamber", id:"chamber-sawed-toxicstorm", name:"Sawed Toxic Storm", cost:1200, text:"Premiumdesign für die sichtbar abgesägte Chamber.KL-Pumpgun nach Einsatz der Handsäge. Rein kosmetisch.", grant:{kind:"sawed:toxicstorm",amount:1} },
    { game:"chamber", id:"chamber-sawed-bloodmoon", name:"Sawed Blood Moon", cost:1400, text:"Premiumdesign für die sichtbar abgesägte Chamber.KL-Pumpgun nach Einsatz der Handsäge. Rein kosmetisch.", grant:{kind:"sawed:bloodmoon",amount:1} },
    { game:"chamber", id:"chamber-sawed-aurora", name:"Sawed Aurora", cost:1600, text:"Premiumdesign für die sichtbar abgesägte Chamber.KL-Pumpgun nach Einsatz der Handsäge. Rein kosmetisch.", grant:{kind:"sawed:aurora",amount:1} },
    { game:"chamber", id:"chamber-sawed-voidwalker", name:"Sawed Voidwalker", cost:1800, text:"Premiumdesign für die sichtbar abgesägte Chamber.KL-Pumpgun nach Einsatz der Handsäge. Rein kosmetisch.", grant:{kind:"sawed:voidwalker",amount:1} },
    { game:"chamber", id:"chamber-sawed-dragoncore", name:"Sawed Dragon Core", cost:2050, text:"Premiumdesign für die sichtbar abgesägte Chamber.KL-Pumpgun nach Einsatz der Handsäge. Rein kosmetisch.", grant:{kind:"sawed:dragoncore",amount:1} },
    { game:"chamber", id:"chamber-sawed-celestial", name:"Sawed Celestial", cost:2350, text:"Premiumdesign für die sichtbar abgesägte Chamber.KL-Pumpgun nach Einsatz der Handsäge. Rein kosmetisch.", grant:{kind:"sawed:celestial",amount:1} },
    { game:"chamber", id:"chamber-sawed-singularitygun", name:"Sawed Singularity X", cost:2750, text:"Premiumdesign für die sichtbar abgesägte Chamber.KL-Pumpgun nach Einsatz der Handsäge. Rein kosmetisch.", grant:{kind:"sawed:singularitygun",amount:1} },
    { game:"chamber", id:"chamber-live-plasma", name:"Plasma Live Shells", cost:220, text:"Premium-Hülsendesign für scharfe Patronen in Chamber.KL V3.", grant:{kind:"shellLive:plasma",amount:1} },
    { game:"chamber", id:"chamber-live-royal", name:"Royal Live Shells", cost:300, text:"Premium-Hülsendesign für scharfe Patronen in Chamber.KL V3.", grant:{kind:"shellLive:royal",amount:1} },
    { game:"chamber", id:"chamber-live-void", name:"Void Live Shells", cost:380, text:"Premium-Hülsendesign für scharfe Patronen in Chamber.KL V3.", grant:{kind:"shellLive:void",amount:1} },
    { game:"chamber", id:"chamber-live-inferno", name:"Inferno Live Shells", cost:480, text:"Premium-Hülsendesign für scharfe Patronen in Chamber.KL V3.", grant:{kind:"shellLive:inferno",amount:1} },
    { game:"chamber", id:"chamber-live-singularity", name:"Singularity Live Shells", cost:620, text:"Premium-Hülsendesign für scharfe Patronen in Chamber.KL V3.", grant:{kind:"shellLive:singularity",amount:1} },
    { game:"chamber", id:"chamber-blank-neon", name:"Neon Blank Shells", cost:220, text:"Premium-Hülsendesign für leere Patronen in Chamber.KL V3.", grant:{kind:"shellBlank:neon",amount:1} },
    { game:"chamber", id:"chamber-blank-eclipse", name:"Eclipse Blank Shells", cost:300, text:"Premium-Hülsendesign für leere Patronen in Chamber.KL V3.", grant:{kind:"shellBlank:eclipse",amount:1} },
    { game:"chamber", id:"chamber-blank-phantom", name:"Phantom Blank Shells", cost:380, text:"Premium-Hülsendesign für leere Patronen in Chamber.KL V3.", grant:{kind:"shellBlank:phantom",amount:1} },
    { game:"chamber", id:"chamber-blank-void", name:"Void Blank Shells", cost:480, text:"Premium-Hülsendesign für leere Patronen in Chamber.KL V3.", grant:{kind:"shellBlank:void",amount:1} },
    { game:"chamber", id:"chamber-blank-aurora", name:"Aurora Blank Shells", cost:620, text:"Premium-Hülsendesign für leere Patronen in Chamber.KL V3.", grant:{kind:"shellBlank:aurora",amount:1} },
    { game:"chamber", id:"chamber-items-holo", name:"Hologram Tool Theme", cost:320, text:"Premium-Texturtheme, das in Chamber.KL V3 für jedes Special Item einzeln ausgerüstet werden kann.", grant:{kind:"itemTheme:holo",amount:1} },
    { game:"chamber", id:"chamber-items-royal", name:"Royal Vault Tool Theme", cost:460, text:"Premium-Texturtheme, das in Chamber.KL V3 für jedes Special Item einzeln ausgerüstet werden kann.", grant:{kind:"itemTheme:royal",amount:1} },
    { game:"chamber", id:"chamber-items-singularity", name:"Singularity Tool Theme", cost:680, text:"Premium-Texturtheme, das in Chamber.KL V3 für jedes Special Item einzeln ausgerüstet werden kann.", grant:{kind:"itemTheme:singularity",amount:1} },
    { game:"chamber", id:"chamber-items-inferno", name:"Inferno Tool Theme", cost:820, text:"Premium-Texturtheme, das in Chamber.KL V3 für jedes Special Item einzeln ausgerüstet werden kann.", grant:{kind:"itemTheme:inferno",amount:1} },
    { game:"chamber", id:"chamber-items-aurora", name:"Aurora Tool Theme", cost:980, text:"Premium-Texturtheme, das in Chamber.KL V3 für jedes Special Item einzeln ausgerüstet werden kann.", grant:{kind:"itemTheme:aurora",amount:1} },
    { game:"chamber", id:"chamber-items-void", name:"Void Tool Theme", cost:1200, text:"Premium-Texturtheme, das in Chamber.KL V3 für jedes Special Item einzeln ausgerüstet werden kann.", grant:{kind:"itemTheme:void",amount:1} },
    { game:"chamber", id:"chamber-table-neon", name:"Neon Grid Table", cost:500, text:"Kompletter Premium-Tischskin für Chamber.KL V3. Rein kosmetisch.", grant:{kind:"table:neon",amount:1} },
    { game:"chamber", id:"chamber-table-inferno", name:"Inferno Table", cost:750, text:"Kompletter Premium-Tischskin für Chamber.KL V3. Rein kosmetisch.", grant:{kind:"table:inferno",amount:1} },
    { game:"chamber", id:"chamber-table-royal", name:"Royal Vault Table", cost:950, text:"Kompletter Premium-Tischskin für Chamber.KL V3. Rein kosmetisch.", grant:{kind:"table:royal",amount:1} },
    { game:"chamber", id:"chamber-table-void", name:"Void Table", cost:1200, text:"Kompletter Premium-Tischskin für Chamber.KL V3. Rein kosmetisch.", grant:{kind:"table:void",amount:1} },
    { game:"chamber", id:"chamber-table-celestial", name:"Celestial Table", cost:1500, text:"Kompletter Premium-Tischskin für Chamber.KL V3. Rein kosmetisch.", grant:{kind:"table:celestial",amount:1} },
    { game:"chamber", id:"chamber-crate-holo", name:"Holo Supply Case", cost:420, text:"Premium-Skin für die Versorgungskiste, die zu Beginn jeder Kammer drei Items ausgibt.", grant:{kind:"crate:holo",amount:1} },
    { game:"chamber", id:"chamber-crate-inferno", name:"Inferno Supply Case", cost:650, text:"Premium-Skin für die Versorgungskiste, die zu Beginn jeder Kammer drei Items ausgibt.", grant:{kind:"crate:inferno",amount:1} },
    { game:"chamber", id:"chamber-crate-royal", name:"Royal Supply Case", cost:850, text:"Premium-Skin für die Versorgungskiste, die zu Beginn jeder Kammer drei Items ausgibt.", grant:{kind:"crate:royal",amount:1} },
    { game:"chamber", id:"chamber-crate-void", name:"Void Supply Case", cost:1050, text:"Premium-Skin für die Versorgungskiste, die zu Beginn jeder Kammer drei Items ausgibt.", grant:{kind:"crate:void",amount:1} },
    { game:"chamber", id:"chamber-crate-singularity", name:"Singularity Supply Case", cost:1350, text:"Premium-Skin für die Versorgungskiste, die zu Beginn jeder Kammer drei Items ausgibt.", grant:{kind:"crate:singularity",amount:1} },
  ...
  function rollTopGameDrop(game,trigger,eventKey=""){
    ...
    if(won&&credit(won,`${({runner:"Runner.KL",city:"City.KL",match:"Match.KL",fight:"Fight.KL",money:"Money.KL"}[gameId]||"Top Game")} Gratis-Drop`,`topgame-drop`)){persist();syncProfileBalance().catch(()=>{});feed(`GRATIS-DROP: +${won} JK/Coin in ${gameId}.`);toast(`◆ GRATIS-DROP · +${won} JK/Coin`);return won;}
    return 0;
  }
...
<<<<<<< HEAD
    const games=["all","runner","city","match","fight","money","bigcards","escape","weed","casino"],labels={all:"Alle Spiele",runner:"Runner.KL",city:"City.KL",match:"Match.KL",fight:"Fight.KL",money:"Money.KL",bigcards:"BigCards.kl",escape:"Escape.kl",weed:"Weed Business",casino:"Casino"};
=======
    const games=["all","runner","city","match","fight","dungeon","money","bigcards","chamber","escape","weed","casino"],labels={all:"Alle Spiele",runner:"Runner.KL",city:"City.KL",match:"Match.KL",fight:"Fight.KL",dungeon:"Dungeon.KL",money:"Money.KL",bigcards:"BigCards.kl",chamber:"Chamber.KL",escape:"Escape.kl",weed:"Weed Business",casino:"Casino"};
...
<<<<<<< HEAD
  function applyPendingGameEntitlements(){const c=coinState();if(!c)return false;const apiMap={runner:window.RunnerKL,city:window.CityKL,match:window.MatchKL,fight:window.FightKL,money:window.MoneyKL,bigcards:window.BigCardsKL,escape:window.EscapeKL,weed:window.WeedKL,casino:window.JKCasinoV82};for(const entry of GAME_STORE){if(entry.game==="casino"&&entry.variable)continue;const total=Number(c.entitlements?.[entry.id]||0),applied=Number(c.appliedEntitlements?.[entry.id]||0),delta=Math.max(0,total-applied);if(!delta)continue;try{const api=apiMap[entry.game];const grant=api?.grantJkCoinPurchase;if(typeof grant!=="function")continue;const ok=grant.call(api,entry.grant.kind,delta,{sku:entry.id,name:entry.name});if(ok!==false)c.appliedEntitlements[entry.id]=total;}catch(error){console.warn("JK/Coin Spiel-Gutschrift",entry.game,error);}}persist();return true;}
=======
  function applyPendingGameEntitlements(){const c=coinState();if(!c)return false;const apiMap={runner:window.RunnerKL,city:window.CityKL,match:window.MatchKL,fight:window.FightKL,dungeon:window.DungeonKL,money:window.MoneyKL,bigcards:window.BigCardsKL,chamber:window.ChamberKL,escape:window.EscapeKL,weed:window.WeedKL,casino:window.JKCasinoV82};for(const entry of GAME_STORE){if(entry.game==="casino"&&entry.variable)continue;const total=Number(c.entitlements?.[entry.id]||0),applied=Number(c.appliedEntitlements?.[entry.id]||0),delta=Math.max(0,total-applied);if(!delta)continue;try{const api=apiMap[entry.game];const grant=api?.grantJkCoinPurchase;if(typeof grant!=="function")continue;const ok=grant.call(api,entry.grant.kind,delta,{sku:entry.id,name:entry.name});if(ok!==false)c.appliedEntitlements[entry.id]=total;}catch(error){console.warn("JK/Coin Spiel-Gutschrift",entry.game,error);}}persist();return true;}
>>>>>>> 59fd18f25bdd22fa2595bff3322cbc0fa8ea7581
...
<<<<<<< HEAD
  const GAME_LABELS={runner:"Runner.KL",city:"City.KL",match:"Match.KL",fight:"Fight.KL",money:"Money.KL",bigcards:"BigCards.kl",escape:"Escape.kl",weed:"Weed Business",casino:"Casino"};
=======
  const GAME_LABELS={runner:"Runner.KL",city:"City.KL",match:"Match.KL",fight:"Fight.KL",dungeon:"Dungeon.KL",money:"Money.KL",bigcards:"BigCards.kl",chamber:"Chamber.KL",escape:"Escape.kl",weed:"Weed Business",casino:"Casino"};
>>>>>>> 59fd18f25bdd22fa2595bff3322cbc0fa8ea7581
