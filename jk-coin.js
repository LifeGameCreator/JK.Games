(() => {
  ...
  const VERSION = "2026-08-13-jkcoin-v435-escape-store";
  ...
  const GAME_STORE = [
    ...
    { game:"escape", id:"escape-treadmill-gold", name:"Gold Speed-Treadmill ×3 · Dauerhaft", cost:250, text:"Schaltet im Escape.kl-Hub das goldene Laufband dauerhaft frei. Beim Stehen darauf sprintet dein Charakter auf der Stelle und trainiert mit ×3 Laufbandrate.", grant:{kind:"speedTreadmill:gold",amount:1} },
    { game:"escape", id:"escape-treadmill-diamond", name:"Diamond Speed-Treadmill ×9 · Dauerhaft", cost:850, text:"Schaltet das Diamond-Laufband dauerhaft frei. Es trainiert im Stand mit ×9 Laufbandrate und behält deine normale Bewegungssteuerung.", grant:{kind:"speedTreadmill:diamond",amount:1} },
    { game:"escape", id:"escape-galaxy-trail", name:"Galaxy Keyboard Trail · Dauerhaft", cost:300, text:"Exklusive violett-kosmische Laufspur für Escape.kl. Rein kosmetisch; kein versteckter Bewegungsbonus.", grant:{kind:"trail:galaxy",amount:1} },
    { game:"escape", id:"escape-speed-boost-2", name:"Escape Speed-Gain ×2 · 15 Min.", cost:180, text:"Verdoppelt 15 Minuten lang den Speed-Gewinn aus echter Laufstrecke und freigeschalteten Laufbändern. Die Bewegungssteuerung selbst bleibt unverändert.", grant:{kind:"speedBoost:2",amount:1} },
