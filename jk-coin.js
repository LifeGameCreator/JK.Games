(() => {
  ...
  const GAME_STORE = [
    ...
    { game:"escape", id:"escape-treadmill-gold", name:"Gold Speed-Treadmill ×6 · Dauerhaft", cost:250, text:"Schaltet im Escape.kl-Training-Hall das goldene Laufband dauerhaft frei. Der Charakter sprintet im Stand und trainiert die aktive Welt mit ×6 Level-Power.", grant:{kind:"speedTreadmill:gold",amount:1} },
