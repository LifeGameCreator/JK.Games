/* BigCards.kl – JK.Games Top Game V424 · Featured/Collection Instance Sync */
(() => {
  "use strict";

  const VERSION = "2026-08-13-bigcards-v424-featured-collection-sync";
...
Hyper-Kerne werden für die hohen Hyper-Generationen benötigt.`,confirmText:"Hyper-Kern herstellen",icon:"⚡",tone:"danger"}))return;
  ...
  function showSectionInfo(id){
    const info={
      ...
      collection:["Sammlung","Oben gibt es F2P-, Rebirth- und Pay-Score getrennt. V424 hält Sammlung und persönlichen Karte-Slot bei demselben Kartenmotiv synchron: Ist eine stärkere ausgebaute Kopie vorhanden, verwendet der Karte-Slot diese Kopie. So kann die Sammlung nicht mehr RB5 anzeigen, während der Karte-Slot unbemerkt eine RB0-Duplikatkopie benutzt. Karten-Rebirth-Ränder: RB1 Cyan, RB2 Violett, RB3 Gold, RB4 Pink/Rot, RB5 Regenbogen."],
