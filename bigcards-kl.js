/* BigCards.kl – JK.Games Top Game V353 */
(() => {
  "use strict";

  const VERSION = "2026-08-10-bigcards-v353-storage-limits";
  ...
  function state(){
    ...
    S.version=353;const repaired=normalizeFloorUniqueCards();updateFeaturedEarnings(now());if(repaired||potionInventoryMigrated){try{localStorage.setItem(SAVE_KEY,JSON.stringify(S));}catch{}}return S;
  }
