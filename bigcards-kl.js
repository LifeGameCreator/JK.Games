/* BigCards.kl – JK.Games Top Game V349 */
(() => {
  "use strict";
  ...
  function state(){
    ...
    S.version=349;const repaired=normalizeFloorUniqueCards();updateFeaturedEarnings(now());if(repaired){try{localStorage.setItem(SAVE_KEY,JSON.stringify(S));}catch{}}return S;
  }
