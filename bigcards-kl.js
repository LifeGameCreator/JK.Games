/* BigCards.kl – JK.Games Top Game V394 */
(() => {
  "use strict";

  const VERSION = "2026-08-11-bigcards-v394-info-cloud-write-batches";
  ...
  async function syncProfile(force=false){
    ...
    try{
      updateFeaturedEarnings(now());const savedAt=now();S.updatedAt=savedAt;S.version=394;
