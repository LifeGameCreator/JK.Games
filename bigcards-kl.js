/* BigCards.kl – JK.Games Top Game V399 */
(() => {
  "use strict";

  const VERSION = "2026-08-11-bigcards-v399-compact-card-live-market";
  ...
  async function syncProfile(force=false){
    ...
    try{
      updateFeaturedEarnings(now());const savedAt=now();S.updatedAt=savedAt;S.version=399;
