/* BigCards.kl – JK.Games Top Game V397 */
(() => {
  "use strict";

  const VERSION = "2026-08-11-bigcards-v397-sets-backup-mobile-limits";
  ...
  async function syncProfile(force=false){
    ...
    try{
      updateFeaturedEarnings(now());const savedAt=now();S.updatedAt=savedAt;S.version=397;
