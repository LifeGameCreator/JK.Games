/* BigCards.kl – JK.Games Top Game V410 · Balanced Point Economy */
(() => {
  "use strict";

  const VERSION = "2026-08-12-bigcards-v410-balanced-point-economy";
  ...
  const TRAILS = Object.freeze([
    ...
    {id:"uncommon",name:"Ungewöhnliche Spur",icon:"🍃",pointPrice:25000,jk:50,levelReq:5,unlockCost:100000,points:.05,xp:.10,damage:.07,hp:.06},
    {id:"rare",name:"Seltene Spur",icon:"💧",pointPrice:150000,jk:90,levelReq:10,unlockCost:500000,points:.08,xp:.16,damage:.11,hp:.09},
    {id:"epic",name:"Epische Spur",icon:"🔮",pointPrice:350000,jk:150,levelReq:15,unlockCost:2500000,points:.12,xp:.24,damage:.16,hp:.13},
    {id:"legendary",name:"Legendäre Spur",icon:"✨",pointPrice:800000,jk:250,levelReq:20,unlockCost:12000000,points:.16,xp:.35,damage:.22,hp:.18},
    {id:"special",name:"Special Spur",icon:"🔻",pointPrice:1800000,jk:400,levelReq:25,unlockCost:60000000,points:.2,xp:.50,damage:.30,hp:.24},
    {id:"mythic",name:"Mythische Spur",icon:"🌟",pointPrice:4000000,jk:650,levelReq:30,unlockCost:300000000,points:.25,xp:.70,damage:.40,hp:.32},
    {id:"exotic",name:"Exotische Spur",icon:"💠",pointPrice:12000000,jk:1000,levelReq:40,unlockCost:1500000000,points:.3,xp:.95,damage:.52,hp:.42},
    {id:"universe",name:"Universe Spur",icon:"🌌",pointPrice:45000000,jk:1500,levelReq:50,unlockCost:7500000000,points:.35,xp:1.30,damage:.66,hp:.54},
    {id:"blackhole",name:"Black Hole Spur",icon:"⚫",pointPrice:160000000,jk:2200,levelReq:60,unlockCost:37500000000,points:.4,xp:1.75,damage:.82,hp:.68},
    {id:"galaxy",name:"Galaxy Spur",icon:"🌠",pointPrice:600000000,jk:3200,levelReq:75,unlockCost:190000000000,points:.45,xp:2.30,damage:1.00,hp:.85},
    {id:"cosmic",name:"Kosmische Spur",icon:"🔥",pointPrice:2200000000,jk:4500,levelReq:90,unlockCost:950000000000,points:.5,xp:3.00,damage:1.22,hp:1.05},
    {id:"godly",name:"Göttliche Spur",icon:"👑",pointPrice:8000000000,jk:6500,levelReq:100,unlockCost:4750000000000,points:.6,xp:4.00,damage:1.50,hp:1.30}
  ...
  async function syncProfile(force=false){
    ...
    try{
      updateFeaturedEarnings(now());const savedAt=now();S.updatedAt=savedAt;S.version=410;
