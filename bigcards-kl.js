/* BigCards.kl – JK.Games Top Game V369 */
(() => {
  "use strict";

  const VERSION = "2026-08-10-bigcards-v369-visible-backup-slot";
  ...
  function adoptState(raw,{saveLocal=false,userId=""}={}){
    ...
    S.version=369;const repaired=normalizeFloorUniqueCards();updateFeaturedEarnings(now(),false);if(saveLocal||repaired||potionInventoryMigrated)writeLocalState(userId||cloudUid||currentUidSync());return S;
  }
  function state(){
    if(S)return S;
