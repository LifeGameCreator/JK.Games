/* BigCards.kl – JK.Games Top Game V364 */
(() => {
  "use strict";

  const VERSION = "2026-08-10-bigcards-v364-firestore-write-throttle";
  ...
  function adoptState(raw,{saveLocal=false,userId=""}={}){
    ...
    S.version=359;const repaired=normalizeFloorUniqueCards();updateFeaturedEarnings(now());if(saveLocal||repaired||potionInventoryMigrated)writeLocalState(userId||cloudUid||currentUidSync());return S;
  }
  function state(){
    if(S)return S;
